...
var B = class {
    ...
    replace(t, e, i) {
      ...
      return (
        ...
        i.length && i.decompose(0, i.length, n, 1 | 2),
        this.decompose(e, this.length, n, 1),
        ee.from(n, this.length - (e - t) + i.length)
      );
    }
    append(t) {
    ...
    slice(t, e = this.length) {
      [t, e] = Xi(this, t, e);
      let i = [];
      return (this.decompose(t, e, i, 0), ee.from(i, e - t));
    }
    eq(t) {
      if (t == this) return !0;
      ...
      for (let o = e, a = e; ;) {
        if (
          ...
          return !1;
        if (((a += n.value.length), n.done || a >= i)) return !0;
      }
    }
    iter(t = 1) {
  ...
  rt = class extends B {
    constructor(t, e = zO(t)) {
      super();
      ((this.text = t), (this.length = e));
    }
    get lines() {
    ...
    lineInner(t, e, i, n) {
      for (let r = 0; ; r++) {
        let o = this.text[r],
          a = n + o.length;
        if ((e ? i : a) >= t) return new _l(n, a, i, o);
        ((n = a + 1), i++);
      }
    }
    decompose(t, e, i, n) {
      ...
      if (n & 1) {
        let o = i.pop(),
          a = xs(r.text, o.text.slice(), 0, r.length);
        if (a.length <= 32) i.push(new rt(a, o.length + r.length));
        else {
          let l = a.length >> 1;
          i.push(new rt(a.slice(0, l)), new rt(a.slice(l)));
        }
      } else i.push(r);
    }
    replace(t, e, i) {
      if (!(i instanceof rt)) return super.replace(t, e, i);
      [t, e] = Xi(this, t, e);
      let n = xs(this.text, xs(i.text, Wl(this.text, 0, t)), e),
        r = this.length + i.length - (e - t);
      return n.length <= 32 ? new rt(n, r) : ee.from(rt.split(n, []), r);
    }
    sliceString(
      t,
      e = this.length,
...
`,
      ...
      for (let r = 0, o = 0; r <= e && o < this.text.length; o++) {
        let a = this.text[o],
          l = r + a.length;
        (r > t && o && (n += i),
          t < l && e > r && (n += a.slice(Math.max(0, t - r), e - r)),
          (r = l + 1));
      }
      return n;
    }
    ...
    static split(t, e) {
      ...
      for (let r of t)
        (i.push(r),
          (n += r.length + 1),
          i.length == 32 && (e.push(new rt(i, n)), (i = []), (n = -1)));
      return (n > -1 && e.push(new rt(i, n)), e);
    }
  },
  ee = class extends B {
    constructor(t, e) {
      super();
      ((this.children = t), (this.length = e), (this.lines = 0));
    ...
    lineInner(t, e, i, n) {
      for (let r = 0; ; r++) {
        let o = this.children[r],
          a = n + o.length,
          l = i + o.lines - 1;
        if ((e ? l : a) >= t) return o.lineInner(t, e, i, n);
        ((n = a + 1), (i = l + 1));
      }
    }
    decompose(t, e, i, n) {
      for (let r = 0, o = 0; o <= e && r < this.children.length; r++) {
        let a = this.children[r],
          l = o + a.length;
        if (t <= l && e >= o) {
          let h = n & ((o <= t ? 1 : 0) | (l >= e ? 2 : 0));
          o >= t && l <= e && !h ? i.push(a) : a.decompose(t - o, e - o, i, h);
        }
        o = l + 1;
      }
    }
    replace(t, e, i) {
      if ((([t, e] = Xi(this, t, e)), i.lines < this.lines))
        for (let n = 0, r = 0; n < this.children.length; n++) {
          ...
          if (t >= r && e <= a) {
            ...
            if (l.lines < h >> (5 - 1) && l.lines > h >> (5 + 1)) {
              ...
              return ((c[n] = l), new ee(c, this.length - (e - t) + i.length));
            }
...
`,
      ...
      for (let r = 0, o = 0; r < this.children.length && o <= e; r++) {
        let a = this.children[r],
          l = o + a.length;
        (o > t && r && (n += i),
          t < l && e > o && (n += a.sliceString(t - o, e - o, i)),
          (o = l + 1));
      }
      return n;
    }
    ...
    static from(t, e = t.reduce((i, n) => i + n.length + 1, -1)) {
      ...
      function f(d) {
        let p;
        if (d.lines > r && d instanceof ee) for (let O of d.children) f(O);
        else
          d.lines > o && (l > o || !l)
            ? (u(), a.push(d))
            : d instanceof rt &&
                l &&
                (p = c[c.length - 1]) instanceof rt &&
                d.lines + p.lines <= 32
              ? ((l += d.lines),
                (h += d.length + 1),
                (c[c.length - 1] = new rt(
      ...
      function u() {
        l != 0 &&
          (a.push(c.length == 1 ? c[0] : ee.from(c, h)),
          (h = -1),
          (l = c.length = 0));
      }
      for (let d of t) f(d);
      return (u(), a.length == 1 ? a[0] : new ee(a, e));
    }
  };
B.empty = new rt([""], 0);
function zO(s) {
  let t = -1;
  for (let e of s) t += e.length + 1;
  return t;
}
function xs(s, t, e = 0, i = 1e9) {
    ...
    constructor(t, e = 1) {
      ((this.dir = e),
        ...
        (this.offsets = [
          e > 0
            ? 1
            : (t instanceof rt ? t.text.length : t.children.length) << 1,
        ]));
    }
    nextInner(t, e) {
      for (this.done = this.lineBreak = !1; ;) {
        let i = this.nodes.length - 1,
          ...
          r = this.offsets[i],
          o = r >> 1,
          a = n instanceof rt ? n.text.length : n.children.length;
        if (o == (e > 0 ? a : 0)) {
...
`),
          ...
          if (((this.offsets[i] += e), l.length > Math.max(0, t)))
            return (
              (this.value =
                t == 0 ? l : e > 0 ? l.slice(t) : l.slice(0, l.length - t)),
              this
            );
          t -= l.length;
        } else {
          ...
          t > l.length
            ? ((t -= l.length), (this.offsets[i] += e))
            : (e < 0 && this.offsets[i]--,
              this.nodes.push(l),
              this.offsets.push(
                e > 0
                  ? 1
                  : (l instanceof rt ? l.text.length : l.children.length) << 1,
              ));
        }
      }
    }
...
typeof Symbol != "undefined" &&
  ...
  (Mi.prototype[Symbol.iterator] =
    Hr.prototype[Symbol.iterator] =
    Kr.prototype[Symbol.iterator] =
      function () {
        return this;
      }));
var _l = class {
...
function Xi(s, t, e) {
  return (
    (t = Math.max(0, Math.min(s.length, t))),
    [t, Math.max(t, Math.min(s.length, e))]
  );
}
function ie(s, t, e = !0, i = !0) {
  return vs(s, t, e, i);
}
function VO(s) {
...
function ks(s, t) {
  ...
  if (!jO(e) || t + 1 == s.length) return e;
  let i = s.charCodeAt(t + 1);
  return VO(i) ? ((e - 55296) << 10) + (i - 56320) + 65536 : e;
}
function Jr(s) {
  return s < 65536 ? 1 : 2;
}
var to = /\r\n?|\n/,
  ...
  ge = class {
    ...
    composeDesc(t) {
      return this.empty ? t : t.empty ? this : Gl(this, t);
    }
    mapDesc(t, e = !1) {
      return t.empty ? this : io(this, t, e);
    }
      ...
      for (let o = 0; o < this.sections.length;) {
        ...
        if (l < 0) {
          ...
          if (
            i != gt.Simple &&
            h >= t &&
            ((i == gt.TrackDel && n < t && h > t) ||
              (i == gt.TrackBefore && n < t) ||
              (i == gt.TrackAfter && h > t))
          )
            return null;
          if (h > t || (h == t && e < 0 && !a))
            return t == n || e < 0 ? r : r + l;
          r += l;
        }
        n = h;
      }
    ...
    touchesRange(t, e = t) {
      for (let i = 0, n = 0; i < this.sections.length && n <= e;) {
        let r = this.sections[i++],
          o = this.sections[i++],
          a = n + r;
        if (o >= 0 && n <= e && a >= t) return n < t && a > e ? "cover" : !0;
        n = a;
      }
      return !1;
    }
  ...
  ht = class extends ge {
    ...
    apply(t) {
      ...
      return (
        eo(this, (e, i, n, r, o) => (t = t.replace(n, n + (i - e), o)), !1),
        t
      );
    }
    mapDesc(t, e = !1) {
      return io(this, t, e, !0);
    }
    invert(t) {
      ...
      for (let n = 0, r = 0; n < e.length; n += 2) {
        ...
        if (a >= 0) {
          ((e[n] = a), (e[n + 1] = o));
          let l = n >> 1;
          for (; i.length < l;) i.push(B.empty);
          i.push(o ? t.slice(r, r + o) : B.empty);
        }
        r += o;
      }
      return new ht(e, i);
    ...
    compose(t) {
      return this.empty ? t : t.empty ? this : Gl(this, t, !0);
    }
    map(t, e = !1) {
      return t.empty ? this : io(this, t, e, !0);
    }
    iterChanges(t, e = !1) {
      eo(this, t, e);
    }
    get desc() {
      return ge.create(this.sections);
    }
    filter(t) {
      let e = [],
        i = [],
      ...
      t: for (let o = 0, a = 0; ;) {
        ...
        for (; a < l || (a == l && r.len == 0);) {
          ...
          (vt(e, c, f), f > 0 && He(i, e, r.text), r.forward(c), (a += c));
        }
        let h = t[o++];
        for (; a < h;) {
          if (r.done) break t;
          ...
          (vt(e, c, -1),
            vt(n, c, r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0),
            r.forward(c),
            (a += c));
        }
      }
      return { changes: new ht(e, i), filtered: ge.create(n) };
    }
    toJSON() {
      let t = [];
      for (let e = 0; e < this.sections.length; e += 2) {
    ...
    static of(t, e, i) {
      ...
      function l(c = !1) {
        ...
        o < e && vt(n, e - o, -1);
        let f = new ht(n, r);
        ((a = a ? a.compose(f.map(a)) : f), (n = []), (r = []), (o = 0));
      }
      function h(c) {
        if (Array.isArray(c)) for (let f of c) h(f);
          ...
          if (c.length != e)
            throw new RangeError(
              `Mismatched change set length (got ${c.length}, expected ${e})`,
            );
          ...
          if (f > u || f < 0 || u > e)
            throw new RangeError(
              `Invalid change range ${f} to ${u} (in doc of length ${e})`,
            );
          let p = d
              ? typeof d == "string"
                ? B.of(d.split(i || to))
      ...
      for (let n = 0; n < t.length; n++) {
        ...
        if (typeof r == "number") e.push(r, -1);
          ...
          if (
            !Array.isArray(r) ||
            typeof r[0] != "number" ||
            r.some((o, a) => a && typeof o != "string")
          )
            throw new RangeError("Invalid JSON representation of ChangeSet");
          if (r.length == 1) e.push(r[0], 0);
          else {
            for (; i.length < n;) i.push(B.empty);
            ((i[n] = B.of(r.slice(1))), e.push(r[0], i[n].length));
          }
        }
      }
      return new ht(e, i);
...
function He(s, t, e) {
  ...
  let i = (t.length - 2) >> 1;
  if (i < s.length) s[s.length - 1] = s[s.length - 1].append(e);
  else {
    for (; s.length < i;) s.push(B.empty);
    s.push(e);
  }
}
function eo(s, t, e) {
    ...
    if (l < 0) ((n += a), (r += a));
      ...
      for (
        ...
        (h += a),
          ...
          !(e || o == s.sections.length || s.sections[o + 1] < 0);
      )
...
function io(s, t, e, i = !1) {
  ...
  for (let l = -1; ;) {
    ...
    if (o.ins == -1 && a.ins == -1) {
      ...
      (vt(n, h, -1), o.forward(h), a.forward(h));
    } else if (
      a.ins >= 0 &&
      (o.ins < 0 ||
        l == o.i ||
        (o.off == 0 && (a.len < o.len || (a.len == o.len && !e))))
    ) {
      let h = a.len;
      for (vt(n, a.ins, -1); h;) {
        ...
        (o.ins >= 0 &&
          l < o.i &&
          o.len <= c &&
          (vt(n, 0, o.ins), r && He(r, n, o.text), (l = o.i)),
          o.forward(c),
          (h -= c));
      }
      a.next();
      ...
      (vt(n, h, l < o.i ? o.ins : 0),
        r && l < o.i && He(r, n, o.text),
        (l = o.i),
        o.forward(o.len - c));
    } else {
      if (o.done && a.done) return r ? ht.createSet(n, r) : ge.create(n);
      throw new Error("Mismatched change set lengths");
    }
  }
}
function Gl(s, t, e = !1) {
  let i = [],
    ...
    o = new Ri(t);
  for (let a = !1; ;) {
    if (r.done && o.done) return n ? ht.createSet(i, n) : ge.create(i);
    if (r.ins == 0) (vt(i, r.len, 0, a), r.next());
    else if (o.len == 0 && !o.done)
      (vt(i, 0, o.ins, a), n && He(n, i, o.text), o.next());
    else {
      if (r.done || o.done) throw new Error("Mismatched change set lengths");
      {
        let l = Math.min(r.len2, o.len),
          h = i.length;
        if (r.ins == -1) {
          let c = o.ins == -1 ? -1 : o.off ? 0 : o.ins;
          (vt(i, l, c, a), n && c && He(n, i, o.text));
        } else
          o.ins == -1
            ? (vt(i, r.off ? 0 : r.len, l, a), n && He(n, i, r.textBit(l)))
            : (vt(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, a),
              n && !o.off && He(n, i, o.text));
        ((a = (r.ins > l || (o.ins >= 0 && o.len > l)) && (a || i.length > h)),
          r.forward2(l),
          o.forward(l));
      }
    }
...
var Ri = class {
    ...
    textBit(t) {
      ...
      return i >= e.length && !t
        ? B.empty
        : e[i].slice(this.off, t == null ? void 0 : this.off + t);
    }
    forward(t) {
  ...
  Ke = class {
    ...
    map(t, e = -1) {
      ...
      return (
        ...
        i == this.from && n == this.to ? this : new Ke(i, n, this.flags)
      );
    }
    extend(t, e = t) {
  ...
  k = class {
    ...
    static range(t, e, i, n) {
      ...
      return e < t
        ? Ke.create(e, t, 32 | 16 | r)
        : Ke.create(t, e, (e > t ? 8 : 0) | r);
    }
    static normalized(t, e = 0) {
      ...
      for (let n = 1; n < t.length; n++) {
        ...
        if (r.empty ? r.from <= o.to : r.from < o.to) {
          let a = o.from,
            l = Math.max(r.to, o.to);
          (n <= e && e--,
            t.splice(
              --n,
              2,
              r.anchor > r.head ? k.range(l, a) : k.range(a, l),
            ));
        }
      }
      return new k(t, e);
...
var no = 0,
  M = class {
    ...
    static define(t = {}) {
      return new M(
        t.combine || ((e) => e),
        t.compareInput || ((e, i) => e === i),
        t.compare || (t.combine ? (e, i) => e === i : so),
        !!t.static,
        t.enables,
      );
    }
    of(t) {
      return new mn([], this, 0, t);
    }
    compute(t, e) {
      if (this.isStatic) throw new Error("Can't compute a static facet");
      return new mn(t, this, 1, e);
    }
    computeN(t, e) {
      if (this.isStatic) throw new Error("Can't compute a static facet");
      return new mn(t, this, 2, e);
    }
    from(t, e) {
  ...
  dynamicSlot(t) {
    ...
    for (let f of this.dependencies)
      f == "doc"
        ...
        : f == "selection"
          ? (h = !0)
          : (((e = t[f.id]) !== null && e !== void 0 ? e : 1) & 1) == 0 &&
            c.push(t[f.id]);
    return {
      create(f) {
      ...
      update(f, u) {
        if (
          ...
          let d = i(f);
          if (a ? !Fl(d, f.values[o], n) : !n(d, f.values[o]))
...
function Fl(s, t, e) {
  ...
  for (let i = 0; i < s.length; i++) if (!e(s[i], t[i])) return !1;
  return !0;
}
function ro(s, t) {
  let e = !1;
  for (let i of t) yn(s, i) & 1 && (e = !0);
  return e;
}
function YO(s, t, e) {
  let i = e.map((l) => s[l.id]),
    n = e.map((l) => l.type),
    r = i.filter((l) => !(l & 1)),
    o = s[t.id] >> 1;
  function a(l) {
    ...
    for (let c = 0; c < i.length; c++) {
      let f = Ps(l, i[c]);
      if (n[c] == 2) for (let u of f) h.push(u);
      else h.push(f);
    }
    return t.combine(h);
  }
  return {
    create(l) {
      for (let h of i) yn(l, h);
      return ((l.values[o] = a(l)), 1);
    },
    update(l, h) {
      if (!ro(l, r)) return 0;
      let c = a(l);
      return t.compare(c, l.values[o]) ? 0 : ((l.values[o] = c), 1);
    },
    reconfigure(l, h) {
      let c = ro(l, i),
        f = h.config.facets[t.id],
        u = h.facet(t);
      if (f && !c && so(e, f)) return ((l.values[o] = u), 0);
      let d = a(l);
      return t.compare(d, u) ? ((l.values[o] = u), 0) : ((l.values[o] = d), 1);
    },
  };
}
var Hl = M.define({ static: !0 }),
  Wt = class {
    constructor(t, e, i, n, r) {
      ((this.id = t),
        (this.createF = e),
    ...
    create(t) {
      let e = t.facet(Hl).find((i) => i.field == this);
    ...
    slot(t) {
      ...
      return {
        ...
        reconfigure: (i, n) =>
          n.config.address[this.id] != null
            ? ((i.values[e] = n.field(this)), 0)
            : ((i.values[e] = this.create(i)), 1),
      };
    }
    init(t) {
      return [this, Hl.of({ field: this, create: t })];
    }
    get extension() {
      return this;
    }
...
var be = {
    highest: gn(fi.highest),
    high: gn(fi.high),
    default: gn(fi.default),
    low: gn(fi.low),
    lowest: gn(fi.lowest),
  },
  oo = class {
  ...
  bn = class {
    ...
    reconfigure(t) {
      return bn.reconfigure.of({ compartment: this, extension: t });
    }
    get(t) {
  ...
  Sn = class {
    ...
    static resolve(t, e, i) {
      ...
      let a = Object.create(null),
        l = [],
        h = [];
      for (let u of n) ((a[u.id] = h.length << 1), h.push((d) => u.slot(d)));
      ...
      for (let u in r) {
        ...
        if (d.every((g) => g.type == 0))
          if (((a[p.id] = (l.length << 1) | 1), so(O, d))) l.push(i.facet(p));
          else {
          ...
          for (let g of d)
            g.type == 0
              ? ((a[g.id] = (l.length << 1) | 1), l.push(g.value))
              : ((a[g.id] = h.length << 1), h.push((b) => g.dynamicSlot(b)));
          ((a[p.id] = h.length << 1), h.push((g) => YO(g, p, d)));
        }
      }
      let f = h.map((u) => u(a));
      return new Sn(t, o, f, a, l, r);
    }
  };
function NO(s, t, e) {
  let i = [[], [], [], [], []],
  ...
  function r(o, a) {
    ...
    if (l != null) {
      if (l <= a) return;
      let h = i[l].indexOf(o);
      (h > -1 && i[l].splice(h, 1), o instanceof Qs && e.delete(o.compartment));
    }
    if ((n.set(o, a), Array.isArray(o))) for (let h of o) r(h, a);
    else if (o instanceof Qs) {
      if (e.has(o.compartment))
        throw new RangeError("Duplicate use of compartment in extensions");
      let h = t.get(o.compartment) || o.inner;
      (e.set(o.compartment, h), r(h, a));
    } else if (o instanceof oo) r(o.inner, o.prec);
    else if (o instanceof Wt) (i[a].push(o), o.provides && r(o.provides, a));
    else if (o instanceof mn)
      (i[a].push(o), o.facet.extensions && r(o.facet.extensions, fi.default));
    else {
      let h = o.extension;
      if (!h)
        throw new Error(
  ...
  return (r(s, fi.default), i.reduce((o, a) => o.concat(a)));
}
function yn(s, t) {
  if (t & 1) return 2;
  let e = t >> 1,
...
var Kl = M.define(),
  ao = M.define({ combine: (s) => s.some((t) => t), static: !0 }),
  Jl = M.define({ combine: (s) => (s.length ? s[0] : void 0), static: !0 }),
  th = M.define(),
  eh = M.define(),
  ih = M.define(),
  nh = M.define({ combine: (s) => (s.length ? s[0] : !1) }),
  Se = class {
    constructor(t, e) {
...
tt.reconfigure = tt.define();
tt.appendConfig = tt.define();
var ct = class {
  constructor(t, e, i, n, r, o) {
    ((this.startState = t),
      (this.changes = e),
...
ct.time = Se.define();
ct.userEvent = Se.define();
ct.addToHistory = Se.define();
ct.remote = Se.define();
function qO(s, t) {
  let e = [];
  for (let i = 0, n = 0; ;) {
    ...
    if (i < s.length && (n == t.length || t[n] >= s[i]))
      ((r = s[i++]), (o = s[i++]));
    else if (n < t.length) ((r = t[n++]), (o = t[n++]));
    else return e;
    !e.length || e[e.length - 1] < r
      ? e.push(r, o)
      : e[e.length - 1] < o && (e[e.length - 1] = o);
  }
}
function oh(s, t, e) {
  var i;
  ...
  return (
    e
      ? ((n = t.changes),
        (r = ht.empty(t.changes.length)),
        (o = s.changes.compose(t.changes)))
      : ((n = t.changes.map(s.changes)),
        (r = s.changes.mapDesc(t.changes, !0)),
        (o = s.changes.compose(n))),
    {
      changes: o,
      selection: t.selection
        ? t.selection.map(r)
        : (i = s.selection) === null || i === void 0
          ? void 0
          : i.map(n),
      effects: tt.mapEffects(s.effects, n).concat(tt.mapEffects(t.effects, r)),
      annotations: s.annotations.length
        ? s.annotations.concat(t.annotations)
        : t.annotations,
...
function lo(s, t, e) {
  let i = t.selection,
    n = Li(t.annotations);
  return (
    t.userEvent && (n = n.concat(ct.userEvent.of(t.userEvent))),
    {
      changes:
        t.changes instanceof ht
          ? t.changes
          : ht.of(t.changes || [], e, s.facet(Jl)),
      selection: i && (i instanceof k ? i : k.single(i.anchor, i.head)),
      effects: Li(t.effects),
      annotations: n,
...
function ah(s, t, e) {
  let i = lo(s, t.length ? t[0] : {}, s.doc.length);
  t.length && t[0].filter === !1 && (e = !1);
  for (let r = 1; r < t.length; r++) {
    t[r].filter === !1 && (e = !1);
    let o = !!t[r].sequential;
    i = oh(i, lo(s, t[r], o ? i.changes.newLength : s.doc.length), o);
  }
  let n = ct.create(
    s,
    i.changes,
...
function WO(s) {
  let t = s.startState,
    e = !0;
  for (let n of t.facet(th)) {
    let r = n(s);
    if (r === !1) {
      e = !1;
      break;
    }
    Array.isArray(r) && (e = e === !0 ? r : qO(e, r));
  }
  if (e !== !0) {
    let n, r;
    if (e === !1) ((r = s.changes.invertedDesc), (n = ht.empty(t.doc.length)));
    else {
    ...
    s = ct.create(
      t,
      n,
      s.selection && s.selection.map(r),
      tt.mapEffects(s.effects, r),
      s.annotations,
      s.scrollIntoView,
    );
  }
  ...
  for (let n = i.length - 1; n >= 0; n--) {
    ...
    r instanceof ct
      ? (s = r)
      : Array.isArray(r) && r.length == 1 && r[0] instanceof ct
        ? (s = r[0])
        : (s = ah(t, Li(r), !1));
  }
  return s;
...
function _O(s) {
  ...
  for (let n = e.length - 1; n >= 0; n--) {
    ...
    r &&
      ...
      (i = oh(i, lo(t, r, s.changes.newLength), !0));
  }
  return i == s
    ? s
    : ct.create(
...
var GO = [];
function Li(s) {
  return s == null ? GO : Array.isArray(s) ? s : [s];
}
var ne = (function (s) {
    return (
      (s[(s.Word = 0)] = "Word"),
  ...
  ho;
try {
  ho = new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch (s) {}
function FO(s) {
  if (ho) return ho.test(s);
  for (let t = 0; t < s.length; t++) {
    let e = s[t];
    if (
      /\w/.test(e) ||
      (e > "\x80" && (e.toUpperCase() != e.toLowerCase() || UO.test(e)))
    )
      return !0;
  }
  return !1;
...
function HO(s) {
  return (t) => {
    if (!/\S/.test(t)) return ne.Space;
    if (FO(t)) return ne.Word;
    for (let e = 0; e < s.length; e++) if (t.indexOf(s[e]) > -1) return ne.Word;
    return ne.Other;
  };
}
var I = class {
  constructor(t, e, i, n, r, o) {
    ((this.config = t),
      ...
      (this.computeSlot = r),
      o && (o._state = this));
    for (let a = 0; a < this.config.dynamicSlots.length; a++) yn(this, a << 1);
  ...
  applyTransaction(t) {
    let e = this.config,
      { base: i, compartments: n } = e;
    for (let a of t.effects)
      a.is(bn.reconfigure)
        ? (e &&
            ((n = new Map()),
            e.compartments.forEach((l, h) => n.set(h, l)),
            (e = null)),
          n.set(a.value.compartment, a.value.extension))
        : a.is(tt.reconfigure)
          ? ((e = null), (i = a.value))
          : a.is(tt.appendConfig) && ((e = null), (i = Li(i).concat(a.value)));
    let r;
    e
      ? (r = t.startState.values.slice())
      : ((e = Sn.resolve(i, n, this)),
        (r = new I(
          e,
          this.doc,
          this.selection,
          e.dynamicSlots.map(() => null),
          (l, h) => h.reconfigure(l, this),
          null,
        ).values));
    let o = t.startState.facet(ao) ? t.newSelection : t.newSelection.asSingle();
    new I(e, t.newDoc, o, r, (a, l) => l.update(a, t), t);
  }
  replaceSelection(t) {
    return (
      typeof t == "string" && (t = this.toText(t)),
  ...
  changeByRange(t) {
    ...
    for (let a = 1; a < e.ranges.length; a++) {
      let l = t(e.ranges[a]),
        ...
        c = h.map(n);
      for (let u = 0; u < a; u++) r[u] = r[u].map(c);
      let f = n.mapDesc(h, !0);
      (r.push(l.range.map(f)),
        (n = n.compose(c)),
        (o = tt.mapEffects(o, c).concat(tt.mapEffects(Li(l.effects), f))));
    }
    return { changes: n, selection: k.create(r, e.mainIndex), effects: o };
  }
  changes(t = []) {
    return t instanceof ht
      ? t
      : ht.of(t, this.doc.length, this.facet(I.lineSeparator));
  }
  toText(t) {
    return B.of(t.split(this.facet(I.lineSeparator) || to));
  }
  ...
  facet(t) {
    ...
    return e == null ? t.default : (yn(this, e), Ps(this, e));
  }
  toJSON(t) {
  ...
  static create(t = {}) {
    let e = Sn.resolve(t.extensions || [], new Map()),
      i =
        t.doc instanceof B
          ? t.doc
          : B.of((t.doc || "").split(e.staticFacet(I.lineSeparator) || to)),
      n = t.selection
...
`
  ...
  wordAt(t) {
    ...
    for (; o > 0;) {
      let l = ie(e, o, !1);
      if (r(e.slice(l, o)) != ne.Word) break;
      o = l;
    }
    for (; a < n;) {
      let l = ie(e, a);
      if (r(e.slice(a, l)) != ne.Word) break;
      a = l;
    }
    return o == a ? null : k.range(o + i, a + i);
  }
};
I.allowMultipleSelections = ao;
I.tabSize = M.define({ combine: (s) => (s.length ? s[0] : 4) });
I.lineSeparator = Jl;
I.readOnly = nh;
I.phrases = M.define({
  compare(s, t) {
...
I.languageData = Kl;
I.changeFilter = th;
I.transactionFilter = eh;
I.transactionExtender = ih;
bn.reconfigure = tt.define();
function wn(s, t, e = {}) {
  let i = {};
  for (let n of s)
    for (let r of Object.keys(n)) {
      ...
      if (a === void 0) i[r] = o;
        ...
        if (Object.hasOwnProperty.call(e, r)) i[r] = e[r](a, o);
        else throw new Error("Config merge conflict for field " + r);
    }
  for (let n in t) i[n] === void 0 && (i[n] = t[n]);
  return i;
}
var ye = class {
  eq(t) {
  ...
  range(t, e = t) {
    return Ii.create(t, e, this);
  }
};
ye.prototype.startSide = ye.prototype.endSide = 0;
ye.prototype.point = !1;
ye.prototype.mapMode = gt.TrackDel;
var Ii = class {
  constructor(t, e, i) {
    ...
    findIndex(t, e, i, n = 0) {
      ...
      for (let o = n, a = r.length; ;) {
        ...
        let l = (o + a) >> 1,
          h =
            r[l] - t ||
            (i ? this.value[l].endSide : this.value[l].startSide) - e;
        if (l == o) return h >= 0 ? o : a;
        h >= 0 ? (a = l) : (o = l + 1);
      }
    }
    between(t, e, i, n) {
      for (
        let r = this.findIndex(e, -1e9, !0), o = this.findIndex(i, 1e9, !1, r);
        r < o;
        r++
      )
      ...
      for (let l = 0; l < this.value.length; l++) {
        ...
        if (c == f) {
          ...
          if (
            p == null ||
            ((u = d = p),
            h.startSide != h.endSide && ((d = e.mapPos(c, h.endSide)), d < u))
          )
            continue;
        } else if (
          ((u = e.mapPos(c, h.startSide)),
          (d = e.mapPos(f, h.endSide)),
          u > d || (u == d && h.startSide > 0 && h.endSide <= 0))
        )
          continue;
        (d - u || h.endSide - h.startSide) < 0 ||
          (o < 0 && (o = u),
          h.point && (a = Math.max(a, d - u)),
          i.push(h),
          n.push(u - o),
          r.push(d - o));
      }
      return { mapped: i.length ? new $s(n, r, i, a) : null, pos: o };
    }
  },
  _ = class {
    constructor(t, e, i, n) {
    ...
    update(t) {
      ...
      if ((i && (e = e.slice().sort(co)), this.isEmpty))
        return e.length ? _.of(e) : this;
      let a = new fo(this, null, -1).goto(0),
        l = 0,
        h = [],
        c = new Me();
      for (; a.value || l < e.length;)
        if (
          l < e.length &&
          (a.from - e[l].from || a.startSide - e[l].value.startSide) >= 0
        ) {
          let f = e[l++];
          ...
          (l == e.length || this.chunkEnd(a.chunkIndex) < e[l].from) &&
          (!o ||
            n > this.chunkEnd(a.chunkIndex) ||
            r < this.chunkPos[a.chunkIndex]) &&
          c.addChunk(this.chunkPos[a.chunkIndex], this.chunk[a.chunkIndex])
            ? a.nextChunk()
            : ((!o || n > a.to || r < a.from || o(a.from, a.to, a.value)) &&
                (c.addInner(a.from, a.to, a.value) ||
                  h.push(Ii.create(a.from, a.to, a.value))),
              a.next());
    ...
    static compare(t, e, i, n, r = -1) {
      let o = t.filter(
        ...
        a = e.filter((f) => f.maxPoint > 0 || (!f.isEmpty && f.maxPoint >= r)),
        l = lh(o, a, i),
        h = new Bi(o, l, r),
        c = new Bi(a, l, r);
      (i.iterGaps((f, u, d) => hh(h, f, c, u, d, n)),
        i.empty && i.length == 0 && hh(h, 0, c, 0, 0, n));
    }
    static eq(t, e, i = 0, n) {
      n == null && (n = 1e9 - 1);
      let r = t.filter((c) => !c.isEmpty && e.indexOf(c) < 0),
        o = e.filter((c) => !c.isEmpty && t.indexOf(c) < 0);
      if (r.length != o.length) return !1;
      if (!r.length) return !0;
      let a = lh(r, o),
        l = new Bi(r, a, 0).goto(i),
        h = new Bi(o, a, 0).goto(i);
      for (;;) {
        if (
          l.to != h.to ||
          !po(l.active, h.active) ||
            ...
            f =
              o.pointFrom < e
                ...
                : o.point.startSide < 0
                  ? c.length
                  : Math.min(c.length, l);
          (n.point(a, h, o.point, c, f, o.pointRank),
            (l = Math.min(o.openEnd(h), c.length)));
    ...
    static of(t, e = !1) {
      let i = new Me();
      for (let n of t instanceof Ii ? [t] : e ? KO(t) : t)
        i.add(n.from, n.to, n.value);
      return i.finish();
    }
    static join(t) {
      if (!t.length) return _.empty;
      let e = t[t.length - 1];
      for (let i = t.length - 2; i >= 0; i--)
        for (let n = t[i]; n != _.empty; n = n.nextLayer)
          e = new _(n.chunkPos, n.chunk, e, Math.max(n.maxPoint, e.maxPoint));
      return e;
    }
  };
...
function KO(s) {
  if (s.length > 1)
    for (let t = s[0], e = 1; e < s.length; e++) {
      let i = s[e];
      if (co(t, i) > 0) return s.slice().sort(co);
      t = i;
    }
  return s;
}
...
var Me = class {
  finishChunk(t) {
    (this.chunks.push(new $s(this.from, this.to, this.value, this.maxPoint)),
  ...
  add(t, e, i) {
    this.addInner(t, e, i) ||
      (this.nextLayer || (this.nextLayer = new Me())).add(t, e, i);
  }
  addInner(t, e, i) {
...
function lh(s, t, e) {
  ...
  for (let r of t)
    for (let o = 0; o < r.chunk.length; o++) {
      ...
      a != null &&
        (e ? e.mapPos(a) : a) == r.chunkPos[o] &&
        !(e == null ? void 0 : e.touchesRange(a, a + r.chunk[o].length)) &&
        n.add(r.chunk[o]);
    }
  return n;
}
var fo = class {
    ...
    gotoInner(t, e, i) {
      for (; this.chunkIndex < this.layer.chunk.length;) {
        ...
        if (!(
          (this.skip && this.skip.has(n)) ||
          this.layer.chunkEnd(this.chunkIndex) < t ||
          n.maxPoint < this.minPoint
        ))
          break;
        (this.chunkIndex++, (i = !1));
      }
  ...
  Di = class {
    ...
    static from(t, e = null, i = -1) {
      ...
      for (let r = 0; r < t.length; r++)
        for (let o = t[r]; !o.isEmpty; o = o.nextLayer)
          o.maxPoint >= i && n.push(new fo(o, e, i, r));
    ...
    goto(t, e = -1e9) {
      ...
      for (let i = this.heap.length >> 1; i >= 0; i--) uo(this.heap, i);
...
function uo(s, t) {
  for (let e = s[t]; ;) {
    ...
    let n = s[i];
    if (
      (i + 1 < s.length && n.compare(s[i + 1]) >= 0 && ((n = s[i + 1]), i++),
      e.compare(n) < 0)
    )
      break;
    ((s[i] = e), (s[t] = n), (t = i));
...
var Bi = class {
  ...
  removeActive(t) {
    (Ts(this.active, t),
      Ts(this.activeTo, t),
      Ts(this.activeRank, t),
      (this.minActive = ch(this.active, this.activeTo)));
  }
  addActive(t) {
    let e = 0,
    ...
    for (
      ...
      e++;
    (Cs(this.active, e, i),
      Cs(this.activeTo, e, n),
      Cs(this.activeRank, e, r),
      t && Cs(t, e, this.cursor.from),
      (this.minActive = ch(this.active, this.activeTo)));
  }
  next() {
    let t = this.to,
    ...
    if (i) {
      this.openStart = 0;
      for (let n = i.length - 1; n >= 0 && i[n] < t; n--) this.openStart++;
    }
  }
  activeForPoint(t) {
  ...
  for (;;) {
    ...
    if (
      (s.point || e.point
        ? (s.point &&
            e.point &&
            (s.point == e.point || s.point.eq(e.point)) &&
            po(s.activeForPoint(s.to), e.activeForPoint(e.to))) ||
          r.comparePoint(a, u, s.point, e.point)
        : u > a &&
          !po(s.active, e.active) &&
          r.compareRange(a, u, s.active, e.active),
      f > o)
    )
      break;
    ((h || s.openEnd != e.openEnd) && r.boundChange && r.boundChange(f),
      (a = f),
      c <= 0 && s.next(),
      c >= 0 && e.next());
  }
...
function po(s, t) {
  ...
  for (let e = 0; e < s.length; e++)
    if (s[e] != t[e] && !s[e].eq(t[e])) return !1;
  return !0;
}
function Ts(s, t) {
  for (let e = t, i = s.length - 1; e < i; e++) s[e] = s[e + 1];
  s.pop();
}
function Cs(s, t, e) {
  for (let i = s.length - 1; i >= t; i--) s[i + 1] = s[i];
  s[t] = e;
}
function ch(s, t) {
  let e = -1,
...
function we(s, t, e = s.length) {
  let i = 0;
  for (let n = 0; n < e;)
    s.charCodeAt(n) == 9 ? ((i += t - (i % t)), n++) : (i++, (n = ie(s, n)));
  return i;
}
function fh(s, t, e, i) {
  for (let n = 0, r = 0; ;) {
    if (r >= t) return n;
    if (n == s.length) break;
    ((r += s.charCodeAt(n) == 9 ? e - (r % e) : 1), (n = ie(s, n)));
  }
  return i === !0 ? -1 : s.length;
}
var Oo = "\u037C",
  uh = typeof Symbol == "undefined" ? "__" + Oo : Symbol.for(Oo),
  mo =
    typeof Symbol == "undefined"
...
`);
    ...
    static newName() {
      let t = dh[uh] || 1;
      return ((dh[uh] = t + 1), Oo + t.toString(36));
    }
    static mount(t, e, i) {
      let n = t[mo],
        r = i && i.nonce;
      (n ? r && n.setNonce(r) : (n = new Oh(t, r)),
  ...
  Oh = class {
    ...
    mount(t, e) {
      ...
      for (let o = 0; o < t.length; o++) {
        ...
        if (
          (l < r && l > -1 && (this.modules.splice(l, 1), r--, (l = -1)),
          l == -1)
        ) {
          if ((this.modules.splice(r++, 0, a), i))
            for (let h = 0; h < a.rules.length; h++)
...
var Xe = {
  ...
  JO = typeof navigator != "undefined" && /Mac/.test(navigator.platform),
  tm =
    typeof navigator != "undefined" &&
    /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (ft = 0; ft < 10; ft++) Xe[48 + ft] = Xe[96 + ft] = String(ft);
var ft;
for (ft = 1; ft <= 24; ft++) Xe[ft + 111] = "F" + ft;
var ft;
for (ft = 65; ft <= 90; ft++)
  ((Xe[ft] = String.fromCharCode(ft + 32)), (zi[ft] = String.fromCharCode(ft)));
var ft;
for (As in Xe) zi.hasOwnProperty(As) || (zi[As] = Xe[As]);
var As;
function mh(s) {
  var t =
      (JO && s.metaKey && s.shiftKey && !s.ctrlKey && !s.altKey) ||
      (tm && s.shiftKey && s.key && s.key.length == 1) ||
      s.key == "Unidentified",
    e =
      (!t && s.key) ||
      (s.shiftKey ? zi : Xe)[s.keyCode] ||
      s.key ||
      "Unidentified";
  return (
    e == "Esc" && (e = "Escape"),
...
var Tt =
  ...
  bo = /Edge\/(\d+)/.exec(Tt.userAgent),
  gh = /MSIE \d/.test(Tt.userAgent),
  So = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(Tt.userAgent),
  Es = !!(gh || So || bo),
  bh = !Es && /gecko\/(\d+)/i.test(Tt.userAgent),
  yo = !Es && /Chrome\/(\d+)/.exec(Tt.userAgent),
  Sh = "webkitFontSmoothing" in go.documentElement.style,
  wo = !Es && /Apple Computer/.test(Tt.vendor),
  yh = wo && (/Mobile\/\w+/.test(Tt.userAgent) || Tt.maxTouchPoints > 2),
  T = {
    mac: yh || /Mac/.test(Tt.platform),
    windows: /Win/.test(Tt.platform),
    linux: /Linux|X11/.test(Tt.platform),
    ie: Es,
    ie_version: gh ? go.documentMode || 6 : So ? +So[1] : bo ? +bo[1] : 0,
    gecko: bh,
    gecko_version: bh ? +(/Firefox\/(\d+)/.exec(Tt.userAgent) || [0, 0])[1] : 0,
    chrome: !!yo,
    chrome_version: yo ? +yo[1] : 0,
    ios: yh,
    android: /Android\b/.test(Tt.userAgent),
    webkit: Sh,
    webkit_version: Sh
      ? +(/\bAppleWebKit\/(\d+)/.exec(Tt.userAgent) || [0, 0])[1]
      : 0,
    safari: wo,
    safari_version: wo
      ? +(/\bVersion\/(\d+(\.\d+)?)/.exec(Tt.userAgent) || [0, 0])[1]
      : 0,
    tabSize:
      go.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size",
  };
function vn(s) {
  let t;
  return (
    s.nodeType == 11 ? (t = s.getSelection ? s : s.ownerDocument) : (t = s),
    t.getSelection()
  );
}
function vo(s, t) {
...
function xn(s) {
  return s.nodeType == 3
    ? pi(s, 0, s.nodeValue.length).getClientRects()
    : s.nodeType == 1
      ? s.getClientRects()
      : [];
}
function kn(s, t, e, i) {
  return e ? wh(s, t, e, i, -1) || wh(s, t, e, i, 1) : !1;
}
function ui(s) {
  for (var t = 0; ; t++) if (((s = s.previousSibling), !s)) return t;
}
function Ms(s) {
  return (
    s.nodeType == 1 &&
    /^(DIV|P|LI|UL|OL|BLOCKQUOTE|DD|DT|H\d|SECTION|PRE)$/.test(s.nodeName)
  );
}
function wh(s, t, e, i, n) {
  for (;;) {
    if (s == e && t == i) return !0;
    if (t == (n < 0 ? 0 : ve(s))) {
      if (s.nodeName == "DIV") return !1;
      let r = s.parentNode;
      if (!r || r.nodeType != 1) return !1;
      ((t = ui(s) + (n < 0 ? 0 : 1)), (s = r));
    } else if (s.nodeType == 1) {
      if (
        ((s = s.childNodes[t + (n < 0 ? -1 : 0)]),
        s.nodeType == 1 && s.contentEditable == "false")
      )
        return !1;
      t = n < 0 ? ve(s) : 0;
    } else return !1;
...
function em(s) {
  ...
  return t
    ...
    : { left: 0, right: s.innerWidth, top: 0, bottom: s.innerHeight };
}
function vh(s, t) {
  let e = t.width / s.offsetWidth,
    i = t.height / s.offsetHeight;
  return (
    ((e > 0.995 && e < 1.005) ||
      !isFinite(e) ||
      Math.abs(t.width - s.offsetWidth) < 1) &&
      (e = 1),
    ((i > 0.995 && i < 1.005) ||
      !isFinite(i) ||
      Math.abs(t.height - s.offsetHeight) < 1) &&
      (i = 1),
    { scaleX: e, scaleY: i }
  );
}
function im(s, t, e, i, n, r, o, a) {
  let l = s.ownerDocument,
  ...
  for (let c = s, f = !1; c && !f;)
    if (c.nodeType == 1) {
      ...
      if (n == "nearest")
        t.top < u.top
          ? ((b = t.top - (u.top + o)),
            e > 0 && t.bottom > u.bottom + b && (b = t.bottom - u.bottom + o))
          : t.bottom > u.bottom &&
            ((b = t.bottom - u.bottom + o),
            e < 0 && t.top - b < u.top && (b = t.top - (u.top + o)));
      else {
      ...
      if (
        (i == "nearest"
          ? t.left < u.left
            ? ((g = t.left - (u.left + r)),
              e > 0 && t.right > u.right + g && (g = t.right - u.right + r))
            : t.right > u.right &&
              ((g = t.right - u.right + r),
              e < 0 && t.left < u.left + g && (g = t.left - (u.left + r)))
          : (g =
              (i == "center"
                ? t.left + (t.right - t.left) / 2 - (u.right - u.left) / 2
                : (i == "start") == a
                  ? t.left - r
                  : t.right - (u.right - u.left) + r) - u.left),
        g || b)
      )
        if (d) h.scrollBy(g, b);
        else {
          ...
          if (b) {
            let C = c.scrollTop;
            ((c.scrollTop += b / O), (y = (c.scrollTop - C) * O));
          }
          if (g) {
            let C = c.scrollLeft;
            ((c.scrollLeft += g / p), (S = (c.scrollLeft - C) * p));
          }
          ((t = {
            left: t.left - S,
            top: t.top - y,
            ...
            S && Math.abs(S - g) < 1 && (i = "nearest"),
            y && Math.abs(y - b) < 1 && (n = "nearest"));
        }
      if (d) break;
      ((t.top < u.top ||
        t.bottom > u.bottom ||
  ...
  for (let n = s.parentNode; n && !(n == t.body || (e && i));)
    if (n.nodeType == 1)
      (!i && n.scrollHeight > n.clientHeight && (i = n),
        !e && n.scrollWidth > n.clientWidth && (e = n),
...
var xh = class {
    ...
    setRange(t) {
      ...
      this.set(
        e,
        Math.min(t.anchorOffset, e ? ve(e) : 0),
        i,
        Math.min(t.focusOffset, i ? ve(i) : 0),
      );
    }
    set(t, e, i, n) {
      ((this.anchorNode = t),
  ...
  di = null;
T.safari && T.safari_version >= 26 && (di = !1);
function kh(s) {
  if (s.setActive) return s.setActive();
  if (di) return s.focus(di);
  let t = [];
  for (
    let e = s;
    e && (t.push(e, e.scrollTop, e.scrollLeft), e != e.ownerDocument);
    e = e.parentNode
  );
  if (
    (s.focus(
...
var Qh;
function pi(s, t, e = t) {
  let i = Qh || (Qh = document.createRange());
...
function sm(s) {
  for (; s;) {
    if (s && (s.nodeType == 9 || (s.nodeType == 11 && s.host))) return s;
    s = s.assignedSlot || s.parentNode;
  }
  return null;
}
function Ph(s) {
  for (; s.attributes.length;) s.removeAttributeNode(s.attributes[0]);
}
function rm(s, t) {
  let e = t.focusNode,
    i = t.focusOffset;
  if (!e || t.anchorNode != e || t.anchorOffset != i) return !1;
  for (i = Math.min(i, ve(e)); ;)
    if (i) {
      if (e.nodeType != 1) return !1;
      let n = e.childNodes[i - 1];
      n.contentEditable == "false" ? i-- : ((e = n), (i = ve(e)));
    } else {
      if (e == s) return !0;
      ((i = ui(e)), (e = e.parentNode));
    }
}
function $h(s) {
...
function Th(s, t) {
  for (let e = s, i = t; ;) {
    if (e.nodeType == 3 && i > 0) return { node: e, offset: i };
    if (e.nodeType == 1 && i > 0) {
      if (e.contentEditable == "false") return null;
      ((e = e.childNodes[i - 1]), (i = ve(e)));
    } else if (e.parentNode && !Ms(e)) ((i = ui(e)), (e = e.parentNode));
    else return null;
  }
}
function Ch(s, t) {
  for (let e = s, i = t; ;) {
    ...
    } else if (e.parentNode && !Ms(e)) ((i = ui(e) + 1), (e = e.parentNode));
    else return null;
  }
}
var bt = class {
    ...
    static before(t, e) {
      return new bt(t.parentNode, ui(t), e);
    }
    static after(t, e) {
      return new bt(t.parentNode, ui(t) + 1, e);
    }
  },
  xo = [],
  G = class {
        ...
        for (let o of this.children) {
          if (o.flags & 7) {
            if (!o.dom && (r = n ? n.nextSibling : i.firstChild)) {
              let a = G.get(r);
              (!a || (!a.parent && a.canReuseDOM(o))) && o.reuseDOM(r);
            }
            (o.sync(t, e), (o.flags &= ~7));
          }
          if (
            ((r = n ? n.nextSibling : i.firstChild),
            e && !e.written && e.node == i && r != o.dom && (e.written = !0),
            o.dom.parentNode == i)
          )
            for (; r && r != o.dom;) r = Ah(r);
          else i.insertBefore(o.dom, r);
          n = o.dom;
        }
        for (
          r = n ? n.nextSibling : i.firstChild,
            r && e && e.node == i && (e.written = !0);
          r;
        )
          r = Ah(r);
      } else if (this.flags & 1)
        for (let i of this.children)
          i.flags & 7 && (i.sync(t, e), (i.flags &= ~7));
    }
    reuseDOM(t) {}
    localPosFromDOM(t, e) {
      let i;
      if (t == this.dom) i = this.dom.childNodes[e];
        ...
        let n = ve(t) == 0 ? 0 : e == 0 ? -1 : 1;
        for (;;) {
          let r = t.parentNode;
          if (r == this.dom) break;
          (n == 0 &&
            r.firstChild != r.lastChild &&
            (t == r.firstChild ? (n = -1) : (n = 1)),
            (t = r));
        }
    ...
    domBoundsAround(t, e, i = 0) {
      let n = -1,
        ...
        o = -1,
        a = -1;
      for (let l = 0, h = i, c = i; l < this.children.length; l++) {
        let f = this.children[l],
          u = h + f.length;
        if (h < t && u > e) return f.domBoundsAround(t, e, h);
        if (
          (u >= t && n == -1 && ((n = l), (r = h)),
          h > e && f.dom.parentNode == this.dom)
        ) {
          ((o = l), (a = c));
          break;
        }
    ...
    setParent(t) {
      this.parent != t &&
        ((this.parent = t), this.flags & 7 && this.markParentsDirty(!0));
    }
    setDOM(t) {
      this.dom != t &&
    ...
    childCursor(t = this.length) {
      return new ko(this.children, t, this.children.length);
    }
    childPos(t, e = 1) {
  ...
  findPos(t, e = 1) {
    for (;;) {
      if (
        t > this.pos ||
        (t == this.pos &&
          (e > 0 || this.i == 0 || this.children[this.i - 1].breakAfter))
      )
...
function Eh(s, t, e, i, n, r, o, a, l) {
  ...
  if (!(
    ...
    !u &&
    r.length < 2 &&
    c.merge(e, n, r.length ? f : null, e == 0, a, l)
  )) {
    if (i < h.length) {
      let d = h[i];
      (d &&
      (n < d.length || (d.breakAfter && (f == null ? void 0 : f.breakAfter)))
        ? (t == i && ((d = d.split(n)), (n = 0)),
          !u && f && d.merge(0, n, f, !0, 0, l)
            ? (r[r.length - 1] = d)
            : ((n || (d.children.length && !d.children[0].length)) &&
                d.merge(0, n, null, !1, 0, l),
              r.push(d)))
        : (d == null ? void 0 : d.breakAfter) &&
          (f ? (f.breakAfter = 1) : (o = 1)),
        i++);
    }
    for (
      c &&
      ((c.breakAfter = o),
      e > 0 &&
        (!o && r.length && c.merge(e, c.length, r[0], !1, a, 0)
          ? (c.breakAfter = r.shift().breakAfter)
          : (e < c.length ||
              (c.children.length &&
                c.children[c.children.length - 1].length == 0)) &&
            c.merge(e, c.length, null, !1, a, 0),
        t++));
      t < i && r.length;
    )
      if (h[i - 1].become(r[r.length - 1]))
        (i--, r.pop(), (l = r.length ? 0 : a));
      else if (h[t].become(r[0])) (t++, r.shift(), (a = r.length ? 0 : l));
      else break;
    (!r.length &&
      t &&
      i < h.length &&
      ...
      t--,
      (t < i || r.length) && s.replaceChildren(t, i, r));
  }
}
function Zh(s, t, e, i, n, r) {
  let o = s.childCursor(),
    { i: a, off: l } = o.findPos(e, 1),
    { i: h, off: c } = o.findPos(t, -1),
    f = t - e;
  for (let u of i) f += u.length;
  ((s.length += f), Eh(s, h, c, a, l, i, 0, n, r));
}
var om = 256,
  _t = class extends G {
    constructor(t) {
    ...
    split(t) {
      let e = new _t(this.text.slice(t));
      return (
  ...
  xe = class extends G {
    ...
    merge(t, e, i, n, r, o) {
      return i &&
        (!(i instanceof xe && i.mark.eq(this.mark)) ||
          (t && r <= 0) ||
          (e < this.length && o <= 0))
        ? !1
        : (Zh(this, t, e, i ? i.children.slice() : [], r - 1, o - 1),
          this.markDirty(),
          !0);
    }
    split(t) {
...
function am(s, t, e) {
  ...
  let n = t,
    ...
    o = 0;
  (t == 0 && e < 0) || (t == i && e >= 0)
    ? T.chrome || T.gecko || (t ? (n--, (o = 1)) : r < i && (r++, (o = -1)))
    : e < 0
      ? n--
      : r < i && r++;
  let a = pi(s, n, r).getClientRects();
  ...
  return (
    T.safari &&
      !o &&
      l.width == 0 &&
      (l = Array.prototype.find.call(a, (h) => h.width) || l),
    o ? Xs(l, o < 0) : l || null
  );
}
var Je = class extends G {
    ...
    split(t) {
      let e = Je.create(this.widget, this.length - t, this.side);
    ...
    get overrideDOMText() {
      ...
      let { view: e } = t,
        i = e && e.state.doc,
        n = this.posAtStart;
      return i ? i.slice(n, n + this.length) : B.empty;
    }
    domAtPos(t) {
      return (this.length ? t == 0 : this.side > 0)
        ? bt.before(this.dom)
        : bt.after(this.dom, t == this.length);
    }
    domBoundsAround() {
      return null;
    }
    coordsAt(t, e) {
      ...
      for (
        let a = o ? n.length - 1 : 0;
        (r = n[a]), !(t > 0 ? a == 0 : a == n.length - 1 || r.top < r.bottom);
        a += o ? -1 : 1
      );
      return Xs(r, !o);
    }
  ...
  Oi = class extends G {
    ...
    become(t) {
      return t instanceof Oi && t.side == this.side;
    }
    split() {
...
_t.prototype.children = Je.prototype.children = Oi.prototype.children = xo;
function Mh(s, t) {
  let e = s.dom,
    { children: i } = s,
    n = 0;
  for (let r = 0; n < i.length; n++) {
    let o = i[n],
      a = r + o.length;
    if (!(a == r && o.getSide() <= 0)) {
      if (t > r && t < a && o.dom.parentNode == e) return o.domAtPos(t - r);
      if (t <= r) break;
      r = a;
    }
  }
...
function Xh(s, t, e) {
  ...
  t instanceof xe &&
  n.length &&
  (i = n[n.length - 1]) instanceof xe &&
  i.mark.eq(t.mark)
    ? Xh(i, t.children[0], e - 1)
    : (n.push(t), t.setParent(s)),
    (s.length += t.length));
}
function Rh(s, t, e) {
  let i = null,
  ...
  a(s, t);
  let l = (e < 0 ? i : r) || i || r;
  return l ? l.coordsAt(Math.max(0, l == i ? n : o), e) : lm(s);
}
function lm(s) {
  let t = s.dom.lastChild;
  if (!t) return s.dom.getBoundingClientRect();
  let e = xn(t);
  return e[e.length - 1] || null;
}
function hm(s, t) {
  let e = s.coordsAt(0, 1),
    i = t.coordsAt(0, 1);
...
function Rs(s, t, e) {
  ...
  let i = Object.keys(s),
    n = Object.keys(t);
  if (
    i.length - (e && i.indexOf(e) > -1 ? 1 : 0) !=
    n.length - (e && n.indexOf(e) > -1 ? 1 : 0)
  )
    return !1;
  for (let r of i)
    if (r != e && (n.indexOf(r) == -1 || s[r] !== t[r])) return !1;
  return !0;
}
function Po(s, t, e) {
  let i = !1;
  if (t)
    for (let n in t)
      (e && n in e) ||
        ((i = !0),
        n == "style" ? (s.style.cssText = "") : s.removeAttribute(n));
  if (e)
    for (let n in e)
      (t && t[n] == e[n]) ||
        ((i = !0),
        n == "style" ? (s.style.cssText = e[n]) : s.setAttribute(n, e[n]));
  return i;
}
function cm(s) {
...
var Re = class {
  ...
  Bt = (function (s) {
    return (
      (s[(s.Text = 0)] = "Text"),
      (s[(s.WidgetBefore = 1)] = "WidgetBefore"),
      (s[(s.WidgetAfter = 2)] = "WidgetAfter"),
      (s[(s.WidgetRange = 3)] = "WidgetRange"),
      s
    );
  })(Bt || (Bt = {})),
  q = class extends ye {
    ...
    static widget(t) {
      ...
      return (
        ...
        new Le(t, e, e, i, t.widget || null, !1)
      );
    }
    static replace(t) {
      let e = !!t.block,
        i,
        n;
      if (t.isBlockGap) ((i = -5e8), (n = 4e8));
      else {
        let { start: r, end: o } = Ih(t, e);
        ((i = (r ? (e ? -3e8 : -1) : 5e8) - 1),
          (n = (o ? (e ? 2e8 : 1) : -6e8) + 1));
      }
      return new Le(t, i, n, e, t.widget || null, !0);
    }
    static line(t) {
      return new Yi(t);
    }
...
q.none = _.empty;
var ji = class extends q {
  constructor(t) {
    let { start: e, end: i } = Ih(t);
  ...
  eq(t) {
    ...
    return (
      ...
      (t instanceof ji &&
        ...
        (this.class ||
          ((e = this.attrs) === null || e === void 0 ? void 0 : e.class)) ==
          (t.class ||
            ((i = t.attrs) === null || i === void 0 ? void 0 : i.class)) &&
        Rs(this.attrs, t.attrs, "class"))
    );
  }
  range(t, e = t) {
...
var Yi = class extends q {
  ...
  eq(t) {
    return (
      ...
      Rs(this.spec.attributes, t.spec.attributes)
    );
  }
  range(t, e = t) {
    if (e != t)
...
Yi.prototype.mapMode = gt.TrackBefore;
...
Le.prototype.point = !0;
function Ih(s, t = !1) {
  let { inclusiveStart: e, inclusiveEnd: i } = s;
  return (
    e == null && (e = s.inclusive),
    i == null && (i = s.inclusive),
    { start: e ?? t, end: i ?? t }
  );
}
function fm(s, t) {
...
var at = class extends G {
    ...
    merge(t, e, i, n, r, o) {
      if (i) {
        if (!(i instanceof at)) return !1;
        this.dom || i.transferDOM(this);
      }
      return (
        n && this.setDeco(i ? i.attrs : null),
        Zh(this, t, e, i ? i.children.slice() : [], r, o),
        !0
      );
    }
    split(t) {
    ...
    transferDOM(t) {
      !this.dom ||
        (this.markDirty(),
        t.setDOM(this.dom),
        (t.prevAttrs = this.prevAttrs === void 0 ? this.attrs : this.prevAttrs),
        (this.prevAttrs = void 0),
        (this.dom = null));
    }
    setDeco(t) {
    ...
    addLineDeco(t) {
      let e = t.spec.attributes,
        i = t.spec.class;
      (e && (this.attrs = Qo(e, this.attrs || {})),
        i && (this.attrs = Qo({ class: i }, this.attrs || {})));
    }
    domAtPos(t) {
      return Mh(this, t);
    }
    reuseDOM(t) {
      t.nodeName == "DIV" && (this.setDOM(t), (this.flags |= 4 | 2));
    }
    sync(t, e) {
      var i;
      (this.dom
        ...
        : (this.setDOM(document.createElement("div")),
          ...
          (this.prevAttrs = this.attrs ? null : void 0)),
        this.prevAttrs !== void 0 &&
          (Po(this.dom, this.prevAttrs, this.attrs),
          this.dom.classList.add("cm-line"),
          (this.prevAttrs = void 0)),
        super.sync(t, e));
      let n = this.dom.lastChild;
      for (; n && G.get(n) instanceof xe;) n = n.lastChild;
      if (
        !n ||
        !this.length ||
        (n.nodeName != "BR" &&
          ((i = G.get(n)) === null || i === void 0 ? void 0 : i.isEditable) ==
            !1 &&
          (!T.ios || !this.children.some((r) => r instanceof _t)))
      ) {
    ...
    coordsAt(t, e) {
      ...
      if (!this.children.length && i && this.parent) {
        let { heightOracle: n } = this.parent.view.viewState,
          r = i.bottom - i.top;
  ...
  ke = class extends G {
    ...
    split(t) {
      let e = this.length - t;
      this.length = t;
      let i = new ke(this.widget, e, this.deco);
    ...
    become(t) {
      return t instanceof ke && t.widget.constructor == this.widget.constructor
    ...
    coordsAt(t, e) {
      ...
      return (
        i ||
        (this.widget instanceof Is
          ? null
          : Xs(this.dom.getBoundingClientRect(), this.length ? t == 0 : e <= 0))
      );
    }
    destroy() {
      (super.destroy(), this.dom && this.widget.destroy(this.dom));
  ...
  Ni = class {
    ...
    posCovered() {
      ...
      return !(t.breakAfter || (t instanceof ke && t.deco.endSide < 0));
    }
    getLine() {
      return (
        this.curLine ||
          (this.content.push((this.curLine = new at())),
          (this.atCursorPos = !0)),
        this.curLine
      );
    }
    flushBuffer(t = this.bufferMarks) {
      this.pendingBuffer &&
        (this.curLine.append(Ds(new Oi(-1), t), t.length),
        (this.pendingBuffer = 0));
    }
    addBlockWidget(t) {
      ...
      (this.pendingBuffer && t <= this.bufferMarks.length
        ...
        !this.posCovered() &&
          !(
            t &&
            this.content.length &&
            this.content[this.content.length - 1] instanceof ke
          ) &&
          this.getLine());
    }
    buildText(t, e, i) {
      for (; t > 0;) {
        ...
        let n = Math.min(this.text.length - this.textOff, t),
          r = Math.min(n, 512);
        (this.flushBuffer(e.slice(e.length - i)),
          this.getLine().append(
            Ds(new _t(this.text.slice(this.textOff, this.textOff + r)), e),
            i,
          ),
          (this.atCursorPos = !0),
          (this.textOff += r),
    ...
    point(t, e, i, n, r, o) {
      if (this.disallowBlockEffectsFor[o] && i instanceof Le) {
        if (i.block)
          throw new RangeError(
      ...
      if (i instanceof Le)
        if (i.block)
          (i.startSide > 0 && !this.posCovered() && this.getLine(),
            this.addBlockWidget(new ke(i.widget || mi.block, a, i)));
        else {
          let l = Je.create(i.widget || mi.inline, a, a ? 0 : i.startSide),
            h =
              this.atCursorPos &&
              !l.isEditable &&
              r <= n.length &&
              (t < e || i.startSide > 0),
            c = !l.isEditable && (t < e || r > n.length || i.startSide <= 0),
            f = this.getLine();
          (this.pendingBuffer == 2 &&
            ...
            this.flushBuffer(n),
            h &&
              (f.append(Ds(new Oi(1), n), r),
              (r = n.length + Math.max(0, r - n.length))),
            f.append(Ds(l, n), r),
            (this.atCursorPos = c),
            (this.pendingBuffer = c ? (t < e || r > n.length ? 1 : 2) : 0),
    ...
    static build(t, e, i, n, r) {
      let o = new Ni(t, e, i, r);
      return (
        (o.openEnd = _.spans(n, e, i, o)),
...
function Ds(s, t) {
  for (let e of t) s = new xe(e, [s], s.length);
  return s;
}
...
function Dh(s) {
  let t = [];
  for (let e = 0; e < s.length; e++) t.push(1 << +s[e]);
  return t;
}
var um = Dh(
...
function Om(s, t, e, i, n) {
  for (let r = 0; r <= i.length; r++) {
    ...
    for (let h = o, c = l, f = l; h < a; h++) {
      let u = K[h];
      if (u == 128)
        h < a - 1 && c == K[h + 1] && c & 24 ? (u = K[h] = c) : (K[h] = 256);
      else if (u == 64) {
        let d = h + 1;
        for (; d < a && K[d] == 64;) d++;
        let p = (h && c == 8) || (d < e && K[d] == 8) ? (f == 1 ? 1 : 8) : 256;
        for (let O = h; O < d; O++) K[O] = p;
        h = d - 1;
      } else u == 8 && f == 1 && (K[h] = 1);
      ((c = u), u & 7 && (f = u));
    }
...
function mm(s, t, e, i, n) {
  ...
  for (let o = 0, a = 0, l = 0; o <= i.length; o++) {
    let h = o ? i[o - 1].to : t,
      c = o < i.length ? i[o].from : e;
    for (let f = h, u, d, p; f < c; f++)
      if ((d = To[(u = s.charCodeAt(f))]))
        if (d < 0) {
          for (let O = a - 3; O >= 0; O -= 3)
            if (Qe[O + 1] == -d) {
              let g = Qe[O + 2],
                b = g & 2 ? n : g & 4 ? (g & 1 ? r : n) : 0;
              (b && (K[f] = K[Qe[O]] = b), (a = O));
              break;
            }
        } else {
          if (Qe.length == 189) break;
          ((Qe[a++] = f), (Qe[a++] = u), (Qe[a++] = l));
        }
      else if ((p = K[f]) == 2 || p == 1) {
        let O = p == n;
        l = O ? 0 : 1;
    ...
    for (let l = o; l < a;) {
      ...
      if (h == 256) {
        ...
        let f = r == 1,
          u = (c < t ? K[c] : i) == 1,
          d = f == u ? (f ? 1 : 2) : i;
        for (let p = c, O = n, g = O ? e[O - 1].to : s; p > l;)
          (p == g && ((p = e[--O].from), (g = O ? e[O - 1].to : s)),
            (K[--p] = d));
        l = c;
      } else ((r = h), l++);
    }
      ...
      t: for (;;)
        if (h < r.length && p == r[h].from) {
          ...
          if ((h++, u)) u.push(O);
            ...
            O.from > l && o.push(new Ie(l, O.from, d));
            let g = (O.direction == gi) != !(d % 2);
            (Ao(s, g ? i + 1 : i, n, O.inner, O.from, O.to, o), (l = O.to));
          }
          p = O.to;
        } else {
          if (p == e || (c ? K[p] != a : K[p] == a)) break;
          p++;
        }
      (u ? Co(s, l, p, i + 1, n, u, o) : l < p && o.push(new Ie(l, p, d)),
        (l = p));
    }
  else
      ...
      t: for (;;)
        if (h && p == r[h - 1].to) {
          ...
          if (u) u.push(O);
            ...
            O.to < l && o.push(new Ie(O.to, l, d));
            let g = (O.direction == gi) != !(d % 2);
            (Ao(s, g ? i + 1 : i, n, O.inner, O.from, O.to, o), (l = O.from));
          }
          p = O.from;
        } else {
          if (p == t || (c ? K[p - 1] != a : K[p - 1] == a)) break;
          p--;
        }
      (u ? Co(s, p, l, i + 1, n, u, o) : p < l && o.push(new Ie(p, l, d)),
        (l = p));
    }
}
...
function bm(s, t, e) {
  if (!s) return [new Ie(0, 0, t == $o ? 1 : 0)];
  if (t == gi && !e.length && !pm.test(s)) return Vh(s.length);
  if (e.length) for (; s.length > K.length;) K[K.length] = 256;
  let i = [],
    n = t == gi ? 0 : 1;
  return (Ao(s, n, n, e, 0, s.length, i), i);
}
function Vh(s) {
  return [new Ie(0, s, 0)];
}
var jh = "";
function Sm(s, t, e, i, n) {
  var r;
  let o = i.head - s.from,
    a = Ie.find(
      t,
  ...
  if (o == h) {
    ...
    ((l = t[(a = u)]), (o = l.side(!n, e)), (h = l.side(n, e)));
  }
  let c = ie(s.text, o, l.forward(n, e));
  ((c < l.from || c > l.to) && (c = h),
    (jh = s.text.slice(Math.min(o, c), Math.max(o, c))));
  let f = a == (n ? t.length - 1 : 0) ? null : t[a + (n ? 1 : -1)];
  return f && c == h && f.level + (n ? 0 : 1) < l.level
    ? k.cursor(f.side(!n, e) + s.from, f.forward(n, e) ? 1 : -1, f.level)
    : k.cursor(c + s.from, l.forward(n, e) ? -1 : 1, l.level);
}
function ym(s, t, e) {
  for (let i = t; i < e; i++) {
    let n = Bh(s.charCodeAt(i));
    if (n == 1) return gi;
    if (n == 2 || n == 4) return $o;
  }
  return gi;
...
var Yh = M.define(),
  ...
  Zo = M.define(),
  Mo = M.define(),
  Uh = M.define({ combine: (s) => s.some((t) => t) }),
  Fh = M.define({ combine: (s) => s.some((t) => t) }),
  Hh = M.define(),
  bi = class {
  ...
  Bs = tt.define({ map: (s, t) => s.map(t) }),
  Kh = tt.define();
function Gt(s, t, e) {
  let i = s.facet(Wh);
  i.length
    ? i[0](t)
    : (window.onerror && window.onerror(String(t), e, void 0, void 0, t)) ||
      (e ? console.error(e + ":", t) : console.error(t));
}
var De = M.define({ combine: (s) => (s.length ? s[0] : !0) }),
  wm = 0,
  qi = M.define({
    combine(s) {
      return s.filter((t, e) => {
        for (let i = 0; i < e; i++) if (s[i].plugin == t.plugin) return !1;
        return !0;
      });
    },
  }),
  Zt = class {
    constructor(t, e, i, n, r) {
      ((this.id = t),
        ...
        (this.extension = this.baseExtensions.concat(
          qi.of({ plugin: this, arg: void 0 }),
        )));
    }
    of(t) {
      return this.baseExtensions.concat(qi.of({ plugin: this, arg: t }));
    }
    static define(t, e) {
      let {
        eventHandlers: i,
    ...
    static fromClass(t, e) {
      return Zt.define((i, n) => new t(i, n), e);
    }
  },
  zs = class {
    constructor(t) {
    ...
    update(t) {
      if (this.value) {
        ...
        try {
          ...
          (Gt(t.state, e, "CodeMirror plugin crashed"), this.deactivate());
        }
      return this;
    }
    destroy(t) {
      ...
      if ((e = this.value) === null || e === void 0 ? void 0 : e.destroy)
        try {
          ...
          Gt(t.state, i, "CodeMirror plugin crashed");
        }
    }
    deactivate() {
  ...
  ec = M.define();
function ic(s, t) {
  let e = s.state.facet(ec);
  if (!e.length) return e;
  let i = e.map((r) => (r instanceof Function ? r(s) : r)),
    n = [];
  return (
    _.spans(i, t.from, t.to, {
      point() {},
      span(r, o, a, l) {
        let h = r - t.from,
          c = o - t.from,
        ...
        for (let u = a.length - 1; u >= 0; u--, l--) {
          let d = a[u].spec.bidiIsolate,
            p;
          if (
            (d == null && (d = ym(t.text, h, c)),
            l > 0 &&
              f.length &&
              (p = f[f.length - 1]).to == h &&
              p.direction == d)
...
function sc(s) {
  let t = 0,
    ...
    i = 0,
    n = 0;
  for (let r of s.state.facet(nc)) {
    let o = r(s);
    o &&
      (o.left != null && (t = Math.max(t, o.left)),
      o.right != null && (e = Math.max(e, o.right)),
      o.top != null && (i = Math.max(i, o.top)),
      o.bottom != null && (n = Math.max(n, o.bottom)));
  }
      ...
      for (let n = 0, r = 0, o = 0, a = 0; ; n++) {
        ...
        for (; r < e.length && e[r] < c;) {
          let f = e[r],
            ...
            d = Math.max(a, f),
            p = Math.min(c, u);
          if ((d <= p && new zt(d + h, p + h, d, p).addToSet(i), u > c)) break;
          r += 2;
        }
        if (!l) return i;
        (new zt(l.fromA, l.toA, l.fromB, l.toB).addToSet(i),
          (o = l.toA),
          (a = l.toB));
      }
    }
  ...
  Tn = class {
    constructor(t, e, i) {
      ((this.view = t),
        ...
        (this.changes = ht.empty(this.startState.doc.length)));
      for (let r of i) this.changes = this.changes.compose(r.changes);
      let n = [];
      (this.changes.iterChangedRanges((r, o, a, l) =>
        n.push(new zt(r, o, a, l)),
      ),
  ...
  Ro = class extends G {
    ...
    constructor(t) {
      ...
      ((this.view = t),
        ...
        (this.editContextFormatting = q.none),
        ...
        this.updateDeco(),
        this.updateInner([new zt(0, 0, 0, t.state.doc.length)], 0, null));
    }
    update(t) {
      var e;
      ...
      this.view.inputState.composing >= 0 &&
        ...
        (((e = this.domChanged) === null || e === void 0 ? void 0 : e.newSel)
          ? (n = this.domChanged.newSel.head)
          : !Tm(t.changes, this.hasComposition) &&
            !t.selectionSet &&
            (n = t.state.selection.main.head));
      let r = n > -1 ? xm(this.view, t.changes, n) : null;
      if (((this.domChanged = null), this.hasComposition)) {
        ...
        i = new zt(
          h,
          c,
          t.changes.mapPos(h, -1),
          t.changes.mapPos(c, 1),
        ).addToSet(i.slice());
      }
    ...
    updateInner(t, e, i) {
      ...
      (n.ignore(() => {
        ...
        this.markedForComposition.forEach((o) => (o.flags &= ~8)));
      let r = [];
      if (
        ...
        for (let o of this.children)
          o instanceof ke && o.widget instanceof Is && r.push(o.dom);
      n.updateGaps(r);
    }
    updateChildren(t, e, i) {
      ...
      for (let o = n.length - 1; ; o--) {
        let a = o >= 0 ? n[o] : null;
        if (!a) break;
        let { fromA: l, toA: h, fromB: c, toB: f } = a,
          u,
          d,
          p,
          O;
        if (i && i.range.fromB < f && i.range.toB > c) {
          ...
          ((d = C.breakAtStart), (p = C.openStart), (O = w.openEnd));
          let Q = this.compositionView(i);
          (w.breakAtStart
            ? (Q.breakAfter = 1)
            : w.content.length &&
              Q.merge(Q.length, Q.length, w.content[0], !1, w.openStart, 0) &&
              ((Q.breakAfter = w.content[0].breakAfter), w.content.shift()),
            C.content.length &&
              Q.merge(
                0,
                0,
              ...
              C.content.pop(),
            (u = C.content.concat(Q).concat(w.content)));
        } else
          ({
            content: u,
            breakAtStart: d,
        ...
        let { i: g, off: b } = r.findPos(h, 1),
          { i: S, off: y } = r.findPos(l, -1);
        Eh(this, S, y, g, b, u, d, p, O);
      }
    ...
    updateEditContextFormatting(t) {
      ...
      for (let e of t.transactions)
        for (let i of e.effects)
          i.is(Kh) && (this.editContextFormatting = i.value);
    }
    compositionView(t) {
      let e = new _t(t.text.nodeValue);
      e.flags |= 8;
      for (let { deco: n } of t.marks) e = new xe(n, [e], e.length);
      let i = new at();
    ...
    updateSelection(t = !1, e = !1) {
      ...
      let i = this.view.root.activeElement,
        ...
        r =
          !n &&
          !(this.view.state.facet(De) || this.dom.tabIndex > -1) &&
          Zs(this.dom, this.view.observer.selectionRange) &&
      ...
      let a = this.view.state.selection.main,
        ...
        h = a.empty ? l : this.moveToLine(this.domAtPos(a.head));
      if (T.gecko && a.empty && !this.hasComposition && vm(l)) {
      ...
      ((o ||
        !c.focusNode ||
        ((!kn(l.node, l.offset, c.anchorNode, c.anchorOffset) ||
          !kn(h.node, h.offset, c.focusNode, c.focusOffset)) &&
          !this.suppressWidgetCursorChange(c, a))) &&
        (this.view.observer.ignore(() => {
          T.android &&
            T.chrome &&
            this.dom.contains(c.focusNode) &&
            $m(c.focusNode, this.dom) &&
            (this.dom.blur(), this.dom.focus({ preventScroll: !0 }));
          let f = vn(this.view.root);
          if (f)
            if (a.empty) {
              if (T.gecko) {
                let u = km(l.node, l.offset);
                if (u && u != (1 | 2)) {
                  let d = (u == 1 ? Th : Ch)(l.node, l.offset);
                  d && (l = new bt(d.node, d.offset));
                }
              }
    ...
    suppressWidgetCursorChange(t, e) {
      return (
        this.hasComposition &&
        e.empty &&
        kn(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset) &&
    ...
    enforceCursorAssoc() {
      ...
      let o = at.find(this, e.head);
      if (!o) return;
      let a = o.posAtStart;
      if (e.head == a || e.head == a + o.length) return;
      ...
      t.docView.posFromDOM(f.anchorNode, f.anchorOffset) != e.from &&
        i.collapse(n, r);
    }
    moveToLine(t) {
      let e = this.dom,
      ...
      return i ? new bt(i.node, i.offset, !0) : t;
    }
    nearest(t) {
      for (let e = t; e;) {
        let i = G.get(e);
    ...
    domAtPos(t) {
      ...
      for (; e < this.children.length - 1;) {
        ...
        if (i < n.length || n instanceof at) break;
        (e++, (i = 0));
      }
    ...
    coordsAt(t, e) {
      ...
      for (let r = this.length, o = this.children.length - 1; o >= 0; o--) {
        ...
        if (
          ...
          (h < t || a.covers(-1)) &&
          (l > t || a.covers(1)) &&
          (!i || (a instanceof at && !(i instanceof at && e >= 0)))
        )
          ((i = a), (n = h));
        else if (i && h == t && l == t && a instanceof ke && Math.abs(e) < 2) {
    ...
    coordsForChar(t) {
      let { i: e, off: i } = this.childPos(t, 1),
        n = this.children[e];
      if (!(n instanceof at)) return null;
      for (; n.children.length;) {
        let { i: a, off: l } = n.childPos(i, 1);
        for (; ; a++) {
          if (a == n.children.length) return null;
          if ((n = n.children[a]).length) break;
        }
        i = l;
      }
      if (!(n instanceof _t)) return null;
      let r = ie(n.text, i);
      if (r == i) return null;
      let o = pi(n.dom, i, r).getClientRects();
    ...
    measureVisibleLineHeights(t) {
      let e = [],
        ...
        a = -1,
        l = this.view.textDirection == it.LTR;
      for (let h = 0, c = 0; c < this.children.length; c++) {
        ...
        if (h >= i) {
          ...
          if ((e.push(d.height), o)) {
            ...
            if (O.length) {
              let g = O[O.length - 1],
                b = l ? g.right - d.left : d.right - g.left;
              b > a &&
                ((a = b),
                (this.minWidth = r),
                (this.minWidthFrom = h),
    ...
    textDirectionAt(t) {
      ...
      return getComputedStyle(this.children[e].dom).direction == "rtl"
        ? it.RTL
        : it.LTR;
    }
    measureTextSize() {
    ...
    computeBlockGapDeco() {
      ...
      for (let i = 0, n = 0; ; n++) {
        ...
        if (o > i) {
          let a =
            (e.lineBlockAt(o).bottom - e.lineBlockAt(i).top) / this.view.scaleY;
          t.push(
            q
              .replace({
                widget: new Is(a),
    ...
    updateDeco() {
      let t = 1,
        e = this.view.state
          .facet(Qn)
          .map((r) =>
            (this.dynamicDecorationMap[t++] = typeof r == "function")
              ? r(this.view)
              : r,
          ),
        i = !1,
        n = this.view.state.facet(tc).map((r, o) => {
          let a = typeof r == "function";
          return (a && (i = !0), a ? r(this.view) : r);
        });
      for (
        n.length && ((this.dynamicDecorationMap[t++] = i), e.push(_.join(n))),
          this.decorations = [
    ...
    scrollIntoView(t) {
      if (t.isSnapshot) {
        ...
        ((this.view.scrollDOM.scrollTop = h.top - t.yMargin),
          (this.view.scrollDOM.scrollLeft = t.xMargin));
        return;
      }
      for (let h of this.view.state.facet(Hh))
        try {
          if (h(this.view, t.range, t)) return !0;
        } catch (c) {
          Gt(this.view.state, c, "scroll handler");
        }
      let { range: e } = t,
        i = this.coordsAt(
          e.head,
      ...
      if (!i) return;
      !e.empty &&
        (n = this.coordsAt(e.anchor, e.anchor > e.head ? -1 : 1)) &&
        (i = {
      ...
      im(
        ...
        t.x,
        t.y,
        Math.max(Math.min(t.xMargin, a), -a),
        Math.max(Math.min(t.yMargin, l), -l),
        this.view.textDirection == it.LTR,
      );
    }
  };
function vm(s) {
  return (
    ...
    s.node.firstChild &&
    (s.offset == 0 ||
      s.node.childNodes[s.offset - 1].contentEditable == "false") &&
    (s.offset == s.node.childNodes.length ||
      s.node.childNodes[s.offset].contentEditable == "false")
  );
}
function rc(s, t) {
  let e = s.observer.selectionRange;
  if (!e.focusNode) return null;
  let i = Th(e.focusNode, e.focusOffset),
    n = Ch(e.focusNode, e.focusOffset),
    r = i || n;
  if (n && i && n.node != i.node) {
    let a = G.get(n.node);
    if (!a || (a instanceof _t && a.text != n.node.nodeValue)) r = n;
    else if (s.docView.lastCompositionAfterCursor) {
      let l = G.get(i.node);
      !l || (l instanceof _t && l.text != i.node.nodeValue) || (r = n);
    }
  }
  if (((s.docView.lastCompositionAfterCursor = r != i), !r)) return null;
  let o = t - r.offset;
...
function xm(s, t, e) {
  let i = rc(s, e);
  if (!i) return null;
  let { node: n, from: r, to: o } = i,
    a = n.nodeValue;
  if (/[\n\r]/.test(a) || s.state.doc.sliceString(i.from, i.to) != a)
    return null;
  let l = t.invertedDesc,
    h = new zt(l.mapPos(r), l.mapPos(o), r, o),
    c = [];
  for (let f = n.parentNode; ; f = f.parentNode) {
    let u = G.get(f);
    if (u instanceof xe) c.push({ node: f, deco: u.mark });
    else {
      if (
        u instanceof at ||
        (f.nodeName == "DIV" && f.parentNode == s.contentDOM)
      )
...
function km(s, t) {
  return s.nodeType != 1
    ? 0
    : (t && s.childNodes[t - 1].contentEditable == "false" ? 1 : 0) |
        (t < s.childNodes.length && s.childNodes[t].contentEditable == "false"
          ? 2
          : 0);
}
var Qm = class {
...
function Pm(s, t, e) {
  let i = new Qm();
  return (_.compare(s, t, e, i), i.changes);
}
function $m(s, t) {
...
function Cm(s, t, e = 1) {
  let i = s.charCategorizer(t),
    n = s.doc.lineAt(t),
    r = t - n.from;
  if (n.length == 0) return k.cursor(t);
  r == 0 ? (e = 1) : r == n.length && (e = -1);
  let o = r,
    a = r;
  e < 0 ? (o = ie(n.text, r, !1)) : (a = ie(n.text, r));
  let l = i(n.text.slice(o, a));
  for (; o > 0;) {
    let h = ie(n.text, o, !1);
    if (i(n.text.slice(h, o)) != l) break;
    o = h;
  }
  for (; a < n.length;) {
    let h = ie(n.text, a);
    if (i(n.text.slice(a, h)) != l) break;
    a = h;
  }
  return k.range(o + n.from, a + n.from);
}
function Am(s, t) {
...
function oc(s, t) {
  return t < s.top
    ? { top: t, left: s.left, right: s.right, bottom: s.bottom }
    : s;
}
function ac(s, t) {
  return t > s.bottom
    ? { top: s.top, left: s.left, right: s.right, bottom: t }
    : s;
}
function Io(s, t, e) {
  let i,
  ...
  for (let p = s.firstChild; p; p = p.nextSibling) {
    ...
    for (let g = 0; g < O.length; g++) {
      let b = O[g];
      n && Lo(n, b) && (b = oc(ac(b, n.bottom), n.top));
      let S = Am(t, b),
        y = Em(e, b);
      if (S == 0 && y == 0) return p.nodeType == 3 ? lc(p, t, e) : Io(p, t, e);
      ((!i || o > y || (o == y && r > S)) &&
        ((i = p),
        (n = b),
        (r = S),
        (o = y),
        (a = S ? (t < b.left ? g > 0 : g < O.length - 1) : !0)),
        S == 0
          ? e > b.bottom && (!c || c.bottom < b.bottom)
            ? ((l = p), (c = b))
            : e < b.top && (!f || f.top > b.top) && ((h = p), (f = b))
          : c && Lo(c, b)
            ? (c = ac(c, b.bottom))
            : f && Lo(f, b) && (f = oc(f, b.top)));
    }
  }
  if (
    (c && c.bottom >= e
  ...
  if (i.nodeType == 3) return lc(i, u, e);
  if (a && i.contentEditable != "false") return Io(i, u, e);
  let d =
    Array.prototype.indexOf.call(s.childNodes, i) +
    (t >= (n.left + n.right) / 2 ? 1 : 0);
...
function lc(s, t, e) {
  let i = s.nodeValue.length,
    ...
    o = 0;
  for (let a = 0; a < i; a++) {
    let l = pi(s, a, a + 1).getClientRects();
    for (let h = 0; h < l.length; h++) {
      ...
      if (c.left - 1 <= t && c.right + 1 >= t && f < r) {
        let u = t >= (c.left + c.right) / 2,
          d = u;
        if (
          ((T.chrome || T.gecko) &&
            pi(s, a).getBoundingClientRect().left == c.right &&
            (d = !u),
          f <= 0)
        )
          return { node: s, offset: a + (d ? 1 : 0) };
        ((n = a + (d ? 1 : 0)), (r = f));
      }
    }
  }
...
function hc(s, t, e, i = -1) {
  var n, r;
  let o = s.contentDOM.getBoundingClientRect(),
    a = o.top + s.viewState.paddingTop,
    l,
    { docHeight: h } = s.viewState,
    { x: c, y: f } = t,
    u = f - a;
  if (u < 0) return 0;
  if (u > h) return s.state.doc.length;
  for (
    let C = s.viewState.heightOracle.textHeight / 2, w = !1;
    (l = s.elementAtHeight(u)), l.type != Bt.Text;
  )
    for (; (u = i > 0 ? l.bottom + C : l.top - C), !(u >= 0 && u <= h);) {
      if (w) return e ? null : 0;
      ((w = !0), (i = -i));
    }
  f = a + u;
  let d = l.from;
  if (d < s.viewport.from)
    return s.viewport.from == 0 ? 0 : e ? null : cc(s, o, l, c, f);
  if (d > s.viewport.to)
    return s.viewport.to == s.state.doc.length
      ? s.state.doc.length
      : e
        ? null
        : cc(s, o, l, c, f);
  let p = s.dom.ownerDocument,
    O = s.root.elementFromPoint ? s.root : p,
    g = O.elementFromPoint(c, f);
  (g && !s.contentDOM.contains(g) && (g = null),
    g ||
  ...
  if (
    g &&
    ((n = s.docView.nearest(g)) === null || n === void 0
      ? void 0
      : n.isEditable) != !1
  ) {
    if (p.caretPositionFromPoint) {
      let C = p.caretPositionFromPoint(c, f);
      C && ({ offsetNode: b, offset: S } = C);
    } else if (p.caretRangeFromPoint) {
      let C = p.caretRangeFromPoint(c, f);
      C && ({ startContainer: b, startOffset: S } = C);
    }
    (b &&
      (!s.contentDOM.contains(b) ||
        (T.safari && Zm(b, S, c)) ||
        (T.chrome && Mm(b, S, c))) &&
      (b = void 0),
      b && (S = Math.min(ve(b), S)));
  }
  if (!b || !s.docView.dom.contains(b)) {
    let C = at.find(s.docView, d);
    if (!C) return u > l.top + l.height / 2 ? l.to : l.from;
    ({ node: b, offset: S } = Io(C.dom, c, f));
  }
  let y = s.docView.nearest(b);
  if (!y) return null;
  if (
    y.isWidget &&
    ((r = y.dom) === null || r === void 0 ? void 0 : r.nodeType) == 1
  ) {
    let C = y.dom.getBoundingClientRect();
    return t.y < C.top || (t.y <= C.bottom && t.x <= (C.left + C.right) / 2)
      ? y.posAtStart
      : y.posAtEnd;
  } else return y.localPosFromDOM(b, S) + y.posAtStart;
}
function cc(s, t, e, i, n) {
  let r = Math.round((i - t.left) * s.defaultCharacterWidth);
  if (s.lineWrapping && e.height > s.defaultLineHeight * 1.5) {
    let a = s.viewState.heightOracle.textHeight;
    r +=
      Math.floor((n - e.top - (s.defaultLineHeight - a) * 0.5) / a) *
      s.viewState.heightOracle.lineLength;
  }
  let o = s.state.sliceDoc(e.from, e.to);
  return e.from + fh(o, r, s.state.tabSize);
}
function fc(s, t, e) {
  let i,
    n = s;
  if (s.nodeType != 3 || t != (i = s.nodeValue.length)) return !1;
  for (;;) {
    let r = n.nextSibling;
    if (r) {
      if (r.nodeName == "BR") break;
      return !1;
    } else {
      let o = n.parentNode;
  ...
  return pi(s, i - 1, i).getBoundingClientRect().right > e;
}
function Zm(s, t, e) {
  return fc(s, t, e);
}
function Mm(s, t, e) {
  if (t != 0) return fc(s, t, e);
  for (let n = s; ;) {
    let r = n.parentNode;
    if (!r || r.nodeType != 1 || r.firstChild != n) return !1;
  ...
  let i =
    s.nodeType == 1
      ...
      : pi(s, 0, Math.max(s.nodeValue.length, 1)).getBoundingClientRect();
  return e - i.left > 5;
}
function Do(s, t, e) {
  ...
  if (Array.isArray(i.type)) {
    ...
    for (let r of i.type) {
      if (r.from > t) break;
      if (!(r.to < t)) {
        if (r.from < t && r.to > t) return r;
        (!n ||
          (r.type == Bt.Text &&
            (n.type != r.type || (e < 0 ? r.from < t : r.to > t)))) &&
          (n = r);
      }
    }
    return n || i;
...
function Xm(s, t, e, i) {
  let n = Do(s, t.head, t.assoc || -1),
    r =
      !i || n.type != Bt.Text || !(s.lineWrapping || n.widgetLineBreaks)
        ? null
        : s.coordsAtPos(t.assoc < 0 && t.head > n.from ? t.head - 1 : t.head);
  if (r) {
    let o = s.dom.getBoundingClientRect(),
      a = s.textDirectionAt(n.from),
      l = s.posAtCoords({
        x: e == (a == it.LTR) ? o.right - 1 : o.left + 1,
        y: (r.top + r.bottom) / 2,
      });
    if (l != null) return k.cursor(l, e ? -1 : 1);
  }
  return k.cursor(e ? n.to : n.from, e ? -1 : 1);
}
function uc(s, t, e, i) {
  let n = s.state.doc.lineAt(t.head),
    r = s.bidiSpans(n),
    o = s.textDirectionAt(n.from);
  for (let a = t, l = null; ;) {
    let h = Sm(n, r, o, a, e),
      c = jh;
    if (!h) {
      if (n.number == (e ? s.state.doc.lines : 1)) return a;
      ((c = `
`),
        (n = s.state.doc.line(n.number + (e ? 1 : -1))),
        (r = s.bidiSpans(n)),
        (h = s.visualLineSide(n, !e)));
    }
    if (l) {
      if (!l(c)) return a;
    } else {
...
function Rm(s, t, e) {
  let i = s.state.charCategorizer(t),
    n = i(e);
  return (r) => {
    let o = i(r);
    return (n == ne.Space && (n = o), n == o);
  };
}
function Lm(s, t, e, i) {
  let n = t.head,
    r = e ? 1 : -1;
  if (n == (e ? s.state.doc.length : 0)) return k.cursor(n, t.assoc);
  let o = t.goalColumn,
    a,
    l = s.contentDOM.getBoundingClientRect(),
    h = s.coordsAtPos(n, t.assoc || -1),
    c = s.documentTop;
  if (h) (o == null && (o = h.left - l.left), (a = r < 0 ? h.top : h.bottom));
  else {
    let d = s.viewState.lineBlockAt(n);
    (o == null &&
      (o = Math.min(l.right - l.left, s.defaultCharacterWidth * (n - d.from))),
      (a = (r < 0 ? d.top : d.bottom) + c));
  }
  let f = l.left + o,
    u = i ?? s.viewState.heightOracle.textHeight >> 1;
  for (let d = 0; ; d += 10) {
    let p = a + (u + d) * r,
      O = hc(s, { x: f, y: p }, !1, r);
    if (p < l.top || p > l.bottom || (r < 0 ? O < n : O > n)) {
      let g = s.docView.coordsForChar(O),
        b = !g || p < g.top ? -1 : 1;
      return k.cursor(O, b, void 0, o);
    }
  }
}
function Cn(s, t, e) {
  for (;;) {
    let i = 0;
    for (let n of s)
      n.between(t - 1, t + 1, (r, o, a) => {
        if (t > r && t < o) {
          let l = i || e || (t - r < o - t ? -1 : 1);
          ((t = l < 0 ? r : o), (i = l));
        }
      });
    if (!i) return t;
  ...
  for (let i = 0; i < t.ranges.length; i++) {
    ...
    if (n.empty) {
      ...
      let o = Cn(s, n.from, -1),
        a = Cn(s, n.to, 1);
      (o != n.from || a != n.to) &&
        (r = k.range(n.from == n.anchor ? o : a, n.from == n.head ? o : a));
    }
...
var An = "\uFFFF",
  pc = class {
    constructor(t, e) {
      ((this.points = t),
        (this.text = ""),
        (this.lineSeparator = e.facet(I.lineSeparator)));
    }
    append(t) {
      this.text += t;
    }
      ...
      for (let i = 0, n = this.lineSeparator ? null : /\r\n?|\n/g; ;) {
        ...
        if (
          (this.lineSeparator
            ...
            : (a = n.exec(e)) && ((r = a.index), (o = a[0].length)),
      ...
      if (i != null) {
        ...
        t.nodeType == 3
          ...
          : t.nodeName == "BR"
            ...
            : t.nodeType == 1 && this.readRange(t.firstChild, null);
    }
    findPointBefore(t, e) {
      for (let i of this.points)
        i.node == t &&
    ...
    findPointInside(t, e) {
      for (let i of this.points)
        (t.nodeType == 3 ? i.node == t : t.contains(i.node)) &&
          (i.pos = this.text.length + (Im(t, i.node, i.offset) ? e : 0));
    }
  };
function Im(s, t, e) {
  for (;;) {
    if (!t || e < ve(t)) return !1;
    if (t == s) return !0;
    ((e = ui(t) + 1), (t = t.parentNode));
  }
}
function Dm(s, t) {
  let e;
  for (; !(s == t || !s); s = s.nextSibling) {
    let i = G.get(s);
    if (!((i == null ? void 0 : i.isWidget) || s.cmIgnore)) return !1;
    i && (e || (e = [])).push(i);
  }
  if (e)
    for (let i of e) {
      let n = i.overrideDOMText;
      if (n == null ? void 0 : n.length) return !1;
    }
  return !0;
}
var zo = class {
    ...
    constructor(t, e, i, n) {
      ...
      if (t.state.readOnly && e > -1) this.newSel = null;
        ...
        (l.readRange(this.bounds.startDOM, this.bounds.endDOM),
          (this.text = l.text),
          (this.newSel = Vm(a, this.bounds.from)));
      } else {
        let a = t.observer.selectionRange,
          l =
            (r && r.node == a.focusNode && r.offset == a.focusOffset) ||
            !vo(t.contentDOM, a.focusNode)
              ? t.state.selection.main.head
              : t.docView.posFromDOM(a.focusNode, a.focusOffset),
          h =
            (o && o.node == a.anchorNode && o.offset == a.anchorOffset) ||
            !vo(t.contentDOM, a.anchorNode)
              ? t.state.selection.main.anchor
              : t.docView.posFromDOM(a.anchorNode, a.anchorOffset),
          c = t.viewport;
        if (
          (T.ios || T.chrome) &&
          t.state.selection.main.empty &&
          l != h &&
          (c.from > 0 || c.to < t.state.doc.length)
        ) {
          let f = Math.min(l, h),
            u = Math.max(l, h),
            d = c.from - f,
            p = c.to - u;
          (d == 0 || d == 1 || f == 0) &&
            (p == 0 || p == -1 || u == t.state.doc.length) &&
            ((l = 0), (h = t.state.doc.length));
        }
        this.newSel = k.single(h, l);
      }
    }
  };
function mc(s, t) {
  let e,
    { newSel: i } = t,
    n = s.state.selection.main,
    r =
      s.inputState.lastKeyTime > Date.now() - 100
        ? s.inputState.lastKeyCode
        : -1;
  if (t.bounds) {
    let { from: o, to: a } = t.bounds,
      l = n.from,
      h = null;
    (r === 8 || (T.android && t.text.length < a - o)) &&
      ((l = n.to), (h = "end"));
    let c = gc(s.state.doc.sliceString(o, a, An), t.text, l - o, h);
    c &&
      (T.chrome &&
        r == 13 &&
        c.toB == c.from + 2 &&
        t.text.slice(c.from, c.toB) == An + An &&
        c.toB--,
      (e = {
        from: o + c.from,
        to: o + c.toA,
        insert: B.of(t.text.slice(c.from, c.toB).split(An)),
      }));
  } else
    i && ((!s.hasFocus && s.state.facet(De)) || i.main.eq(n)) && (i = null);
  if (!e && !i) return !1;
  if (
    (!e && t.typeOver && !n.empty && i && i.main.empty
      ? (e = {
          from: n.from,
          to: n.to,
          insert: s.state.doc.slice(n.from, n.to),
        })
      : (T.mac || T.android) &&
          e &&
          e.from == e.to &&
          e.from == n.head - 1 &&
          /^\. ?$/.test(e.insert.toString()) &&
          s.contentDOM.getAttribute("autocorrect") == "off"
        ? (i &&
            e.insert.length == 2 &&
          ...
          (e = {
            from: e.from,
            to: e.to,
            insert: B.of([e.insert.toString().replace(".", " ")]),
          }))
        : e &&
            e.from >= n.from &&
            e.to <= n.to &&
            (e.from != n.from || e.to != n.to) &&
            n.to - n.from - (e.to - e.from) <= 4
          ? (e = {
              from: n.from,
              to: n.to,
              insert: s.state.doc
                .slice(n.from, e.from)
                .append(e.insert)
                .append(s.state.doc.slice(e.to, n.to)),
            })
          : T.chrome &&
            e &&
            e.from == e.to &&
 ...
 ` &&
            ...
            (e = { from: n.from, to: n.to, insert: B.of([" "]) })),
    e)
  )
    return Vo(s, e, i, r);
  if (i && !i.main.eq(n)) {
    let o = !1,
      a = "select";
    return (
      s.inputState.lastSelectionTime > Date.now() - 50 &&
        (s.inputState.lastSelectionOrigin == "select" && (o = !0),
        (a = s.inputState.lastSelectionOrigin),
        a == "select.pointer" &&
          (i = dc(
            s.state.facet(Pn).map((l) => l(s)),
            i,
          ))),
      s.dispatch({ selection: i, scrollIntoView: o, userEvent: a }),
      !0
    );
  } else return !1;
}
function Vo(s, t, e, i = -1) {
  if (T.ios && s.inputState.flushIOSKey(t)) return !0;
  let n = s.state.selection.main;
  if (
    T.android &&
    ((t.to == n.to &&
      (t.from == n.from ||
        (t.from == n.from - 1 && s.state.sliceDoc(t.from, n.from) == " ")) &&
      t.insert.length == 1 &&
      t.insert.lines == 2 &&
      Vi(s.contentDOM, "Enter", 13)) ||
      (((t.from == n.from - 1 && t.to == n.to && t.insert.length == 0) ||
        (i == 8 && t.insert.length < t.to - t.from && t.to > n.head)) &&
        Vi(s.contentDOM, "Backspace", 8)) ||
      (t.from == n.from &&
        t.to == n.to + 1 &&
        t.insert.length == 0 &&
        Vi(s.contentDOM, "Delete", 46)))
  )
    return !0;
  ...
  let o,
    a = () => o || (o = Bm(s, t, e));
  return (
    s.state.facet(_h).some((l) => l(s, t.from, t.to, r, a)) || s.dispatch(a()),
    !0
  );
}
function Bm(s, t, e) {
  ...
  if ((t.from == t.to && t.from < r.from) || t.from > r.to) {
    let l = t.from < r.from ? -1 : 1,
      h = l < 0 ? r.from : r.to,
      c = Cn(
        n.facet(Pn).map((f) => f(s)),
        h,
        l,
      );
    t.from == c && (o = c);
  ...
  if (o > -1)
    i = { changes: t, selection: k.cursor(t.from + t.insert.length, -1) };
  else if (
    t.from >= r.from &&
    t.to <= r.to &&
    t.to - t.from >= (r.to - r.from) / 3 &&
    (!e || (e.main.empty && e.main.from == t.from + t.insert.length)) &&
    s.inputState.composing < 0
  ) {
    let l = r.from < t.from ? n.sliceDoc(r.from, t.from) : "",
      h = r.to > t.to ? n.sliceDoc(t.to, r.to) : "";
    i = n.replaceSelection(
      s.state.toText(
        l + t.insert.sliceString(0, void 0, s.state.lineBreak) + h,
      ),
    );
  } else {
    let l = n.changes(t),
    ...
    if (
      ...
      let c = s.state.sliceDoc(t.from, t.to),
        f,
        u = e && rc(s, e.main.head);
      if (u) {
        let O = t.insert.length - (t.to - t.from);
        f = { from: u.from, to: u.to - O };
      } else f = s.state.doc.lineAt(r.head);
      let d = r.to - t.to,
        p = r.to - r.from;
      i = n.changeByRange((O) => {
        ...
        if (
          O.to - O.from != p ||
          s.state.sliceDoc(b, g) != c ||
          (O.to >= f.from && O.from <= f.to)
        )
          return { range: O };
        let S = n.changes({ from: b, to: g, insert: t.insert }),
          y = O.to - r.to;
        return {
          changes: S,
          range: h
            ? k.range(Math.max(0, h.anchor + y), Math.max(0, h.head + y))
            : O.map(S),
        };
      });
    } else i = { changes: l, selection: h && n.selection.replaceRange(h) };
  }
  let a = "input.type";
  return (
    (s.composing ||
      (s.inputState.compositionPendingChange &&
        s.inputState.compositionEndedAt > Date.now() - 50)) &&
      ((s.inputState.compositionPendingChange = !1),
      (a += ".compose"),
      s.inputState.compositionFirstChange &&
        ((a += ".start"), (s.inputState.compositionFirstChange = !1))),
    n.update(i, { userEvent: a, scrollIntoView: !0 })
  );
}
function gc(s, t, e, i) {
  let n = Math.min(s.length, t.length),
    r = 0;
  for (; r < n && s.charCodeAt(r) == t.charCodeAt(r);) r++;
  if (r == n && s.length == t.length) return null;
  let o = s.length,
    a = t.length;
  for (; o > 0 && a > 0 && s.charCodeAt(o - 1) == t.charCodeAt(a - 1);)
    (o--, a--);
  if (i == "end") {
  ...
  return (
    o < r && s.length < t.length
      ? ((r -= e <= r && e >= o ? r - e : 0), (a = r + (a - o)), (o = r))
      : a < r &&
        ((r -= e <= r && e >= a ? r - e : 0), (o = r + (o - a)), (a = r)),
    { from: r, toA: o, toB: a }
  );
}
function zm(s) {
  let t = [];
  if (s.root.activeElement != s.contentDOM) return t;
  let {
    anchorNode: e,
    anchorOffset: i,
    focusNode: n,
    focusOffset: r,
  } = s.observer.selectionRange;
  return (
    e && (t.push(new zo(e, i)), (n != e || r != i) && t.push(new zo(n, r))),
    t
  );
}
function Vm(s, t) {
...
var bc = class {
  ...
  constructor(t) {
    ((this.view = t),
      ...
      T.safari && t.contentDOM.addEventListener("input", () => null),
      T.gecko && ig(t.contentDOM.ownerDocument));
  }
  handleEvent(t) {
    !Gm(this.view, t) ||
      this.ignoreDuringComposition(t) ||
      (t.type == "keydown" && this.keydown(t)) ||
  ...
  runHandlers(t, e) {
    ...
    if (i) {
      for (let n of i.observers) n(this.view, e);
  ...
  ensureHandlers(t) {
    ...
    for (let r in e)
      if (r != "scroll") {
        ...
        (a &&
          o != !a.handlers.length &&
          (n.removeEventListener(r, this.handleEvent), (a = null)),
          a || n.addEventListener(r, this.handleEvent, { passive: o }));
      }
    for (let r in i)
  ...
  keydown(t) {
    ...
    return T.ios &&
      ...
      !t.altKey &&
      !t.metaKey &&
      (((e = yc.find((i) => i.keyCode == t.keyCode)) && !t.ctrlKey) ||
        (Ym.indexOf(t.key) > -1 && t.ctrlKey && !t.shiftKey))
      ? ((this.pendingIOSKey = e || t),
        setTimeout(() => this.flushIOSKey(), 250),
        !0)
      : (t.keyCode != 229 && this.view.observer.forceFlush(), !1);
  }
  flushIOSKey(t) {
  ...
  ignoreDuringComposition(t) {
    return !/^key/.test(t.type) || t.synthetic
      ? !1
      : this.composing > 0
        ? !0
        : T.safari &&
...
function jm(s) {
  ...
  for (let i of s) {
    let n = i.spec,
      r = n && n.plugin.domEventHandlers,
      o = n && n.plugin.domEventObservers;
    if (r)
      for (let a in r) {
        let l = r[a];
        l && e(a).handlers.push(Sc(i.value, l));
      }
    if (o)
      for (let a in o) {
        let l = o[a];
        l && e(a).observers.push(Sc(i.value, l));
      }
  }
  for (let i in re) e(i).handlers.push(re[i]);
  for (let i in Ut) e(i).observers.push(Ut[i]);
  return t;
}
var yc = [
...
function Nm(s, t) {
  return Math.max(
    Math.abs(s.clientX - t.clientX),
    Math.abs(s.clientY - t.clientY),
  );
}
var vc = class {
  constructor(t, e, i, n) {
    ((this.view = t),
      ...
      (this.scrolling = -1),
      (this.lastEvent = e),
      (this.scrollParents = nm(t.contentDOM)),
      (this.atoms = t.state.facet(Pn).map((o) => o(t))));
    ...
    (r.addEventListener("mousemove", (this.move = this.move.bind(this))),
      ...
      (this.multiple = t.state.facet(I.allowMultipleSelections) && qm(t, e)),
      (this.dragging = _m(t, e) && Ec(e) == 1 ? null : !1));
  }
  start(t) {
  ...
  move(t) {
    ...
    if (this.dragging || (this.dragging == null && Nm(this.startEvent, t) < 10))
      return;
    ...
    (this.scrollParents.x &&
      ({ left: n, right: o } = this.scrollParents.x.getBoundingClientRect()),
      this.scrollParents.y &&
        ({ top: r, bottom: a } = this.scrollParents.y.getBoundingClientRect()));
    let l = sc(this.view);
    (t.clientX - l.left <= n + Vs
      ? (e = -js(n - t.clientX))
      : t.clientX + l.right >= o - Vs && (e = js(t.clientX - o)),
      t.clientY - l.top <= r + Vs
        ? (i = -js(r - t.clientY))
        : t.clientY + l.bottom >= a - Vs && (i = js(t.clientY - a)),
      this.setScrollSpeed(e, i));
  }
  up(t) {
  ...
  select(t) {
    let { view: e } = this,
      i = dc(this.atoms, this.style.get(t, this.extend, this.multiple));
    ((this.mustSelect || !i.eq(e.state.selection, this.dragging === !1)) &&
      this.view.dispatch({ selection: i, userEvent: "select.pointer" }),
      (this.mustSelect = !1));
  }
  update(t) {
    t.transactions.some((e) => e.isUserEvent("input.type"))
      ? this.destroy()
      : this.style.update(t) &&
...
var re = Object.create(null),
  ...
  xc = (T.ie && T.ie_version < 15) || (T.ios && T.webkit_version < 604);
function Um(s) {
  ...
  ((e.style.cssText = "position: fixed; left: -10000px; top: 10px"),
    e.focus(),
    setTimeout(() => {
      (s.focus(), e.remove(), kc(s, e.value));
    }, 50));
}
function Ys(s, t, e) {
  for (let i of s.facet(t)) e = i(e, s);
  return e;
}
function kc(s, t) {
  t = Ys(s.state, Zo, t);
  let { state: e } = s,
    ...
    n = 1,
    r = e.toText(t),
    o = r.lines == e.selection.ranges.length;
  if (
    jo != null &&
    e.selection.ranges.every((l) => l.empty) &&
    jo == r.toString()
  ) {
    let l = -1;
    i = e.changeByRange((h) => {
    ...
    o
      ? (i = e.changeByRange((l) => {
          ...
          return {
            ...
            range: k.cursor(l.from + h.length),
          };
        }))
      : (i = e.replaceSelection(r));
  s.dispatch(i, { userEvent: "input.paste", scrollIntoView: !0 });
}
Ut.scroll = (s) => {
  ((s.inputState.lastScrollTop = s.scrollDOM.scrollTop),
    (s.inputState.lastScrollLeft = s.scrollDOM.scrollLeft));
};
re.keydown = (s, t) => (
  s.inputState.setSelectionOrigin("select"),
  t.keyCode == 27 &&
    s.inputState.tabFocusMode != 0 &&
    (s.inputState.tabFocusMode = Date.now() + 2e3),
  !1
);
Ut.touchstart = (s, t) => {
  ((s.inputState.lastTouchTime = Date.now()),
...
re.mousedown = (s, t) => {
  if ((s.observer.flush(), s.inputState.lastTouchTime > Date.now() - 2e3))
    return !1;
  let e = null;
  for (let i of s.state.facet(qh)) if (((e = i(s, t)), e)) break;
  if ((!e && t.button == 0 && (e = Km(s, t)), e)) {
    let i = !s.hasFocus;
    (s.inputState.startMouseSelection(new vc(s, t, e, i)),
      i &&
        s.observer.ignore(() => {
          kh(s.contentDOM);
    ...
    if (n) return (n.start(t), n.dragging === !1);
  } else s.inputState.setSelectionOrigin("select.pointer");
  return !1;
};
function Qc(s, t, e, i) {
  if (i == 1) return k.cursor(t, e);
  if (i == 2) return Cm(s.state, t, e);
  {
    let n = at.find(s.docView, t),
      r = s.state.doc.lineAt(n ? n.posAtEnd : t),
      o = n ? n.posAtStart : r.from,
      a = n ? n.posAtEnd : r.to;
    return (a < s.state.doc.length && a == r.to && a++, k.range(o, a));
  }
}
var Pc = (s, t, e) =>
  t >= e.top && t <= e.bottom && s >= e.left && s <= e.right;
function Fm(s, t, e, i) {
  let n = at.find(s.docView, t);
  if (!n) return 1;
  ...
  if (o && Pc(e, i, o)) return -1;
  let a = n.coordsAt(r, 1);
  return a && Pc(e, i, a) ? 1 : o && o.bottom >= i ? -1 : 1;
}
function $c(s, t) {
  let e = s.posAtCoords({ x: t.clientX, y: t.clientY }, !1);
  return { pos: e, bias: Fm(s, e, t.clientX, t.clientY) };
}
var Hm = T.ie && T.ie_version <= 11,
  Tc = null,
  Cc = 0,
  Ac = 0;
function Ec(s) {
  if (!Hm) return s.detail;
  let t = Tc,
    e = Ac;
  return (
    (Tc = s),
    ...
    (Cc =
      !t ||
      (e > Date.now() - 400 &&
        Math.abs(t.clientX - s.clientX) < 2 &&
        Math.abs(t.clientY - s.clientY) < 2)
        ? (Cc + 1) % 3
        : 1)
  );
}
function Km(s, t) {
  ...
  return {
    update(r) {
      r.docChanged &&
        ((e.pos = r.changes.mapPos(e.pos)), (n = n.map(r.changes)));
    },
    get(r, o, a) {
      let l = $c(s, r),
        h,
        c = Qc(s, l.pos, l.bias, i);
      if (e.pos != l.pos && !o) {
        let f = Qc(s, e.pos, e.bias, i),
      ...
      return o
        ...
        : a && i == 1 && n.ranges.length > 1 && (h = Jm(n, l.pos))
          ? h
          : a
            ? n.addRange(c)
            : k.create([c]);
...
function Jm(s, t) {
  for (let e = 0; e < s.ranges.length; e++) {
    ...
    if (i <= t && n >= t)
      return k.create(
        s.ranges.slice(0, e).concat(s.ranges.slice(e + 1)),
        s.mainIndex == e ? 0 : s.mainIndex - (s.mainIndex > e ? 1 : 0),
      );
  }
  return null;
}
  ...
  return (
    ...
    t.dataTransfer &&
      (t.dataTransfer.setData(
        "Text",
        Ys(s.state, Mo, s.state.sliceDoc(e.from, e.to)),
      ),
      (t.dataTransfer.effectAllowed = "copyMove")),
    !1
  );
};
re.dragend = (s) => ((s.inputState.draggedContent = null), !1);
function Zc(s, t, e, i) {
  if (((e = Ys(s.state, Zo, e)), !e)) return;
  let n = s.posAtCoords({ x: t.clientX, y: t.clientY }, !1),
    { draggedContent: r } = s.inputState,
    o = i && r && Wm(s, t) ? { from: r.from, to: r.to } : null,
    a = { from: n, insert: e },
    l = s.state.changes(o ? [o, a] : a);
  (s.focus(),
    s.dispatch({
      changes: l,
...
re.drop = (s, t) => {
  ...
  if (e && e.length) {
    let i = Array(e.length),
      ...
      r = () => {
        ++n == e.length &&
          Zc(s, t, i.filter((o) => o != null).join(s.state.lineBreak), !1);
      };
...
re.paste = (s, t) => {
  ...
  return e
    ? (kc(s, e.getData("text/plain") || e.getData("text/uri-list")), !0)
    : (Um(s), !1);
};
function tg(s, t) {
...
function eg(s) {
  ...
  if (!t.length) {
    ...
    for (let { from: r } of s.selection.ranges) {
      ...
      (o.number > n &&
        (t.push(o.text),
        e.push({ from: o.from, to: Math.min(s.doc.length, o.to + 1) })),
        (n = o.number));
    }
    i = !0;
  }
  return { text: Ys(s, Mo, t.join(s.lineBreak)), ranges: e, linewise: i };
}
var jo = null;
re.copy = re.cut = (s, t) => {
  let { text: e, ranges: i, linewise: n } = eg(s.state);
  if (!e && !n) return !1;
  ((jo = n ? e : null),
    t.type == "cut" &&
      !s.state.readOnly &&
      s.dispatch({ changes: i, scrollIntoView: !0, userEvent: "delete.cut" }));
  let r = xc ? null : t.clipboardData;
  return r ? (r.clearData(), r.setData("text/plain", e), !0) : (tg(s, e), !1);
};
var Mc = Se.define();
function Xc(s, t) {
  let e = [];
  for (let i of s.facet(Gh)) {
    let n = i(s, t);
    n && e.push(n);
  }
  return e.length ? s.update({ effects: e, annotations: Mc.of(!0) }) : null;
}
function Rc(s) {
  setTimeout(() => {
    let t = s.hasFocus;
...
Ut.focus = (s) => {
  ((s.inputState.lastFocusTime = Date.now()),
    !s.scrollDOM.scrollTop &&
      (s.inputState.lastScrollTop || s.inputState.lastScrollLeft) &&
      ((s.scrollDOM.scrollTop = s.inputState.lastScrollTop),
      (s.scrollDOM.scrollLeft = s.inputState.lastScrollLeft)),
    Rc(s));
};
Ut.blur = (s) => {
  (s.observer.clearSelectionRange(), Rc(s));
};
Ut.compositionstart = Ut.compositionupdate = (s) => {
  s.observer.editContext ||
    (s.inputState.compositionFirstChange == null &&
      (s.inputState.compositionFirstChange = !0),
    s.inputState.composing < 0 && (s.inputState.composing = 0));
};
Ut.compositionend = (s) => {
  s.observer.editContext ||
    ((s.inputState.composing = -1),
    (s.inputState.compositionEndedAt = Date.now()),
    (s.inputState.compositionPendingKey = !0),
    (s.inputState.compositionPendingChange =
      s.observer.pendingRecords().length > 0),
    (s.inputState.compositionFirstChange = null),
    T.chrome && T.android
      ? s.observer.flushSoon()
      : s.inputState.compositionPendingChange
        ? Promise.resolve().then(() => s.observer.flush())
        : setTimeout(() => {
            s.inputState.composing < 0 &&
              s.docView.hasComposition &&
              s.update([]);
          }, 50));
};
Ut.contextmenu = (s) => {
...
re.beforeinput = (s, t) => {
  ...
  if (t.inputType == "insertReplacementText" && s.observer.editContext) {
    let r =
        (e = t.dataTransfer) === null || e === void 0
          ? void 0
          : e.getData("text/plain"),
      o = t.getTargetRanges();
    if (r && o.length) {
      let a = o[0],
        l = s.posAtDOM(a.startContainer, a.startOffset),
        h = s.posAtDOM(a.endContainer, a.endOffset);
      return (Vo(s, { from: l, to: h, insert: s.state.toText(r) }, null), !0);
    }
  }
  let n;
  if (
    T.chrome &&
    T.android &&
    (n = yc.find((r) => r.inputType == t.inputType)) &&
    (s.observer.delayAndroidKey(n.key, n.keyCode),
    ...
    setTimeout(() => {
      ...
      (((o = window.visualViewport) === null || o === void 0
        ...
        r + 10 &&
        s.hasFocus &&
        (s.contentDOM.blur(), s.focus());
    }, 100);
  }
  return (
    T.ios && t.inputType == "deleteContentForward" && s.observer.flushSoon(),
    T.safari &&
      t.inputType == "insertText" &&
      s.inputState.composing >= 0 &&
      setTimeout(() => Ut.compositionend(s, t), 20),
    !1
  );
};
var Lc = new Set();
...
var Ic = ["pre-wrap", "normal", "pre-line", "break-spaces"],
  Wi = !1;
function Dc() {
  Wi = !1;
}
var Bc = class {
    ...
    mustRefreshForWrapping(t) {
      return Ic.indexOf(t) > -1 != this.lineWrapping;
    }
    mustRefreshForHeights(t) {
      ...
      for (let i = 0; i < t.length; i++) {
        ...
        n < 0
          ? i++
          : this.heightSamples[Math.floor(n * 10)] ||
            ((e = !0), (this.heightSamples[Math.floor(n * 10)] = !0));
      }
      return e;
    }
    refresh(t, e, i, n, r, o) {
      let a = Ic.indexOf(t) > -1,
        l =
  ...
  oe = class {
    ...
    get widget() {
      return this._content instanceof Le ? this._content.widget : null;
    }
  ...
  et = (function (s) {
    return (
      (s[(s.ByPos = 0)] = "ByPos"),
      (s[(s.ByHeight = 1)] = "ByHeight"),
      (s[(s.ByPosNoHeight = 2)] = "ByPosNoHeight"),
      s
    );
  })(et || (et = {})),
  Ns = 0.001,
  xt = class {
    ...
    setHeight(t) {
      this.height != t &&
        (Math.abs(this.height - t) > Ns && (Wi = !0), (this.height = t));
    }
    replace(t, e, i) {
      return xt.of(i);
    }
    ...
    applyChanges(t, e, i, n) {
      ...
      for (let a = n.length - 1; a >= 0; a--) {
        let { fromA: l, toA: h, fromB: c, toB: f } = n[a],
          u = r.lineAt(l, et.ByPosNoHeight, i.setDoc(e), 0, 0),
          d = u.to >= h ? u : r.lineAt(h, et.ByPosNoHeight, i, 0, 0);
        for (f += d.to - h, h = d.to; a > 0 && u.from <= n[a - 1].toA;)
          ((l = n[a - 1].fromA),
            (c = n[a - 1].fromB),
            a--,
            l < u.from && (u = r.lineAt(l, et.ByPosNoHeight, i, 0, 0)));
        ((c += u.from - l), (l = u.from));
        let p = Ws.build(i.setDoc(o), t, c, f);
        r = qs(r, r.replace(l, h, p));
      }
    ...
    static of(t) {
      ...
      for (;;)
        if (e == i)
          if (n > r * 2) {
            let a = t[e - 1];
            (a.break
              ? t.splice(--e, 1, a.left, null, a.right)
              : t.splice(--e, 1, a.left, a.right),
              (i += 1 + a.break),
              (n -= a.size));
          } else if (r > n * 2) {
            let a = t[i];
            (a.break
              ? t.splice(i, 1, a.left, null, a.right)
              : t.splice(i, 1, a.left, a.right),
              (i += 2 + a.break),
              (r -= a.size));
          } else break;
        else if (n < r) {
      ...
      let o = 0;
      return (
        t[e - 1] == null ? ((o = 1), e--) : t[e] == null && ((o = 1), i++),
        new Vc(xt.of(t.slice(0, e)), o, xt.of(t.slice(i)))
      );
    }
  };
function qs(s, t) {
  return s == t ? s : (s.constructor != t.constructor && (Wi = !0), t);
}
xt.prototype.size = 1;
var Yo = class extends xt {
    constructor(t, e, i) {
      super(t, e);
      this.deco = i;
    }
    blockAt(t, e, i, n) {
      return new oe(n, this.length, i, this.height, this.deco || 0);
    }
    lineAt(t, e, i, n, r) {
    ...
    updateHeight(t, e = 0, i = !1, n) {
      return (
        n && n.from <= e && n.more && this.setHeight(n.heights[n.index++]),
        (this.outdated = !1),
        this
      );
    }
  ...
  Mt = class extends Yo {
    constructor(t, e) {
      super(t, e, null);
      ((this.collapsed = 0), (this.widgetHeight = 0), (this.breaks = 0));
    }
    blockAt(t, e, i, n) {
      return new oe(n, this.length, i, this.height, this.breaks);
    }
    replace(t, e, i) {
      let n = i[0];
      return i.length == 1 &&
        (n instanceof Mt || (n instanceof Ot && n.flags & 4)) &&
        Math.abs(this.length - n.length) < 10
        ? (n instanceof Ot
            ? (n = new Mt(n.length, this.height))
  ...
  Ot = class extends xt {
    ...
    heightMetrics(t, e) {
      ...
      if (t.lineWrapping) {
        ...
        ((o = l / r),
          this.length > r + 1 &&
            (a = (this.height - l) / (this.length - r - 1)));
    ...
    blockAt(t, e, i, n) {
      ...
      if (e.lineWrapping) {
        let h =
          ...
          f = a + c.length * l,
          u = Math.max(i, t - f / 2);
        return new oe(c.from, c.length, u, f, 0);
      } else {
        let h = Math.max(0, Math.min(o - r, Math.floor((t - i) / a))),
          { from: c, length: f } = e.doc.line(r + h);
        return new oe(c, f, i + a * h, a, 0);
      }
    }
    lineAt(t, e, i, n, r) {
      if (e == et.ByHeight) return this.blockAt(t, i, n, r);
      if (e == et.ByPosNoHeight) {
        let { from: d, to: p } = i.doc.lineAt(t);
        return new oe(d, p - d, 0, 0, 0);
      }
      let { firstLine: o, perLine: a, perChar: l } = this.heightMetrics(i, r),
        h = i.doc.lineAt(t),
        c = a + h.length * l,
        f = h.number - o,
        u = n + a * f + l * (h.from - r - f);
      return new oe(
        h.from,
        h.length,
        Math.max(n, Math.min(u, n + this.height - c)),
        c,
        0,
      );
    }
    forEachLine(t, e, i, n, r, o) {
      ...
      for (let c = t, f = n; c <= e;) {
        ...
        let d = l + h * u.length;
        (o(new oe(u.from, u.length, f, d, 0)), (f += d), (c = u.to + 1));
      }
    }
    replace(t, e, i) {
      let n = this.length - e;
      if (n > 0) {
        let r = i[i.length - 1];
        r instanceof Ot
          ? (i[i.length - 1] = new Ot(r.length + n))
          : i.push(null, new Ot(n - 1));
      }
      if (t > 0) {
        let r = i[0];
        r instanceof Ot
          ? (i[0] = new Ot(t + r.length))
          : i.unshift(new Ot(t - 1), null);
      }
      return xt.of(i);
    }
    decomposeLeft(t, e) {
    ...
    updateHeight(t, e = 0, i = !1, n) {
      ...
      if (n && n.from <= e + this.length && n.more) {
        let o = [],
          ...
          l = -1;
        for (
          n.from > e && o.push(new Ot(n.from - e - 1).updateHeight(t, e));
          a <= r && n.more;
        ) {
          let c = t.doc.lineAt(a).length;
          o.length && o.push(null);
          let f = n.heights[n.index++];
          l == -1 ? (l = f) : Math.abs(f - l) >= Ns && (l = -2);
          let u = new Mt(c, f);
          ((u.outdated = !1), o.push(u), (a += c + 1));
        }
        a <= r && o.push(null, new Ot(r - a).updateHeight(t, a));
        let h = xt.of(o);
        return (
          (l < 0 ||
            Math.abs(h.height - this.height) >= Ns ||
            Math.abs(l - this.heightMetrics(t, e).perLine) >= Ns) &&
            (Wi = !0),
          qs(this, h)
        );
      } else
  ...
  Vc = class extends xt {
    ...
    lineAt(t, e, i, n, r) {
      let o = n + this.left.height,
        ...
        l = e == et.ByHeight ? t < o : t < a,
        h = l
          ? this.left.lineAt(t, e, i, n, r)
          : this.right.lineAt(t, e, i, o, a);
      if (this.break || (l ? h.to < a : h.from > a)) return h;
      let c = e == et.ByPosNoHeight ? et.ByPosNoHeight : et.ByPos;
      return l
        ? h.join(this.right.lineAt(a, c, i, o, a))
        : this.left.lineAt(a, c, i, n, r).join(h);
    }
    forEachLine(t, e, i, n, r, o) {
      let a = n + this.left.height,
        l = r + this.left.length + this.break;
      if (this.break)
        (t < l && this.left.forEachLine(t, e, i, n, r, o),
          e >= l && this.right.forEachLine(t, e, i, a, l, o));
      else {
        let h = this.lineAt(l, et.ByPos, i, n, r);
        (t < h.from && this.left.forEachLine(t, h.from - 1, i, n, r, o),
          h.to >= t && h.from <= e && o(h),
          e > h.to && this.right.forEachLine(h.to + 1, e, i, a, l, o));
      }
    }
    replace(t, e, i) {
      ...
      let o = r.length;
      for (let a of i) r.push(a);
      if ((t > 0 && jc(r, o - 1), e < this.length)) {
        let a = r.length;
        (this.decomposeRight(e, r), jc(r, a));
      }
      return xt.of(r);
    }
    decomposeLeft(t, e) {
    ...
    balanced(t, e) {
      return t.size > 2 * e.size || e.size > 2 * t.size
        ? xt.of(this.break ? [t, null, e] : [t, e])
        : ((this.left = qs(this.left, t)),
          (this.right = qs(this.right, e)),
    ...
    updateHeight(t, e = 0, i = !1, n) {
      let { left: r, right: o } = this,
        a = e + r.length + this.break,
        l = null;
      return (
        n && n.from <= e + r.length && n.more
          ? (l = r = r.updateHeight(t, e, i, n))
          : r.updateHeight(t, e, i),
        n && n.from <= a + o.length && n.more
          ? (l = o = o.updateHeight(t, a, i, n))
          : o.updateHeight(t, a, i),
        l
          ? this.balanced(r, o)
...
function jc(s, t) {
  let e, i;
  s[t] == null &&
    (e = s[t - 1]) instanceof Ot &&
    (i = s[t + 1]) instanceof Ot &&
    s.splice(t - 1, 3, new Ot(e.length + 1 + i.length));
}
var ng = 5,
  Ws = class {
    constructor(t, e) {
      ...
      if (this.lineStart > -1) {
        ...
        (n instanceof Mt
          ...
          : (i > this.pos || !this.isCovered) &&
            this.nodes.push(new Mt(i - this.pos, -1)),
          (this.writtenTo = i),
          e > i &&
    ...
    point(t, e, i) {
      if (t < e || i.heightRelevant) {
        ...
        let o = e - t;
        i.block
          ? this.addBlock(new Yo(o, n, i))
          : (o || r || n >= ng) && this.addLineDeco(n, r, o);
    ...
    enterLine() {
      ...
      ((this.lineStart = t),
        ...
        this.pos > t && this.nodes.push(new Mt(this.pos - t, -1)),
    ...
    finish(t) {
      ...
      this.lineStart > -1 && !(e instanceof Mt) && !this.isCovered
        ? this.nodes.push(new Mt(0, -1))
        : (this.writtenTo < this.pos || e == null) &&
          this.nodes.push(this.blankContent(this.writtenTo, this.pos));
      let i = t;
      for (let n of this.nodes)
        (n instanceof Mt && n.updateHeight(this.oracle, i),
          (i += n ? n.length : 1));
      return this.nodes;
    }
    static build(t, e, i, n) {
      let r = new Ws(i, t);
      return (_.spans(e, i, n, r, 0), r.finish(i));
    }
  };
function sg(s, t, e) {
  let i = new Yc();
  return (_.compare(s, t, e, i, 0), i.changes);
}
var Yc = class {
  constructor() {
    this.changes = [];
...
function rg(s, t) {
  let e = s.getBoundingClientRect(),
    ...
    r = Math.max(0, e.left),
    o = Math.min(n.innerWidth, e.right),
    a = Math.max(0, e.top),
    l = Math.min(n.innerHeight, e.bottom);
    ...
    if (h.nodeType == 1) {
      ...
      if (
        ...
        ((r = Math.max(r, u.left)),
          ...
          (a = Math.max(a, u.top)),
          (l = Math.min(h == s.parentNode ? n.innerHeight : l, u.bottom)));
      }
      h =
  ...
  return {
    ...
    top: a - (e.top + t),
    bottom: Math.max(a, l) - (e.top + t),
  };
}
function og(s) {
  let t = s.getBoundingClientRect(),
    e = s.ownerDocument.defaultView || window;
  return (
    t.left < e.innerWidth &&
    t.right > 0 &&
    t.top < e.innerHeight &&
  ...
  No = class {
    constructor(t) {
      ((this.state = t),
        ...
        (this.defaultTextDirection = it.LTR),
        (this.visibleRanges = []),
        (this.mustEnforceCursorAssoc = !1));
      let e = t
        .facet(Xo)
        .some((i) => typeof i != "function" && i.class == "cm-lineWrapping");
      ((this.heightOracle = new Bc(e)),
        (this.stateDeco = t.facet(Qn).filter((i) => typeof i != "function")),
        (this.heightMap = xt
          .empty()
          .applyChanges(
            this.stateDeco,
      ...
      (this.updateViewportLines(),
        ...
        (this.lineGapDeco = q.set(this.lineGaps.map((i) => i.draw(this, !1)))),
    ...
    updateForViewport() {
      ...
      return (
        (this.viewports = t.sort((i, n) => i.from - n.from)),
        this.updateScaler()
      );
    }
    updateScaler() {
      ...
      return (
        (this.scaler =
          this.heightMap.height <= 7e6
            ? qc
            : new Fs(this.heightOracle, this.heightMap, this.viewports)),
    ...
    updateViewportLines() {
      ((this.viewportLines = []),
        this.heightMap.forEachLine(
          ...
          0,
          (t) => {
            this.viewportLines.push(Zn(t, this.scaler));
          },
        ));
    }
    update(t, e = null) {
      ...
      let n = t.changedRanges,
        r = zt.extendWithRanges(
          n,
          sg(
            i,
            this.stateDeco,
            t ? t.changes : ht.empty(this.state.doc.length),
          ),
        ),
      ...
      (Dc(),
        ...
        (this.heightMap.height != o || Wi) && (t.flags |= 2),
        a
          ? ((this.scrollAnchorPos = t.changes.mapPos(a.from, -1)),
      ...
      ((this.viewport = l),
        ...
        (h || !t.changes.empty || t.flags & 2) && this.updateViewportLines(),
    ...
    measure(t) {
      ...
      (this.scrollTop != d &&
        ...
        (this.scrolledToBottom = $h(t.scrollDOM)));
      let p = (this.printing ? ag : rg)(e, this.paddingTop),
      ...
      if (
        (b != this.inView && ((this.inView = b), b && (l = !0)),
        !this.inView && !this.scrollTarget && !og(t.dom))
      )
        return 0;
      let S = a.width;
      if (
        ...
        if (
          (n.mustRefreshForHeights(C) && (o = !0),
          o ||
            (n.lineWrapping &&
              Math.abs(S - this.contentDOMWidth) > n.charWidth))
        ) {
          let {
            lineHeight: w,
            charWidth: Q,
          ...
          ((o = w > 0 && n.refresh(r, w, Q, P, Math.max(5, S / Q), C)),
            o && ((t.docView.minWidth = 0), (h |= 16)));
        }
        (O > 0 && g > 0
          ? (c = Math.max(O, g))
          : O < 0 && g < 0 && (c = Math.min(O, g)),
          Dc());
        for (let w of this.viewports) {
          let Q =
            w.from == this.viewport.from
              ? C
              : t.docView.measureVisibleLineHeights(w);
          this.heightMap = (
            o
              ? xt
                  .empty()
                  .applyChanges(this.stateDeco, B.empty, this.heightOracle, [
                    new zt(0, 0, 0, t.state.doc.length),
                  ])
              : this.heightMap
          ).updateHeight(n, 0, o, new zc(w.from, Q));
        }
        Wi && (h |= 2);
      }
      let y =
      ...
      return (
        ...
        (h & 2 || y) && this.updateViewportLines(),
        (this.lineGaps.length ||
          this.viewport.to - this.viewport.from > 2e3 << 1) &&
          this.updateLineGaps(this.ensureLineGaps(o ? [] : this.lineGaps, t)),
    ...
    getViewport(t, e) {
      let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)),
        ...
        l = new En(
          n.lineAt(o - i * 1e3, et.ByHeight, r, 0, 0).from,
          n.lineAt(a + (1 - i) * 1e3, et.ByHeight, r, 0, 0).to,
        );
      if (e) {
        let { head: h } = e.range;
        if (h < l.from || h > l.to) {
          let c = Math.min(
            ...
            f = n.lineAt(h, et.ByPos, r, 0, 0),
            u;
          (e.y == "center"
            ? (u = (f.top + f.bottom) / 2 - c / 2)
            : e.y == "start" || (e.y == "nearest" && h < l.from)
              ? (u = f.top)
              : (u = f.bottom - c),
            (l = new En(
              n.lineAt(u - 1e3 / 2, et.ByHeight, r, 0, 0).from,
              n.lineAt(u + c + 1e3 / 2, et.ByHeight, r, 0, 0).to,
            )));
        }
      }
      return l;
    ...
    mapViewport(t, e) {
      let i = e.mapPos(t.from, -1),
        n = e.mapPos(t.to, 1);
      return new En(
        this.heightMap.lineAt(i, et.ByPos, this.heightOracle, 0, 0).from,
        this.heightMap.lineAt(n, et.ByPos, this.heightOracle, 0, 0).to,
      );
    }
    viewportIsAppropriate({ from: t, to: e }, i = 0) {
      ...
      let { top: n } = this.heightMap.lineAt(
        ...
        { visibleTop: o, visibleBottom: a } = this;
      return (
        (t == 0 || n <= o - Math.max(10, Math.min(-i, 250))) &&
        (e == this.state.doc.length ||
          r >= a + Math.max(10, Math.min(i, 250))) &&
        n > o - 2 * 1e3 &&
        r < a + 2 * 1e3
      );
    }
    mapLineGaps(t, e) {
      ...
      for (let n of t)
        e.touchesRange(n.from, n.to) ||
          i.push(
            new _s(e.mapPos(n.from), e.mapPos(n.to), n.size, n.displaySize),
          );
      return i;
    }
    ensureLineGaps(t, e) {
      let i = this.heightOracle.lineWrapping,
        ...
        r = n >> 1,
        o = n << 1;
      if (this.defaultTextDirection != it.LTR && !i) return [];
      let a = [],
        l = (c, f, u, d) => {
          if (f - c < r) return;
          ...
          if (!g) {
            if (
              ...
              e &&
              i &&
              e.visibleRanges.some((y) => y.from <= f && y.to >= f)
            ) {
              let y = e.moveToLineBoundary(k.cursor(f), !1, !0).head;
              y > c && (f = y);
            }
        ...
        h = (c) => {
          if (c.length < o || c.type != Bt.Text) return;
          let f = lg(c.from, c.to, this.stateDeco);
          if (f.total < o) return;
          ...
          if (i) {
            ...
            if (u != null) {
              let S = Us(f, u),
                y = ((this.visibleBottom - this.visibleTop) / 2 + O) / c.height;
              ((g = S - y), (b = S + y));
            } else
            ...
            let O = f.total * this.heightOracle.charWidth,
              g = n * this.heightOracle.charWidth,
              b = 0;
            if (O > 2e6)
              for (let Q of t)
                Q.from >= c.from &&
                  Q.from < c.to &&
                  Q.size != Q.displaySize &&
                  Q.from * this.heightOracle.charWidth + b <
                    this.pixelViewport.left &&
                  (b = Q.size - Q.displaySize);
            let S = this.pixelViewport.left + b,
              y = this.pixelViewport.right + b,
              C,
              w;
            if (u != null) {
              let Q = Us(f, u),
    ...
    updateLineGaps(t) {
      _s.same(t, this.lineGaps) ||
        ((this.lineGaps = t),
        (this.lineGapDeco = q.set(
          t.map((e) => e.draw(this, this.heightOracle.lineWrapping)),
        )));
    }
    computeVisibleRanges(t) {
      ...
      let n = 0;
      if (i.length != this.visibleRanges.length) n = 8 | 4;
      else
        for (let r = 0; r < i.length && !(n & 8); r++) {
          ...
          (o.from != a.from || o.to != a.to) &&
            ((n |= 4),
            (t &&
              t.mapPos(o.from, -1) == a.from &&
              t.mapPos(o.to, 1) == a.to) ||
              (n |= 8));
        }
    ...
    lineBlockAt(t) {
      return (
        ...
        Zn(
          this.heightMap.lineAt(t, et.ByPos, this.heightOracle, 0, 0),
          this.scaler,
        )
      );
    }
    ...
    scrollAnchorAt(t) {
      ...
      return e.from >= this.viewport.from || this.viewportLines[0].top - t > 200
        ? e
        : this.viewportLines[0];
    }
    elementAtHeight(t) {
      return Zn(
        this.heightMap.blockAt(this.scaler.fromDOM(t), this.heightOracle, 0, 0),
        this.scaler,
      );
    }
    get docHeight() {
...
function lg(s, t, e) {
  ...
  return (
    ...
    n < t && (i.push({ from: n, to: t }), (r += t - n)),
    { total: r, ranges: i }
  );
}
function Gs({ total: s, ranges: t }, e) {
...
function hg(s, t) {
  for (let e of s) if (t(e)) return e;
}
var qc = {
    toDOM(s) {
      return s;
  ...
  Fs = class {
    constructor(t, e, i) {
      ...
      ((this.viewports = i.map(({ from: a, to: l }) => {
        let h = e.lineAt(a, et.ByPos, t, 0, 0).top,
          c = e.lineAt(l, et.ByPos, t, 0, 0).bottom;
        return (
          (n += c - h),
          { from: a, to: l, top: h, bottom: c, domTop: 0, domBottom: 0 }
        );
      })),
        (this.scale = (7e6 - n) / (e.height - n)));
      for (let a of this.viewports)
        ((a.domTop = o + (a.top - r) * this.scale),
      ...
      return t instanceof Fs
        ? this.scale == t.scale &&
            ...
            this.viewports.every(
              (e, i) =>
                e.from == t.viewports[i].from && e.to == t.viewports[i].to,
            )
        : !1;
    }
  };
function Zn(s, t) {
  if (t.scale == 1) return s;
  let e = t.toDOM(s.top),
    i = t.toDOM(s.bottom);
  return new oe(
    s.from,
    ...
    e,
    i - e,
    Array.isArray(s._content) ? s._content.map((n) => Zn(n, t)) : s._content,
  );
}
var Hs = M.define({ combine: (s) => s.join(" ") }),
  qo = M.define({ combine: (s) => s.indexOf(!0) > -1 }),
  Wo = se.newName(),
  Wc = se.newName(),
  _c = se.newName(),
  Gc = { "&light": "." + Wc, "&dark": "." + _c };
  ...
  return new se(t, {
    finish(i) {
      return /&/.test(i)
        ? i.replace(/&\w*/, (n) => {
            if (n == "&") return s;
            if (!e || !e[n]) throw new RangeError(`Unsupported selector: ${n}`);
            return e[n];
          })
        : s + " " + i;
    },
...
var cg = _o(
  ...
  Go = T.ie && T.ie_version <= 11,
  Uc = class {
    constructor(t) {
      ((this.view = t),
        (this.active = !1),
        (this.editContext = null),
        (this.selectionRange = new xh()),
        ...
        (this.observer = new MutationObserver((e) => {
          ...
          ((T.ie && T.ie_version <= 11) || (T.ios && t.composing)) &&
          e.some(
            (i) =>
        ...
        window.EditContext &&
          T.android &&
          t.constructor.EDIT_CONTEXT !== !1 &&
          !(T.chrome && T.chrome_version < 126) &&
          ((this.editContext = new Kc(t)),
          t.state.facet(De) &&
        ...
        typeof ResizeObserver == "function" &&
          ((this.resizeScroll = new ResizeObserver(() => {
            var e;
            ((e = this.view.docView) === null || e === void 0
              ? void 0
              : e.lastUpdate) <
    ...
    onPrint(t) {
      ((t.type == "change" || !t.type) && !t.matches) ||
    ...
    onSelectionChange(t) {
      ...
      if (
        i.state.facet(De) ? i.root.activeElement != this.dom : !Zs(this.dom, n)
      )
        return;
      ...
      n.focusNode &&
      kn(n.focusNode, n.focusOffset, n.anchorNode, n.anchorOffset)
        ? this.flushSoon()
        : this.flush(!1);
    }
    readSelectionRange() {
    ...
    start() {
      this.active ||
        (this.observer.observe(this.dom, fg),
        Go &&
      ...
      if (!this.delayedAndroidKey) {
        let n = () => {
          ...
          r &&
            ...
            !this.flush() && r.force && Vi(this.dom, r.key, r.keyCode));
        };
        this.flushingAndroidKey = this.view.win.requestAnimationFrame(n);
      }
      (!this.delayedAndroidKey || t == "Enter") &&
    ...
    processRecords() {
      ...
      for (let r of t) {
        ...
        !o ||
          ...
          e == -1
            ? ({ from: e, to: i } = o)
            : ((e = Math.min(o.from, e)), (i = Math.max(o.to, i))));
      }
    ...
    flush(t = !0) {
      ...
      return (
        this.view.state == i &&
          (e.domChanged ||
            (e.newSel && !e.newSel.main.eq(this.view.state.selection.main))) &&
          this.view.update([]),
        n
      );
    }
    readMutation(t) {
      ...
      if (
        ...
        t.type == "attributes" && (e.flags |= 4),
        t.type == "childList")
      ) {
        let i = Fc(e, t.previousSibling || t.target.previousSibling, -1),
          n = Fc(e, t.nextSibling || t.target.nextSibling, 1);
        return {
    ...
    update(t) {
      this.editContext &&
        ...
        t.startState.facet(De) != t.state.facet(De) &&
          (t.view.contentDOM.editContext = t.state.facet(De)
    ...
    destroy() {
      var t, e, i;
      (this.stop(),
        (t = this.intersection) === null || t === void 0 || t.disconnect(),
        (e = this.gapIntersection) === null || e === void 0 || e.disconnect(),
...
function Hc(s, t) {
  let e = t.startContainer,
    ...
    n = t.endContainer,
    r = t.endOffset,
    o = s.docView.domAtPos(s.state.selection.main.anchor);
  return (
    kn(o.node, o.offset, n, r) && ([e, i, n, r] = [n, r, e, i]),
    { anchorNode: e, anchorOffset: i, focusNode: n, focusOffset: r }
  );
}
function ug(s, t) {
  ...
  function i(n) {
    (n.preventDefault(),
      ...
      (e = n.getTargetRanges()[0]));
  }
  return (
    s.contentDOM.addEventListener("beforeinput", i, !0),
    s.dom.ownerDocument.execCommand("indent"),
    s.contentDOM.removeEventListener("beforeinput", i, !0),
    e ? Hc(s, e) : null
  );
}
var Kc = class {
    constructor(t) {
      ...
      let e = (this.editContext = new window.EditContext({
        ...
        selectionStart: this.toContextPos(
          Math.max(this.from, Math.min(this.to, t.state.selection.main.anchor)),
        ),
      ...
      ((this.handlers.textupdate = (i) => {
        ...
        a == this.from && r < this.from
          ? (a = r)
          : l == this.to && r > this.to && (l = r);
        let c = gc(
          t.state.sliceDoc(a, l),
          i.text,
          (h ? n.from : n.to) - a,
          h ? "end" : null,
        );
        if (!c) {
          ...
          u.main.eq(n) || t.dispatch({ selection: u, userEvent: "select" });
          return;
        }
        let f = {
          from: c.from + a,
...
`),
        ...
        if (
          ((T.mac || T.android) &&
            ...
            (f = { from: a, to: l, insert: B.of([i.text.replace(".", " ")]) }),
        ...
        (this.handlers.characterboundsupdate = (i) => {
          ...
          for (
            let o = this.toEditorPos(i.rangeStart),
              a = this.toEditorPos(i.rangeEnd);
            o < a;
            o++
          ) {
            let l = t.coordsForChar(o);
            ((r =
              (l &&
                new DOMRect(
                  l.left,
        ...
        (this.handlers.textformatupdate = (i) => {
          ...
          for (let r of i.getTextFormats()) {
            let o = r.underlineStyle,
              a = r.underlineThickness;
            if (!/none/i.test(o) && !/none/i.test(a)) {
              let l = this.toEditorPos(r.rangeStart),
              ...
              if (l < h) {
                ...
                n.push(q.mark({ attributes: { style: c } }).range(l, h));
              }
            }
          }
          t.dispatch({ effects: Kh.of(q.set(n)) });
        }),
    ...
    applyEdits(t) {
      ...
      return (
        t.changes.iterChanges((r, o, a, l, h) => {
          if (i) return;
          let c = h.length - (o - r);
          if (n && o >= n.to)
            if (n.from == r && n.to == o && n.insert.eq(h)) {
              ((n = this.pendingContextChange = null),
                ...
                (this.to += c));
              return;
            } else ((n = null), this.revertPending(t.state));
    ...
    update(t) {
      ...
      (this.composing.drifted ||
        (!t.changes.touchesRange(i.from, i.to) &&
          t.transactions.some(
            (n) =>
              !n.isUserEvent("input.type") &&
              n.changes.touchesRange(this.from, this.to),
          )))
  ...
  A = class {
    ...
    constructor(t = {}) {
      ...
      ((this.dispatchTransactions =
        ...
        (i && ((n) => n.forEach((r) => i(r, this)))) ||
        ((n) => this.update(n))),
        (this.dispatch = this.dispatch.bind(this)),
        (this._root = t.root || sm(t.parent) || document),
        (this.viewState = new No(t.state || I.create(t))),
        t.scrollTo &&
          t.scrollTo.is(Bs) &&
          (this.viewState.scrollTarget = t.scrollTo.value.clip(
            this.viewState.state,
          )),
        (this.plugins = this.state.facet(qi).map((n) => new zs(n))));
      for (let n of this.plugins) n.update(this);
      ((this.observer = new Uc(this)),
        (this.inputState = new bc(this)),
        this.inputState.ensureHandlers(this.plugins),
        (this.docView = new Ro(this)),
        this.mountStyles(),
        this.updateAttrs(),
        (this.updateState = 0),
        this.requestMeasure(),
        ((e = document.fonts) === null || e === void 0 ? void 0 : e.ready) &&
          document.fonts.ready.then(() => this.requestMeasure()));
    }
    dispatch(...t) {
      let e =
        t.length == 1 && t[0] instanceof ct
          ? t
    ...
    update(t) {
      ...
      let o = this.hasFocus,
        a = 0,
        l = null;
      t.some((u) => u.annotation(Mc))
        ? ((this.inputState.notifiedFocused = o), (a = 1))
        : o != this.inputState.notifiedFocused &&
          ((this.inputState.notifiedFocused = o), (l = Xc(r, o)), l || (a = 1));
        ...
        (h
          ? (this.observer.clearDelayedAndroidKey(),
            ...
            ((c && !this.state.doc.eq(r.doc)) ||
              ...
              (c = null))
          : this.observer.clear(),
        r.facet(I.phrases) != this.state.facet(I.phrases))
      )
        return this.setState(r);
      ((n = Tn.create(this, r, t)), (n.flags |= a));
      ...
      try {
        ...
        for (let u of t) {
          if ((f && (f = f.map(u.changes)), u.scrollIntoView)) {
            ...
            f = new bi(
              d.empty ? d : k.cursor(d.head, d.head > d.anchor ? -1 : 1),
            );
          }
          for (let d of u.effects) d.is(Bs) && (f = d.value.clip(this.state));
        }
        (this.viewState.update(n, f),
          (this.bidiCache = Mn.update(this.bidiCache, n.changes)),
          n.empty || (this.updatePlugins(n), this.inputState.update(n)),
          (e = this.docView.update(n)),
          this.state.facet($n) != this.styleModules && this.mountStyles(),
          (i = this.updateAttrs()),
          this.showAnnouncements(t),
          this.docView.updateSelection(
            e,
            t.some((u) => u.isUserEvent("select.pointer")),
          ));
      } finally {
        this.updateState = 0;
      }
      if (
        (n.startState.facet(Hs) != n.state.facet(Hs) &&
        ...
        for (let u of this.state.facet(Eo))
          try {
            ...
            Gt(this.state, d, "update listener");
          }
      (l || c) &&
        Promise.resolve().then(() => {
          (l && this.state == l.startState && this.dispatch(l),
            c &&
              !mc(this, c) &&
              h.force &&
              Vi(this.contentDOM, h.key, h.keyCode));
        });
    }
    setState(t) {
      if (this.updateState != 0)
      ...
      try {
        ...
        ((this.viewState = new No(t)),
          (this.plugins = t.facet(qi).map((i) => new zs(i))),
    ...
    updatePlugins(t) {
      let e = t.startState.facet(qi),
        i = t.state.facet(qi);
      if (e != i) {
        let n = [];
        for (let r of i) {
          let o = e.indexOf(r);
          if (o < 0) n.push(new zs(r));
          else {
      ...
      for (let t of this.plugins) {
        ...
        if (e && e.docViewUpdate)
          try {
            ...
            Gt(this.state, i, "doc view update listener");
          }
      }
    }
    measure(t = !0) {
      ...
      (Math.abs(n - this.viewState.scrollTop) > 1 && (o = -1),
        (this.viewState.scrollAnchorHeight = -1));
      try {
        for (let a = 0; ; a++) {
          if (o < 0)
            if ($h(i)) ((r = -1), (o = this.viewState.heightMap.height));
            else {
          ...
          let c = h.map((d) => {
              try {
                ...
                return (Gt(this.state, p), Jc);
              }
            }),
            f = Tn.create(this, this.state, []),
            u = !1;
          ((f.flags |= l),
            e ? (e.flags |= l) : (e = f),
            (this.updateState = 2),
      ...
      if (e && !e.empty) for (let a of this.state.facet(Eo)) a(e);
    }
    get themeClasses() {
      return (
        Wo + " " + (this.state.facet(qo) ? _c : Wc) + " " + this.state.facet(Hs)
      );
    }
    updateAttrs() {
      let t = tf(this, Jh, {
        ...
        e = {
          ...
          translate: "no",
          contenteditable: this.state.facet(De) ? "true" : "false",
          class: "cm-content",
          style: `${T.tabSize}: ${this.state.tabSize}`,
          role: "textbox",
          "aria-multiline": "true",
        };
      (this.state.readOnly && (e["aria-readonly"] = "true"), tf(this, Xo, e));
      let i = this.observer.ignore(() => {
        let n = Po(this.contentDOM, this.contentAttrs, e),
          r = Po(this.dom, this.editorAttrs, t);
        return n || r;
      });
    ...
    mountStyles() {
      ...
      se.mount(
        this.root,
        this.styleModules.concat(cg).reverse(),
        t ? { nonce: t } : void 0,
      );
    }
    readMeasured() {
    ...
    plugin(t) {
      ...
      return (
        (e === void 0 || (e && e.plugin != t)) &&
          this.pluginMap.set(
            t,
            (e = this.plugins.find((i) => i.plugin == t) || null),
          ),
    ...
    moveByChar(t, e, i) {
      return Bo(this, t, uc(this, t, e, i));
    }
    moveByGroup(t, e) {
      return Bo(
        this,
        t,
        uc(this, t, e, (i) => Rm(this, t.head, i)),
      );
    }
    visualLineSide(t, e) {
      let i = this.bidiSpans(t),
        ...
        r = i[e ? i.length - 1 : 0];
      return k.cursor(r.side(e, n) + t.from, r.forward(!e, n) ? 1 : -1);
    }
    moveToLineBoundary(t, e, i = !0) {
      return Xm(this, t, e, i);
    }
    moveVertically(t, e, i) {
      return Bo(this, t, Lm(this, t, e, i));
    }
    domAtPos(t) {
    ...
    posAtCoords(t, e = !0) {
      return (this.readMeasured(), hc(this, t, e));
    }
    coordsAtPos(t, e = 1) {
      this.readMeasured();
      ...
      let n = this.state.doc.lineAt(t),
        r = this.bidiSpans(n),
        o = r[Ie.find(r, t - n.from, -1, e)];
      return Xs(i, (o.dir == it.LTR) == e > 0);
    }
    coordsForChar(t) {
    ...
    bidiSpans(t) {
      if (t.length > dg) return Vh(t.length);
      ...
      for (let r of this.bidiCache)
        if (
          r.from == t.from &&
          r.dir == e &&
          (r.fresh || zh(r.isolates, (i = ic(this, t))))
        )
          return r.order;
      i || (i = ic(this, t));
      let n = bm(t.text, e, i);
    ...
    get hasFocus() {
      ...
      return (
        (this.dom.ownerDocument.hasFocus() ||
          (T.safari &&
            ((t = this.inputState) === null || t === void 0
              ? void 0
              : t.lastContextMenu) >
              Date.now() - 3e4)) &&
    ...
    focus() {
      this.observer.ignore(() => {
        (kh(this.contentDOM), this.docView.updateSelection());
      });
    }
    setRoot(t) {
      this._root != t &&
        ...
        this.observer.setWindow(
          (t.nodeType == 9 ? t : t.ownerDocument).defaultView || window,
        ),
        this.mountStyles());
    }
    destroy() {
    ...
    scrollSnapshot() {
      ...
      return Bs.of(
        new bi(k.cursor(i.from), "start", "start", i.top - t, e, !0),
      );
    }
    setTabFocusMode(t) {
      t == null
    ...
    static theme(t, e) {
      let i = se.newName(),
        n = [Hs.of(i), $n.of(_o(`.${i}`, t))];
      return (e && e.dark && n.push(qo.of(!0)), n);
    }
    static baseTheme(t) {
      return be.lowest($n.of(_o("." + Wo, t, Gc)));
    }
    static findFromDOM(t) {
      ...
      let i = t.querySelector(".cm-content"),
        n = (i && G.get(i)) || G.get(t);
      return (
        ((e = n == null ? void 0 : n.rootView) === null || e === void 0
          ? void 0
          : e.view) || null
      );
    }
...
A.styleModule = $n;
A.inputHandler = _h;
A.clipboardInputFilter = Zo;
A.clipboardOutputFilter = Mo;
A.scrollHandler = Hh;
A.focusChangeEffect = Gh;
A.perLineTextDirection = Uh;
A.exceptionSink = Wh;
A.updateListener = Eo;
A.editable = De;
A.mouseSelectionStyle = qh;
A.dragMovesSelection = Nh;
A.clickAddsSelectionRange = Yh;
A.decorations = Qn;
A.outerDecorations = tc;
A.atomicRanges = Pn;
A.bidiIsolatedRanges = ec;
A.scrollMargins = nc;
A.darkTheme = qo;
A.cspNonce = M.define({ combine: (s) => (s.length ? s[0] : "") });
A.contentAttributes = Xo;
A.editorAttributes = Jh;
A.lineWrapping = A.contentAttributes.of({ class: "cm-lineWrapping" });
A.announce = tt.define();
var dg = 4096,
  Jc = {},
  Mn = class {
    constructor(t, e, i, n, r, o) {
    ...
    static update(t, e) {
      ...
      let i = [],
        n = t.length ? t[t.length - 1].dir : it.LTR;
...
var pg = T.mac ? "mac" : T.windows ? "win" : T.linux ? "linux" : "key";
function Og(s, t) {
  let e = s.split(/-(?!$)/),
    i = e[e.length - 1];
  i == "Space" && (i = " ");
  ...
  for (let l = 0; l < e.length - 1; ++l) {
    ...
    else if (/^mod$/i.test(h)) t == "mac" ? (a = !0) : (r = !0);
...
var mg = be.default(
    A.domEventHandlers({
      keydown(s, t) {
        return yg(gg(t.state), s, t, "editor");
      },
    }),
  ),
  Be = M.define({ enables: mg }),
  ef = new WeakMap();
function gg(s) {
  let t = s.facet(Be),
    e = ef.get(t);
  return (e || ef.set(t, (e = Sg(t.reduce((i, n) => i.concat(n), [])))), e);
}
var ti = null,
  bg = 4e3;
function Sg(s, t = pg) {
        ...
        (n(S, !0),
          d[S] ||
            (d[S] = {
              ...
              run: [
                (y) => {
                  let C = (ti = { view: y, prefix: S, scope: o });
                  return (
                    setTimeout(() => {
                      ti == C && (ti = null);
                    }, bg),
  ...
  for (let o of s) {
    ...
    if (o.any)
      for (let h of a) {
        let c = e[h] || (e[h] = Object.create(null));
        c._any ||
          (c._any = { preventDefault: !1, stopPropagation: !1, run: [] });
        let { any: f } = o;
        for (let u in c) c[u].run.push((d) => f(d, Uo));
      }
    let l = o[t] || o.key;
    if (!!l)
      for (let h of a)
        (r(h, l, o.run, o.preventDefault, o.stopPropagation),
          o.shift &&
            r(h, "Shift-" + l, o.shift, o.preventDefault, o.stopPropagation));
  }
  return e;
}
var Uo = null;
function yg(s, t, e, i) {
  ...
  ti &&
    ...
    ti.scope == i &&
    ((a = ti.prefix + " "),
    wc.indexOf(t.keyCode) < 0 && ((h = !0), (ti = null)));
  let f = new Set(),
    u = (g) => {
      if (g) {
        for (let b of g.run)
    ...
    d &&
      (u(d[a + Ks(n, t, !o)])
        ...
        : o &&
            ...
            !(T.windows && t.ctrlKey && t.altKey) &&
            !(T.mac && t.altKey && !(t.ctrlKey || t.metaKey)) &&
            (p = Xe[t.keyCode]) &&
            p != n
          ? (u(d[a + Ks(p, t, !0)]) ||
              (t.shiftKey &&
                ...
                u(d[a + Ks(O, t, !1)]))) &&
            (l = !0)
          : o && t.shiftKey && u(d[a + Ks(n, t, !0)]) && (l = !0),
      !l && u(d._any) && (l = !0)),
    h && (l = !0),
...
var _i = class {
  ...
  adjust(t) {
    ((t.style.left = this.left + "px"),
      ...
      this.width != null && (t.style.width = this.width + "px"),
  ...
  static forRange(t, e, i) {
    if (i.empty) {
      ...
      let r = nf(t);
      return [
        new _i(e, n.left - r.left, n.top - r.top, null, n.bottom - n.top),
      ];
    } else return wg(t, e, i);
  }
};
function nf(s) {
  ...
  return {
    left:
      (s.textDirection == it.LTR
        ? t.left
        : t.right - s.scrollDOM.clientWidth * s.scaleX) -
      s.scrollDOM.scrollLeft * s.scaleX,
    top: t.top - s.scrollDOM.scrollTop * s.scaleY,
  };
}
function sf(s, t, e, i) {
  let n = s.coordsAtPos(t, e * 2);
  if (!n) return i;
  let r = s.dom.getBoundingClientRect(),
    o = (n.top + n.bottom) / 2,
    a = s.posAtCoords({ x: r.left + 1, y: o }),
    l = s.posAtCoords({ x: r.right - 1, y: o });
  return a == null || l == null
    ? i
    : {
        from: Math.max(i.from, Math.min(a, l)),
        to: Math.min(i.to, Math.max(a, l)),
      };
}
function wg(s, t, e) {
  if (e.to <= s.viewport.from || e.from >= s.viewport.to) return [];
  let i = Math.max(e.from, s.viewport.from),
    n = Math.min(e.to, s.viewport.to),
    r = s.textDirection == it.LTR,
    o = s.contentDOM,
    ...
    u = a.right - (c ? parseInt(c.paddingRight) : 0),
    d = Do(s, i, 1),
    p = Do(s, n, -1),
    O = d.type == Bt.Text ? d : null,
    g = p.type == Bt.Text ? p : null;
  if (
    (O && (s.lineWrapping || d.widgetLineBreaks) && (O = sf(s, i, 1, O)),
    g && (s.lineWrapping || p.widgetLineBreaks) && (g = sf(s, n, -1, g)),
    O && g && O.from == g.from && O.to == g.to)
  )
    return S(y(e.from, e.to, O));
  {
    let w = O ? y(e.from, null, O) : C(d, !1),
      Q = g ? y(null, e.to, g) : C(p, !0),
      P = [];
    return (
      (O || d).to < (g || p).from - (O && g ? 1 : 0) ||
      (d.widgetLineBreaks > 1 && w.bottom + s.defaultLineHeight / 2 < Q.top)
        ? P.push(b(f, w.bottom, u, Q.top))
        : w.bottom < Q.top &&
          s.elementAtHeight((w.bottom + Q.top) / 2).type == Bt.Text &&
          (w.bottom = Q.top = (w.bottom + Q.top) / 2),
      S(w).concat(P).concat(S(Q))
    );
  }
  function b(w, Q, P, Y) {
    return new _i(t, w - l.left, Q - l.top, P - w, Y - Q);
  }
  function S({ top: w, bottom: Q, horizontal: P }) {
    let Y = [];
    for (let D = 0; D < P.length; D += 2) Y.push(b(P[D], w, P[D + 1], Q));
    return Y;
  }
  function y(w, Q, P) {
    let Y = 1e9,
      D = -1e9,
      H = [];
    function L(N, J, $t, It, Oe) {
      let mt = s.coordsAtPos(N, N == P.to ? -2 : 2),
        Nt = s.coordsAtPos($t, $t == P.from ? 2 : -2);
      !mt ||
        !Nt ||
        ((Y = Math.min(mt.top, Nt.top, Y)),
        (D = Math.max(mt.bottom, Nt.bottom, D)),
        Oe == it.LTR
          ? H.push(r && J ? f : mt.left, r && It ? u : Nt.right)
          : H.push(!r && It ? f : Nt.left, !r && J ? u : mt.right));
    }
    let R = w ?? P.from,
      W = Q ?? P.to;
    for (let N of s.visibleRanges)
      if (N.to > R && N.from < W)
        for (let J = Math.max(N.from, R), $t = Math.min(N.to, W); ;) {
          let It = s.state.doc.lineAt(J);
          for (let Oe of s.bidiSpans(It)) {
            let mt = Oe.from + It.from,
              Nt = Oe.to + It.from;
            if (mt >= $t) break;
            Nt > J &&
              L(
          ...
          if (((J = It.to + 1), J >= $t)) break;
        }
    return (
      H.length == 0 && L(R, w == null, W, Q == null, s.textDirection),
      { top: Y, bottom: D, horizontal: H }
    );
  }
  function C(w, Q) {
    let P = a.top + (Q ? w.top : w.bottom);
...
var rf = class {
    ...
    update(t) {
      (t.startState.facet(Js) != t.state.facet(Js) && this.setOrder(t.state),
  ...
  Js = M.define();
function of(s) {
  return [Zt.define((t) => new rf(t, s)), Js.of(s)];
}
var Xn = M.define({
  combine(s) {
    return wn(
...
function af(s = {}) {
  return [Xn.of(s), xg, kg, Qg, Fh.of(!0)];
}
function lf(s) {
  return s.startState.facet(Xn) != s.state.facet(Xn);
}
var xg = of({
  above: !0,
  markers(s) {
    ...
    for (let n of t.selection.ranges) {
      ...
      if (n.empty || e.drawRangeCursor) {
        let o = r
            ? "cm-cursor cm-cursor-primary"
            : "cm-cursor cm-cursor-secondary",
          a = n.empty ? n : k.cursor(n.head, n.head > n.anchor ? -1 : 1);
        for (let l of _i.forRange(s, o, a)) i.push(l);
      }
    }
    return i;
  },
  update(s, t) {
    s.transactions.some((i) => i.selection) &&
      (t.style.animationName =
        t.style.animationName == "cm-blink" ? "cm-blink2" : "cm-blink");
    let e = lf(s);
    return (e && hf(s.state, t), s.docChanged || s.selectionSet || e);
  },
  mount(s, t) {
    hf(t.state, s);
  },
...
function hf(s, t) {
  t.style.animationDuration = s.facet(Xn).cursorBlinkRate + "ms";
}
var kg = of({
    above: !1,
    markers(s) {
      return s.state.selection.ranges
        .map((t) =>
          t.empty ? [] : _i.forRange(s, "cm-selectionBackground", t),
        )
        .reduce((t, e) => t.concat(e));
    },
    update(s, t) {
      return s.docChanged || s.selectionSet || s.viewportChanged || lf(s);
    },
...
function cf(s, t, e, i, n) {
  t.lastIndex = 0;
  for (let r = s.iterRange(e, i), o = e, a; !r.next().done; o += r.value.length)
    if (!r.lineBreak) for (; (a = t.exec(r.value));) n(o + a.index, a);
}
function Pg(s, t) {
  ...
  for (let { from: n, to: r } of e)
    ((n = Math.max(s.state.doc.lineAt(n).from, n - t)),
      (r = Math.min(s.state.doc.lineAt(r).to, r + t)),
      i.length && i[i.length - 1].to >= n
        ? (i[i.length - 1].to = r)
        : i.push({ from: n, to: r }));
  return i;
}
var ff = class {
    constructor(t) {
      ...
      if (((this.regexp = e), n))
        this.addMatch = (a, l, h, c) => n(c, h, h + a[0].length, a, l);
      else if (typeof i == "function")
        this.addMatch = (a, l, h, c) => {
          let f = i(a, l, h);
          f && c(h, h + a[0].length, f);
        };
      else if (i) this.addMatch = (a, l, h, c) => c(h, h + a[0].length, i);
      else
        throw new RangeError(
    ...
    createDeco(t) {
      let e = new Me(),
        i = e.add.bind(e);
      for (let { from: n, to: r } of Pg(t, this.maxLength))
        cf(t.state.doc, this.regexp, n, r, (o, a) => this.addMatch(a, t, o, i));
      return e.finish();
    }
    updateDeco(t, e) {
      let i = 1e9,
      ...
      return (
        t.docChanged &&
          t.changes.iterChanges((r, o, a, l) => {
            l >= t.view.viewport.from &&
              a <= t.view.viewport.to &&
              ((i = Math.min(a, i)), (n = Math.max(l, n)));
          }),
        t.viewportMoved || n - i > 1e3
    ...
    updateRange(t, e, i, n) {
      for (let r of t.visibleRanges) {
        let o = Math.max(r.from, i),
          a = Math.min(r.to, n);
        if (a >= o) {
          let l = t.state.doc.lineAt(o),
            h = l.to < a ? t.state.doc.lineAt(a) : l,
            c = Math.max(r.from, l.from),
          ...
          let u = [],
            d,
            p = (O, g, b) => u.push(b.range(O, g));
          if (l == h)
            for (
              this.regexp.lastIndex = c - l.from;
              (d = this.regexp.exec(l.text)) && d.index < f - l.from;
            )
              this.addMatch(d, t, d.index + l.from, p);
          else
            cf(t.state.doc, this.regexp, c, f, (O, g) =>
              this.addMatch(g, t, O, p),
            );
          e = e.update({
            filterFrom: c,
            filterTo: f,
...
function Cg() {
  var s;
  if (Ho == null && typeof document != "undefined" && document.body) {
    let t = document.body.style;
    Ho = ((s = t.tabSize) !== null && s !== void 0 ? s : t.MozTabSize) != null;
  }
  return Ho || !1;
}
var tr = M.define({
  combine(s) {
    let t = wn(s, { render: null, specialChars: $g, addSpecialChars: null });
    return (
      (t.replaceTabs = !Cg()) &&
        (t.specialChars = new RegExp("	|" + t.specialChars.source, Fo)),
      t.addSpecialChars &&
      ...
      class {
        constructor(s) {
          ((this.view = s),
            ...
            (this.decorator = this.makeDecorator(s.state.facet(tr))),
            (this.decorations = this.decorator.createDeco(s)));
        }
        makeDecorator(s) {
          return new ff({
            ...
            decoration: (t, e, i) => {
              ...
              return (
                ...
                (this.decorationCache[r] = q.replace({ widget: new pf(s, r) }))
              );
            },
        ...
        update(s) {
          ...
          s.startState.facet(tr) != t
            ? ((this.decorator = this.makeDecorator(t)),
              (this.decorations = this.decorator.createDeco(s.view)))
...
var Eg = "\u2022";
function Zg(s) {
  return s >= 32 ? Eg : s == 10 ? "\u2424" : String.fromCharCode(9216 + s);
}
    ...
    toDOM(t) {
      let e = Zg(this.code),
        i =
          ...
          " " +
          (Tg[this.code] || "0x" + this.code.toString(16)),
...
var Ko = 1024,
  ...
  X = class {
    ...
    add(t) {
      ...
      return (
        typeof t != "function" && (t = nt.match(t)),
        (e) => {
          let i = t(e);
...
X.closedBy = new X({ deserialize: (s) => s.split(" ") });
X.openedBy = new X({ deserialize: (s) => s.split(" ") });
X.group = new X({ deserialize: (s) => s.split(" ") });
X.isolate = new X({
  deserialize: (s) => {
...
var Si = class {
  ...
  nt = class {
    ...
    static define(t) {
      let e = t.props && t.props.length ? Object.create(null) : Xg,
        i =
          (t.top ? 1 : 0) |
          (t.skipped ? 2 : 0) |
          (t.error ? 4 : 0) |
          (t.name == null ? 8 : 0),
        n = new nt(t.name || "", e, t.id, i);
      if (t.props) {
    ...
    static match(t) {
      ...
      return (i) => {
        for (let n = i.prop(X.group), r = -1; r < (n ? n.length : 0); r++) {
...
nt.none = new nt("", Object.create(null), 0, 8);
var ze = class {
    constructor(t) {
      this.types = t;
      ...
      for (let i of this.types) {
        ...
        for (let r of t) {
          ...
          if (o) {
            ...
            let a = o[1],
              l = o[0];
            (l.combine && l.id in n && (a = l.combine(n[l.id], a)),
              (n[l.id] = a));
          }
        }
        e.push(n ? new nt(i.name, n, i.id, i.flags) : i);
      }
      return new ze(e);
    }
  },
  ...
  V;
(function (s) {
  ((s[(s.ExcludeBuffers = 1)] = "ExcludeBuffers"),
    (s[(s.IncludeAnonymous = 2)] = "IncludeAnonymous"),
    (s[(s.IgnoreMounts = 4)] = "IgnoreMounts"),
    (s[(s.IgnoreOverlays = 8)] = "IgnoreOverlays"),
    (s[(s.EnterBracketed = 16)] = "EnterBracketed"));
})(V || (V = {}));
var z = class {
  constructor(t, e, i, n, r) {
    if (
      ...
      for (let [o, a] of r) this.props[typeof o == "number" ? o : o.id] = a;
    }
  }
  toString() {
    let t = Si.get(this);
  ...
  cursor(t = 0) {
    return new Ln(this.topNode, t);
  }
  cursorAt(t, e = 0, i = 0) {
    let n = er.get(this) || this.topNode,
      r = new Ln(n);
    return (r.moveTo(t, e), er.set(this, r._tree), r);
  }
  get topNode() {
    return new St(this, 0, 0, null);
  }
  resolve(t, e = 0) {
    let i = Rn(er.get(this) || this.topNode, t, e, !1);
    return (er.set(this, i), i);
  }
  resolveInner(t, e = 0) {
    let i = Rn(mf.get(this) || this.topNode, t, e, !0);
  ...
  iterate(t) {
    let { enter: e, leave: i, from: n = 0, to: r = this.length } = t,
      o = t.mode || 0,
      a = (o & V.IncludeAnonymous) > 0;
    for (let l = this.cursor(o | V.IncludeAnonymous); ;) {
      let h = !1;
      if (
        l.from <= r &&
        l.to >= n &&
        ((!a && l.type.isAnonymous) || e(l) !== !1)
      ) {
  ...
  balance(t = {}) {
    return this.children.length <= 8
      ...
      : ia(
          ...
          0,
          this.length,
          (e, i, n) => new z(this.type, e, i, n, this.propValues),
          t.makeTree || ((e, i, n) => new z(nt.none, e, i, n)),
        );
  }
  static build(t) {
    return Lg(t);
...
var ir = class {
  ...
  Ve = class {
    ...
    findChild(t, e, i, n, r) {
      ...
      for (
        let l = t;
        l != e && !(gf(r, n, o[l + 1], o[l + 2]) && ((a = l), i > 0));
        l = o[l + 3]
      );
      return a;
    }
    slice(t, e, i) {
      ...
      for (let a = t, l = 0; a < e;) {
        ((r[l++] = n[a++]), (r[l++] = n[a++] - i));
        let h = (r[l++] = n[a++] - i);
        ((r[l++] = n[a++] - t), (o = Math.max(o, h)));
      }
      return new Ve(r, o, this.set);
    }
  };
function gf(s, t, e, i) {
  switch (s) {
...
function Rn(s, t, e, i) {
  ...
  if (i)
    for (let o = s, a = o.parent; a; o = a, a = o.parent)
      o instanceof St &&
        o.index < 0 &&
        ((n = a.enter(t, e, r)) === null || n === void 0 ? void 0 : n.from) !=
          o.from &&
        (s = a);
  for (;;) {
    let o = s.enter(t, e, r);
...
var Jo = class {
    ...
    resolveInner(t, e = 0) {
      return Rn(this, t, e, !0);
    }
    matchContext(t) {
      return ta(this.parent, t);
    }
    enterUnfinishedNodesBefore(t) {
      ...
      for (; e;) {
        let n = e.lastChild;
        if (!n || n.to != e.to) break;
        n.type.isError && n.from == n.to
          ? ((i = e), (e = n.prevSibling))
          : (e = n);
      }
      return i;
  ...
  St = class extends Jo {
    ...
    nextChild(t, e, i, n, r = 0) {
      for (let o = this; ;) {
        for (
          let { children: a, positions: l } = o._tree,
            h = e > 0 ? a.length : -1;
          t != h;
          t += e
        ) {
          ...
          if (!(
            ...
            if (c instanceof Ve) {
              if (r & V.ExcludeBuffers) continue;
              let d = c.findChild(0, c.buffer.length, e, i - f, n);
              if (d > -1) return new ae(new Sf(o, c, t, f), null, d);
            } else if (r & V.IncludeAnonymous || !c.type.isAnonymous || ea(c)) {
              let d;
              if (!(r & V.IgnoreMounts) && (d = Si.get(c)) && !d.overlay)
                return new St(d.tree, f, t, o);
              let p = new St(c, f, t, o);
              return r & V.IncludeAnonymous || !p.type.isAnonymous
                ? p
                : p.nextChild(e < 0 ? c.children.length - 1 : 0, e, i, n, r);
            }
          }
        }
        if (
          r & V.IncludeAnonymous ||
          !o.type.isAnonymous ||
          (o.index >= 0
            ? (t = o.index + e)
            : (t = e < 0 ? -1 : o._parent._tree.children.length),
          (o = o._parent),
          !o)
        )
          return null;
    ...
    enter(t, e, i = 0) {
      let n;
      if (!(i & V.IgnoreOverlays) && (n = Si.get(this._tree)) && n.overlay) {
        let r = t - this.from,
          o = i & V.EnterBracketed && n.bracketed;
        for (let { from: a, to: l } of n.overlay)
          if ((e > 0 || o ? a <= r : a < r) && (e < 0 || o ? l >= r : l > r))
...
function bf(s, t, e, i) {
  ...
  if (e != null) {
    for (let o = !1; !o;) if (((o = n.type.is(e)), !n.nextSibling())) return r;
  }
  for (;;) {
    if (i != null && n.type.is(i)) return r;
    if ((n.type.is(t) && r.push(n.node), !n.nextSibling()))
      return i == null ? r : [];
  }
}
function ta(s, t, e = t.length - 1) {
  for (let i = s; e >= 0; i = i.parent) {
    if (!i) return !1;
    if (!i.type.isAnonymous) {
      if (t[e] && t[e] != i.name) return !1;
      e--;
    }
  }
  return !0;
...
var Sf = class {
  ...
  ae = class extends Jo {
    ...
    child(t, e, i) {
      ...
      return r < 0 ? null : new ae(this.context, this, r);
    }
    get firstChild() {
    ...
    enter(t, e, i = 0) {
      if (i & V.ExcludeBuffers) return null;
      let { buffer: n } = this.context,
        r = n.findChild(
          this.index + 4,
          n.buffer[this.index + 3],
    ...
    get nextSibling() {
      ...
      return e <
        ...
        ? new ae(this.context, this._parent, e)
...
function yf(s) {
  ...
  let i = e instanceof St && e.index < 0 ? null : e.parent,
    n = s.slice();
  return (i ? (n[t] = i) : n.splice(t, 1), new wf(n, e));
}
var wf = class {
  constructor(t, e) {
  ...
  get next() {
    return yf(this.heads);
  }
};
function Rg(s, t, e) {
  let i = s.resolveInner(t, e),
    n = null;
  for (let r = i instanceof St ? i : i.context.parent; r; r = r.parent)
    if (r.index < 0) {
      ...
      if (
        ...
        o.overlay &&
        o.overlay[0].from <= t &&
        o.overlay[o.overlay.length - 1].to >= t
      ) {
        let a = new St(o.tree, o.overlay[0].from + r.from, -1, r);
        (n || (n = [i])).push(Rn(a, t, e, !1));
      }
    }
  return n ? yf(n) : i;
}
var Ln = class {
  ...
  constructor(t, e = 0) {
    if (
      ...
      (this.mode = e & ~V.EnterBracketed),
      t instanceof St)
    )
      this.yieldNode(t);
    else {
      ((this._tree = t.context.parent), (this.buffer = t.context));
      for (let i = t._parent; i; i = i._parent) this.stack.unshift(i.index);
  ...
  parent() {
    if (!this.buffer)
      return this.yieldNode(
        this.mode & V.IncludeAnonymous ? this._tree._parent : this._tree.parent,
      );
    if (this.stack.length) return this.yieldBuf(this.stack.pop());
    let t =
      this.mode & V.IncludeAnonymous
        ? this.buffer.parent
    ...
    if (n) {
      if (t > 0) {
        ...
        for (let r = 0; r < this.index; r++)
          if (n.buffer.buffer[r + 3] < this.index) return !1;
      ({ index: e, parent: i } = n);
    } else ({ index: e, _parent: i } = this._tree);
    for (; i; { index: e, _parent: i } = i)
      if (e > -1)
        for (
          let r = e + t, o = t < 0 ? -1 : i._tree.children.length;
          r != o;
          r += t
        ) {
  ...
  get node() {
    ...
    for (let n = i; n < this.stack.length; n++)
      e = new ae(this.buffer, e, this.stack[n]);
    return (this.bufferNode = new ae(this.buffer, e, this.index));
  }
  get tree() {
  ...
  matchContext(t) {
    if (!this.buffer) return ta(this.node.parent, t);
    let { buffer: e } = this.buffer,
      { types: i } = e.set;
    for (let n = t.length - 1, r = this.stack.length - 1; n >= 0; r--) {
      if (r < 0) return ta(this._tree, t, n);
...
function ea(s) {
  return s.children.some(
    (t) => t instanceof Ve || !t.type.isAnonymous || ea(t),
  );
}
function Lg(s) {
  var t;
  let {
      buffer: e,
      nodeSet: i,
      maxBufferLength: n = Ko,
      reused: r = [],
      minRepeatType: o = i.types.length,
    } = s,
    a = Array.isArray(e) ? new ir(e, e.length) : e,
    l = i.types,
    h = 0,
    c = 0;
  function f(w, Q, P, Y, D, H) {
    let { id: L, start: R, end: W, size: N } = a,
      J = c,
      $t = h;
    if (N < 0)
      if ((a.next(), N == -1)) {
        let Ze = r[L];
        (P.push(Ze), Y.push(R - w));
        return;
      } else if (N == -3) {
        h = L;
        return;
        ...
        c = L;
        return;
      } else throw new RangeError(`Unrecognized record size: ${N}`);
    let It = l[L],
      Oe,
      mt,
      Nt = R - w;
    if (W - R <= n && (mt = g(a.pos - Q, D))) {
      let Ze = new Uint16Array(mt.size - mt.skip),
        qt = a.pos - mt.size,
        me = Ze.length;
      for (; a.pos > qt;) me = b(mt.start, Ze, me);
      ((Oe = new Ve(Ze, W - mt.start, i)), (Nt = mt.start - w));
    } else {
      let Ze = a.pos - N;
      a.next();
      let qt = [],
        ...
        ms = W;
      for (; a.pos > Ze;)
        ci >= 0 && a.id == ci && a.size >= 0
          ? (a.end <= ms - n &&
              (p(qt, me, R, Ei, a.end, ms, ci, J, $t),
              (Ei = qt.length),
              (ms = a.end)),
            a.next())
          : H > 2500
      ...
      if (
        (ci >= 0 &&
          Ei > 0 &&
          Ei < qt.length &&
          p(qt, me, R, Ei, R, ms, ci, J, $t),
        qt.reverse(),
        me.reverse(),
        ci > -1 && Ei > 0)
      ) {
        let Rl = d(It, $t);
        Oe = ia(It, qt, me, 0, qt.length, 0, W - R, Rl, Rl);
      } else Oe = O(It, qt, me, W - R, J - W, $t);
    }
    (P.push(Oe), Y.push(Nt));
  }
  function u(w, Q, P, Y) {
    let D = [],
      ...
      L = -1;
    for (; a.pos > Q;) {
      let { id: R, start: W, end: N, size: J } = a;
      if (J > 4) a.next();
      else {
        if (L > -1 && W < L) break;
        (L < 0 && (L = N - n), D.push(R, W, N), H++, a.next());
      }
    }
    if (H) {
      let R = new Uint16Array(H * 4),
        W = D[D.length - 2];
      for (let N = D.length - 3, J = 0; N >= 0; N -= 3)
        ((R[J++] = D[N]),
          (R[J++] = D[N + 1] - W),
          (R[J++] = D[N + 2] - W),
          (R[J++] = J));
      (P.push(new Ve(R, D[2] - W, i)), Y.push(W - w));
    }
  }
  function d(w, Q) {
    return (P, Y, D) => {
      let H = 0,
        ...
        R,
        W;
      if (L >= 0 && (R = P[L]) instanceof z) {
        if (!L && R.type == w && R.length == D) return R;
        (W = R.prop(X.lookAhead)) && (H = Y[L] + R.length + W);
      }
      return O(w, P, Y, D, H, Q);
    };
  }
  function p(w, Q, P, Y, D, H, L, R, W) {
    let N = [],
      J = [];
    for (; w.length > Y;) (N.push(w.pop()), J.push(Q.pop() + P - D));
    (w.push(O(i.types[L], N, J, H - D, R - H, W)), Q.push(D - P));
  }
  function O(w, Q, P, Y, D, H, L) {
    if (H) {
      let R = [X.contextHash, H];
      L = L ? [R].concat(L) : [R];
    }
    if (D > 25) {
      let R = [X.lookAhead, D];
  ...
  function g(w, Q) {
    ...
    t: for (let W = P.pos - w; P.pos > W;) {
      ...
      let J = P.pos - N;
      if (N < 0 || J < W || P.start < L) break;
      let $t = P.id >= o ? 4 : 0,
        It = P.start;
      for (P.next(); P.pos > J;) {
        if (P.size < 0)
          if (P.size == -3 || P.size == -4) $t += 4;
          else break t;
        else P.id >= o && ($t += 4);
        P.next();
      }
    ...
    return (
      (Q < 0 || Y == w) && ((R.size = Y), (R.start = D), (R.skip = H)),
      R.size > 4 ? R : void 0
    );
  }
  function b(w, Q, P) {
    let { id: Y, start: D, end: H, size: L } = a;
    if ((a.next(), L >= 0 && Y < o)) {
      let R = P;
      if (L > 4) {
        let W = a.pos - (L - 4);
        for (; a.pos > W;) P = b(w, Q, P);
      }
      ((Q[--P] = R), (Q[--P] = H - w), (Q[--P] = D - w), (Q[--P] = Y));
    } else L == -3 ? (h = Y) : L == -4 && (c = Y);
    return P;
  }
  let S = [],
    y = [];
  for (; a.pos > 0;) f(s.start || 0, s.bufferStart || 0, S, y, -1, 0);
  let C =
    (t = s.length) !== null && t !== void 0
      ? t
      : S.length
        ? y[0] + S[0].length
        : 0;
  return new z(l[s.topID], S.reverse(), y.reverse(), C);
}
var vf = new WeakMap();
function nr(s, t) {
  if (!s.isAnonymous || t instanceof Ve || t.type != s) return 1;
  let e = vf.get(t);
  if (e == null) {
    e = 1;
...
function ia(s, t, e, i, n, r, o, a, l) {
  let h = 0;
  for (let p = i; p < n; p++) h += nr(s, t[p]);
  let c = Math.ceil((h * 1.5) / 8),
    f = [],
    u = [];
  function d(p, O, g, b, S) {
    for (let y = g; y < b;) {
      let C = y,
        w = O[y],
        Q = nr(s, p[y]);
      ...
      if (y == C + 1) {
        if (Q > c) {
          let P = p[C];
          d(P.children, P.positions, 0, P.children.length, O[C] + S);
          continue;
        }
        f.push(p[C]);
      } else {
        let P = O[y - 1] + p[y - 1].length - w;
        f.push(ia(s, p, O, C, y, w, P, null, l));
      }
      u.push(w + S - r);
    }
  }
  return (d(t, e, i, n, 0), (a || l)(f, u, o));
}
var In = class {
    constructor() {
    ...
    set(t, e) {
      t instanceof ae
        ...
        : t instanceof St && this.map.set(t.tree, e);
    }
    get(t) {
  ...
  le = class {
    ...
    static addTree(t, e = [], i = !1) {
      let n = [new le(0, t.length, t, 0, !1, i)];
      for (let r of e) r.to > t.length && n.push(r);
      return n;
    }
    static applyChanges(t, e, i = 128) {
      ...
      for (let a = 0, l = 0, h = 0; ; a++) {
        let c = a < e.length ? e[a] : null,
          f = c ? c.fromA : 1e9;
        if (f - l >= i)
          for (; o && o.from < f;) {
            let u = o;
            if (l >= u.from || f <= u.to || h) {
              let d = Math.max(u.from, l) - h,
                p = Math.min(u.to, f) - h;
              u =
                d >= p ? null : new le(d, p, u.tree, u.offset + h, a > 0, !!c);
            }
            if ((u && n.push(u), o.to > f)) break;
  ...
  yi = class {
    startParse(t, e, i) {
      return (
        typeof t == "string" && (t = new xf(t)),
        (i = i
          ? i.length
            ? i.map((n) => new Vt(n.from, n.to))
            : [new Vt(0, 0)]
          : [new Vt(0, t.length)]),
...
function sr(s) {
  return (t, e, i, n) => new Pf(t, s, e, i, n);
}
var na = class {
  constructor(t, e, i, n, r, o) {
    ((this.parser = t),
...
function kf(s) {
  if (!s.length || s.some((t) => t.from >= t.to))
    throw new RangeError(
      "Invalid inner parse ranges given: " + JSON.stringify(s),
    );
}
var Qf = class {
    constructor(t, e, i, n, r, o, a, l) {
      ((this.parser = t),
        (this.predicate = e),
        (this.mounts = i),
        (this.index = n),
  ...
  Pf = class {
    ...
    advance() {
        ...
        return (
          this.stoppedAt != null &&
            (i = new z(
              ...
              i.positions,
              i.length,
              i.propValues.concat([[sa, this.stoppedAt]]),
            )),
          i
        );
      }
      ...
      if (e) {
        ...
        ((i[X.mounted.id] = new Si(e, t.overlay, t.parser, t.bracketed)),
          (t.target.props = i));
      }
      return null;
    }
    ...
    startInner() {
      let t = new Tf(this.fragments),
        e = null,
        i = null,
        n = new Ln(
          new St(this.baseTree, this.ranges[0].from, 0, null),
          V.IncludeAnonymous | V.IgnoreMounts,
        );
      t: for (let r, o; ;) {
        let a = !0,
          l;
        if (this.stoppedAt != null && n.from >= this.stoppedAt) a = !1;
        else if (t.hasNode(n)) {
          if (e) {
            let h = e.mounts.find(
              (c) =>
                c.frag.from <= n.from && c.frag.to >= n.to && c.mount.overlay,
            );
            if (h)
              for (let c of h.mount.overlay) {
                ...
                f >= n.from &&
                  u <= n.to &&
                  !e.ranges.some((d) => d.from < u && d.to > f) &&
                  e.ranges.push({ from: f, to: u });
              }
          }
          a = !1;
        } else if (i && (o = Ig(i.ranges, n.from, n.to))) a = o != 2;
        else if (
          !n.type.isAnonymous &&
          (r = this.nest(n, this.input)) &&
          (n.from < n.to || !r.overlay)
        ) {
          n.tree || (Dg(n), e && e.depth++, i && i.depth++);
          ...
          if (typeof r.overlay == "function")
            ...
            let c = Cf(
              this.ranges,
              r.overlay || (n.from < n.to ? [new Vt(n.from, n.to)] : []),
            );
            (c.length && kf(c),
              (c.length || !r.overlay) &&
                this.inner.push(
                  new na(
                    r.parser,
                    c.length
                      ? r.parser.startParse(this.input, Af(h, c), c)
                      : r.parser.startParse(""),
                    r.overlay
                      ? r.overlay.map(
                          (f) => new Vt(f.from - n.from, f.to - n.from),
                        )
                      : null,
                    !!r.bracketed,
                    n.tree,
                    c.length ? c[0].from : n.from,
                  ),
                ),
              r.overlay
          ...
          e &&
          (l = e.predicate(n)) &&
          (l === !0 && (l = new Vt(n.from, n.to)), l.from < l.to)
        ) {
          let h = e.ranges.length - 1;
          h >= 0 && e.ranges[h].to == l.from
            ? (e.ranges[h] = { from: e.ranges[h].from, to: l.to })
            : e.ranges.push(l);
        }
            ...
            if (e && !--e.depth) {
              ...
              (h.length &&
                ...
                this.inner.splice(
                  ...
                  new na(
                    e.parser,
                    e.parser.startParse(this.input, Af(e.mounts, h), h),
                    e.ranges.map(
                      (c) => new Vt(c.from - e.start, c.to - e.start),
                    ),
                    e.bracketed,
                    e.target,
                    h[0].from,
...
function Ig(s, t, e) {
  for (let i of s) {
    if (i.from >= e) break;
    if (i.to > t) return i.from <= t && i.to >= e ? 2 : 1;
  }
  return 0;
}
function $f(s, t, e, i, n, r) {
  if (t < e) {
    let o = s.buffer[t + 1];
...
function Dg(s) {
  let { node: t } = s,
    e = [],
    i = t.context.buffer;
  do (e.push(s.index), s.parent());
  while (!s.tree);
  let n = s.tree,
    r = n.children.indexOf(i),
    o = n.children[r],
    a = o.buffer,
    l = [r];
  function h(c, f, u, d, p, O) {
    let g = e[O],
      b = [],
      S = [];
    $f(o, c, g, b, S, d);
    ...
    l.push(b.length);
    let w = O
      ? h(g + 4, a[g + 3], o.set.types[a[g]], y, C - y, O - 1)
      : t.toTree();
    return (
      b.push(w),
      S.push(y - d),
  ...
  n.children[r] = h(0, a.length, nt.none, 0, o.length, e.length - 1);
  for (let c of l) {
    let f = s.tree.children[c],
      u = s.tree.positions[c];
    s.yield(new St(f, u + s.from, c, s._tree));
  }
}
var ra = class {
    constructor(t, e) {
      ((this.offset = e),
        (this.done = !1),
        (this.cursor = t.cursor(V.IncludeAnonymous | V.IgnoreMounts)));
    }
    moveTo(t) {
      let { cursor: e } = this,
        i = t - this.offset;
      for (; !this.done && e.from < i;)
        if (!(e.to >= t && e.enter(i, 1, V.IgnoreOverlays | V.ExcludeBuffers)))
          if (e.to <= t) e.next(!1) || (this.done = !0);
          else break;
    }
    hasNode(t) {
      if (
  ...
  Tf = class {
    constructor(t) {
      ...
      if (
        ...
        ((this.curTo =
          (e = i.tree.prop(sa)) !== null && e !== void 0 ? e : i.to),
          (this.inner = new ra(i.tree, -i.offset)));
    ...
    nextFrag() {
      ...
      if ((this.fragI++, this.fragI == this.fragments.length))
        ...
        ((this.curTo =
          (t = e.tree.prop(sa)) !== null && t !== void 0 ? t : e.to),
          (this.inner = new ra(e.tree, -e.offset)));
      }
    }
    findMounts(t, e) {
      var i;
      ...
      if (this.inner) {
        ...
        for (let r = this.inner.cursor.node; r; r = r.parent) {
          let o =
            (i = r.tree) === null || i === void 0 ? void 0 : i.prop(X.mounted);
          if (o && o.parser == e)
            for (let a = this.fragI; a < this.fragments.length; a++) {
              let l = this.fragments[a];
              if (l.from >= r.to) break;
              l.tree == this.curFrag.tree &&
                n.push({ frag: l, pos: r.from - l.offset, mount: o });
            }
        }
      }
      return n;
  ...
  for (let n = 1, r = 0; n < s.length; n++) {
    ...
    for (; r < i.length; r++) {
      ...
      l.to <= o ||
        ...
        l.from < o
          ? ((e[r] = new Vt(l.from, o)),
            l.to > a && e.splice(r + 1, 0, new Vt(a, l.to)))
          : l.to > a
            ? (e[r--] = new Vt(a, l.to))
            : e.splice(r--, 1));
    }
...
function Bg(s, t, e, i) {
  let n = 0,
    ...
    h = [];
  for (;;) {
    let c = n == s.length ? 1e9 : o ? s[n].to : s[n].from,
      f = r == t.length ? 1e9 : a ? t[r].to : t[r].from;
    if (o != a) {
      let u = Math.max(l, e),
        d = Math.min(c, f, i);
      u < d && h.push(new Vt(u, d));
    }
    if (((l = Math.min(c, f)), l == 1e9)) break;
    (c == l && (o ? ((o = !1), n++) : (o = !0)),
      f == l && (a ? ((a = !1), r++) : (a = !0)));
  }
  return h;
...
function Af(s, t) {
  ...
  for (let { pos: i, mount: n, frag: r } of s) {
    let o = i + (n.overlay ? n.overlay[0].from : 0),
      a = o + n.tree.length,
      l = Math.max(r.from, o),
      h = Math.min(r.to, a);
    if (n.overlay) {
      let c = n.overlay.map((u) => new Vt(u.from + i, u.to + i)),
        f = Bg(t, c, l, h);
      for (let u = 0, d = l; ; u++) {
        let p = u == f.length,
          O = p ? h : f[u].from;
...
var zg = 0,
  Ct = class {
    ...
    static define(t, e) {
      ...
      if ((t instanceof Ct && (e = t), e == null ? void 0 : e.base))
    ...
    static defineModifier(t) {
      let e = new Dn(t);
      return (i) =>
        i.modified.indexOf(e) > -1
          ? i
          : Dn.get(
              i.base || i,
              i.modified.concat(e).sort((n, r) => n.id - r.id),
            );
    }
  },
  Vg = 0,
  Dn = class {
    constructor(t) {
      ((this.name = t), (this.instances = []), (this.id = Vg++));
    }
    static get(t, e) {
      if (!e.length) return t;
      let i = e[0].instances.find((a) => a.base == t && jg(e, a.modified));
      if (i) return i;
      let n = [],
        r = new Ct(t.name, n, t, e);
      for (let a of e) a.instances.push(r);
      let o = Yg(e);
      for (let a of t.set)
        if (!a.modified.length) for (let l of o) n.push(Dn.get(a, l));
      return r;
    }
  };
function jg(s, t) {
...
function Yg(s) {
  let t = [[]];
  for (let e = 0; e < s.length; e++)
    for (let i = 0, n = t.length; i < n; i++) t.push(t[i].concat(s[e]));
    ...
    for (let n of e.split(" "))
      if (n) {
        let r = [],
          ...
          a = n;
        for (let f = 0; ;) {
          if (a == "..." && f > 0 && f + 3 == n.length) {
            o = 1;
            break;
          }
          let u = /^"(?:[^"\\]|\\.)*?"|[^\/!]+/.exec(a);
          if (!u) throw new RangeError("Invalid path: " + n);
          if (
            (r.push(
        ...
        let c = new Gi(i, o, l > 0 ? r.slice(0, l) : null);
        t[h] = c.sort(t[h]);
      }
  }
  return Ef.add(t);
      ...
      for (; s || t;) {
        if (
          (!s || (t && s.depth >= t.depth)
            ? ((n = t), (t = t.next))
            : ((n = s), (s = s.next)),
          e && e.mode == n.mode && !n.context && !e.context)
        )
          continue;
        let r = new Gi(n.tags, n.mode, n.context);
        (e ? (e.next = r) : (i = r), (e = r));
      }
      return i;
    },
...
function oa(s, t) {
  let e = Object.create(null);
  for (let r of s)
    if (!Array.isArray(r.tag)) e[r.tag.id] = r.class;
    else for (let o of r.tag) e[o.id] = r.class;
...
function Zf(s, t, e, i = 0, n = s.length) {
  let r = new Mf(i, Array.isArray(t) ? t : [t], e);
...
var Mf = class {
  ...
  highlightRange(t, e, i, n, r) {
    ...
    if (
      (f &&
        (h && (h += " "), (h += f), c.mode == 1 && (n += (n ? " " : "") + f)),
      this.startSpan(Math.max(e, a), h),
      c.opaque)
    )
      return;
    let u = t.tree && t.tree.prop(X.mounted);
    if (u && u.overlay) {
      let d = t.node.enter(u.overlay[0].from + a, 1),
        p = this.highlighters.filter((g) => !g.scope || g.scope(u.tree.type)),
        O = t.firstChild();
      for (let g = 0, b = a; ; g++) {
        let S = g < u.overlay.length ? u.overlay[g] : null,
          y = S ? S.from + a : l,
          C = Math.max(e, b),
          w = Math.min(i, y);
        if (C < w && O)
          for (
            ;
            t.from < w &&
            (this.highlightRange(t, C, w, n, r),
            this.startSpan(Math.min(w, t.to), h),
            !(t.to >= y || !t.nextSibling()));
          );
        if (!S || y > i) break;
        ((b = S.to + a),
          b > e &&
...
function qg(s) {
  let t = s.type.prop(Ef);
  for (; t && t.context && !s.matchContext(t.context);) t = t.next;
  return t || null;
}
var x = Ct.define,
  rr = x(),
  ...
  m = {
    ...
    operatorKeyword: x($e),
    controlKeyword: x($e),
    definitionKeyword: x($e),
    moduleKeyword: x($e),
    operator: Te,
    derefOperator: x(Te),
    arithmeticOperator: x(Te),
    logicOperator: x(Te),
    bitwiseOperator: x(Te),
    compareOperator: x(Te),
    updateOperator: x(Te),
    definitionOperator: x(Te),
    typeOperator: x(Te),
    controlOperator: x(Te),
    punctuation: la,
    separator: x(la),
    bracket: Bn,
    angleBracket: x(Bn),
...
var ha,
  si = new X();
function zn(s) {
  return M.define({ combine: s ? (t) => t.concat(s) : void 0 });
}
var lr = new X(),
  Xt = class {
    constructor(t, e, i = [], n = "") {
      ((this.data = t),
        (this.name = n),
        I.prototype.hasOwnProperty("tree") ||
          Object.defineProperty(I.prototype, "tree", {
            get() {
              return F(this);
            },
          }),
    ...
    isActiveAt(t, e, i = -1) {
      return Lf(t, e, i).type.prop(si) == this.data;
    }
    findRegions(t) {
      let e = t.facet(Ui);
      ...
      let i = [],
        n = (r, o) => {
          if (r.prop(si) == this.data) {
            i.push({ from: o, to: o + r.length });
            return;
          }
          let a = r.prop(X.mounted);
          if (a) {
            if (a.tree.prop(si) == this.data) {
              if (a.overlay)
              ...
              let l = i.length;
              if ((n(a.tree, a.overlay[0].from + o), i.length > l)) return;
            }
          }
          for (let l = 0; l < r.children.length; l++) {
            let h = r.children[l];
            h instanceof z && n(h, r.positions[l] + o);
          }
        };
      return (n(F(t), 0), i);
    }
...
Xt.setState = tt.define();
function Lf(s, t, e) {
  let i = s.facet(Ui),
    n = F(s).topNode;
  if (!i || i.allowsNesting)
    for (let r = n; r; r = r.enter(t, e, V.ExcludeBuffers | V.EnterBracketed))
      r.type.isTop && (n = r);
  return n;
}
var Ce = class extends Xt {
  ...
  static define(t) {
    let e = zn(t.languageData);
    return new Ce(
      e,
      t.parser.configure({ props: [si.add((i) => (i.isTop ? e : void 0))] }),
      t.name,
    );
  }
  configure(t, e) {
    return new Ce(this.data, this.parser.configure(t), e || this.name);
  }
  get allowsNesting() {
...
var If = class {
  ...
  vi = class {
    ...
    static create(t, e, i) {
      return new vi(t, e, [], z.empty, 0, i, [], null);
    }
    startParse() {
      return this.parser.startParse(new If(this.state.doc), this.fragments);
    }
    work(t, e) {
      return (
        e != null && e >= this.state.doc.length && (e = void 0),
        this.tree != z.empty && this.isDone(e ?? this.state.doc.length)
          ? (this.takeTree(), !0)
          : this.withContext(() => {
              var i;
              if (typeof t == "number") {
              ...
              for (
                ...
                if (n)
                  if (
                    ...
                    (this.tree = n),
                    (this.parse = null),
                    this.treeLen < (e ?? this.state.doc.length))
                  )
    ...
    takeTree() {
      ...
      this.parse &&
        ...
        (this.tree = e),
        (this.fragments = this.withoutTempSkipped(
          le.addTree(this.tree, this.fragments, !0),
        )),
        (this.parse = null));
    }
    withContext(t) {
    ...
    withoutTempSkipped(t) {
      for (let e; (e = this.tempSkipped.pop());) t = Df(t, e.from, e.to);
      return t;
    }
    changes(t, e) {
      let { fragments: i, tree: n, treeLen: r, viewport: o, skipped: a } = this;
      if ((this.takeTree(), !t.empty)) {
        let l = [];
        if (
          (t.iterChangedRanges((h, c, f, u) =>
            l.push({ fromA: h, toA: c, fromB: f, toB: u }),
          ),
          (i = le.applyChanges(i, l)),
          (n = z.empty),
          (r = 0),
          ...
          for (let h of this.skipped) {
            let c = t.mapPos(h.from, 1),
              f = t.mapPos(h.to, -1);
            c < f && a.push({ from: c, to: f });
          }
        }
      }
      return new vi(this.parser, e, i, n, r, o, a, this.scheduleOn);
    }
    updateViewport(t) {
      ...
      for (let i = 0; i < this.skipped.length; i++) {
        ...
        n < t.to &&
          r > t.from &&
          ((this.fragments = Df(this.fragments, n, r)),
        ...
        createParse(e, i, n) {
          ...
          return {
            ...
            advance() {
              let l = Vn;
              if (l) {
                for (let h of n) l.tempSkipped.push(h);
                t &&
                  (l.scheduleOn = l.scheduleOn
                    ? Promise.all([l.scheduleOn, t])
                    : t);
              }
              return ((this.parsedPos = o), new z(nt.none, [], [], o - r));
            },
            stoppedAt: null,
            stopAt() {},
          };
...
function Df(s, t, e) {
  return le.applyChanges(s, [{ fromA: t, toA: e, fromB: t, toB: e }]);
}
var xi = class {
  constructor(t) {
  ...
  apply(t) {
    ...
    return (e.work(20, i) || e.takeTree(), new xi(e));
  }
  static init(t) {
    let e = Math.min(3e3, t.doc.length),
      i = vi.create(t.facet(Ui).parser, t, { from: 0, to: e });
    return (i.work(20, e) || i.takeTree(), new xi(i));
  }
};
Xt.state = Wt.define({
  create: xi.init,
  update(s, t) {
    for (let e of t.effects) if (e.is(Xt.setState)) return e.value;
    return t.startState.facet(Ui) != t.state.facet(Ui)
      ? xi.init(t.state)
      : s.apply(t);
  },
});
...
var ca =
    typeof navigator != "undefined" &&
    ((ha = navigator.scheduling) === null || ha === void 0
      ? void 0
      : ha.isInputPending)
  ...
  Wg = Zt.fromClass(
    class {
      ...
      update(t) {
        let e = this.view.state.field(Xt.state).context;
      ...
      work(t) {
        ...
        let o =
            ...
            Math.min(
              this.chunkBudget,
              100,
              t && !ca ? Math.max(25, t.timeRemaining() - 5) : 1e9,
            ),
          a = r.context.treeLen < n && i.doc.length > n + 1e3,
          l = r.context.work(
            () => (ca && ca()) || Date.now() > o,
            n + (a ? 0 : 1e5),
          );
        ((this.chunkBudget -= Date.now() - e),
          (l || this.chunkBudget <= 0) &&
            (r.context.takeTree(),
            this.view.dispatch({ effects: Xt.setState.of(new xi(r.context)) })),
  ...
  Fi = class {
    ...
    static of(t) {
      ...
      return new Fi(
        t.name,
        (t.alias || []).concat(t.name).map((n) => n.toLowerCase()),
        t.extensions || [],
        t.filename,
        e,
        i,
    ...
    static matchFilename(t, e) {
      for (let n of t) if (n.filename && n.filename.test(e)) return n;
      let i = /\.([^.]+)$/.exec(e);
      if (i) {
        for (let n of t) if (n.extensions.indexOf(i[1]) > -1) return n;
      }
      return null;
    }
    static matchLanguageName(t, e, i = !0) {
      e = e.toLowerCase();
      for (let n of t) if (n.alias.some((r) => r == e)) return n;
      if (i)
        for (let n of t)
          for (let r of n.alias) {
            ...
            if (
              o > -1 &&
              (r.length > 2 ||
                (!/\w/.test(e[o - 1]) && !/\w/.test(e[o + r.length])))
            )
              return n;
          }
      return null;
...
function Yn(s, t) {
  ...
  for (let r = 0; r < t; r++) e += n;
  return e;
}
function fa(s, t) {
  s instanceof I && (s = new Hi(s));
  for (let i of s.state.facet(_g)) {
    let n = i(s, t);
    if (n !== void 0) return n;
  }
  let e = F(s.state);
  return e.length >= t ? Gg(s, e, t) : null;
}
var Hi = class {
    constructor(t, e = {}) {
      ((this.state = t), (this.options = e), (this.unit = jn(t)));
    }
    lineAt(t, e = 1) {
      let i = this.state.doc.lineAt(t),
        { simulateBreak: n, simulateDoubleBreak: r } = this.options;
      return n != null && n >= i.from && n <= i.to
        ? r && n == t
          ? { text: "", from: t }
          : (e < 0 ? n < t : n <= t)
    ...
    countColumn(t, e = t.length) {
      return we(t, this.state.tabSize, e);
    }
    lineIndent(t, e = 1) {
      let { text: i, from: n } = this.lineAt(t, e),
  ...
  je = new X();
function Gg(s, t, e) {
  let i = t.resolveStack(e),
    n = t.resolveInner(e, -1).resolve(e, 0).enterUnfinishedNodesBefore(e);
  if (n != i.node) {
    let r = [];
    for (
      let o = n;
...
function Fg(s) {
  let t = s.type.prop(je);
  if (t) return t;
  let e = s.firstChild,
    i;
  if (e && (i = e.type.prop(X.closedBy))) {
    let n = s.lastChild,
      r = n && i.indexOf(n.name) > -1;
    return (o) => jf(o, !0, 1, void 0, r && !Ug(o) ? n.from : void 0);
  }
  return s.parent == null ? Hg : null;
}
function Hg() {
  return 0;
}
var hr = class extends Hi {
  constructor(t, e, i) {
    super(t.state, t.options);
    ((this.base = t), (this.pos = e), (this.context = i));
  }
  get node() {
  ...
  continue() {
    return zf(this.context.next, this.base, this.pos);
  }
};
function Kg(s, t) {
  for (let e = t; e; e = e.parent) if (s == e) return !0;
  return !1;
}
function Jg(s) {
  let t = s.node,
    e = t.childAfter(t.from),
    i = t.lastChild;
  if (!e) return null;
  let n = s.options.simulateBreak,
    r = s.state.doc.lineAt(e.from),
    o = n == null || n <= r.from ? r.to : Math.min(r.to, n);
  for (let a = e.to; ;) {
...
function Vf({ closing: s, align: t = !0, units: e = 1 }) {
  return (i) => jf(i, t, e, s);
}
function jf(s, t, e, i, n) {
  let r = s.textAfter,
    o = r.match(/^\s*/)[0].length,
    a = (i && r.slice(o, o + i.length) == i) || n == s.pos + o,
    l = t ? Jg(s) : null;
  return l
    ? a
      ? s.column(l.from)
      : s.column(l.to)
    : s.baseIndent + (a ? 0 : s.unit * e);
}
var Yf = (s) => s.baseIndent;
function Ki({ except: s, units: t = 1 } = {}) {
  return (e) => {
...
function cr(s) {
  ...
  return t && t.to < e.from
    ? { from: t.to, to: e.type.isError ? s.to : e.from }
    : null;
}
var ki = class {
    constructor(t, e) {
      ...
      let r = typeof e.all == "string" ? e.all : e.all ? n(e.all) : void 0,
        o = e.scope;
      ((this.scope =
        o instanceof Xt
          ? (a) => a.prop(si) == o.data
...
function fr(s, t) {
  ...
  return (
    s instanceof ki &&
      (s.module && e.push(A.styleModule.of(s.module)), (i = s.themeType)),
    (t == null ? void 0 : t.fallback)
      ? e.push(qf.of(s))
      : i
        ? e.push(
            ua.computeN([A.darkTheme], (n) =>
              n.facet(A.darkTheme) == (i == "dark") ? [s] : [],
            ),
          )
        : e.push(ua.of(s)),
    e
...
var Wf = class {
    constructor(t) {
      ((this.markCache = Object.create(null)),
        (this.tree = F(t.state)),
        (this.decorations = this.buildDeco(t, da(t.state))),
    ...
    update(t) {
      let e = F(t.state),
        ...
        n = i != da(t.startState),
        { viewport: r } = t.view,
        o = t.changes.mapPos(this.decoratedTo, 1);
      e.length < r.to && !n && e.type == this.tree.type && o >= r.to
    ...
    buildDeco(t, e) {
      if (!e || !this.tree.length) return q.none;
      let i = new Me();
        ...
        Zf(
          ...
          (o, a, l) => {
            i.add(
              o,
              a,
              this.markCache[l] || (this.markCache[l] = q.mark({ class: l })),
            );
          },
          n,
          r,
  ...
  t0 = be.high(Zt.fromClass(Wf, { decorations: (s) => s.decorations })),
  _f = ki.define([
...
var pa = new X();
function Oa(s, t, e) {
  let i = s.prop(t < 0 ? X.openedBy : X.closedBy);
  if (i) return i;
  if (s.name.length == 1) {
    let n = e.indexOf(s.name);
    if (n > -1 && n % 2 == (t < 0 ? 1 : 0)) return [e[n + t]];
  }
  return null;
}
function ma(s) {
  let t = s.type.prop(pa);
  return t ? t(s.node) : s;
}
function Qi(s, t, e, i = {}) {
  let n = i.maxScanDistance || e0,
    r = i.brackets || i0,
    o = F(s),
    a = o.resolveInner(t, e);
  for (let l = a; l; l = l.parent) {
    let h = Oa(l.type, e, r);
    if (h && l.from < l.to) {
      let c = ma(l);
      if (c && (e > 0 ? t >= c.from && t < c.to : t > c.from && t <= c.to))
        return n0(s, t, e, l, c, h, r);
    }
  }
  return s0(s, t, e, o, a.type, n, r);
}
function n0(s, t, e, i, n, r, o) {
  let a = i.parent,
  ...
  if (c && (e < 0 ? c.childBefore(i.from) : c.childAfter(i.to)))
    do
      if (e < 0 ? c.to <= i.from : c.from >= i.to) {
        ...
        } else if (Oa(c.type, e, o)) h++;
        else if (Oa(c.type, -e, o)) {
          if (h == 0) {
            let f = ma(c);
            return {
              start: l,
...
function s0(s, t, e, i, n, r, o) {
  if (e < 0 ? !t : t == s.doc.length) return null;
  let a = e < 0 ? s.sliceDoc(t - 1, t) : s.sliceDoc(t, t + 1),
    l = o.indexOf(a);
  if (l < 0 || (l % 2 == 0) != e > 0) return null;
  let h = { from: e < 0 ? t - 1 : t, to: e > 0 ? t + 1 : t },
    c = s.doc.iterRange(t, e > 0 ? s.doc.length : 0),
    f = 0;
  for (let u = 0; !c.next().done && u <= r;) {
    ...
    let p = t + u * e;
    for (
      let O = e > 0 ? 0 : d.length - 1, g = e > 0 ? d.length : -1;
      O != g;
      O += e
    ) {
      let b = o.indexOf(d[O]);
      if (!(b < 0 || i.resolveInner(p + O, 1).type != n))
        if ((b % 2 == 0) == e > 0) f++;
        else {
          if (f == 1)
            return {
...
for (let [s, t] of [
  ...
  o0[s] = a0(r0, t);
function ga(s, t) {
  Uf.indexOf(s) > -1 || (Uf.push(s), console.warn(t));
}
function a0(s, t) {
  let e = [];
    ...
    for (let h of a.split(".")) {
      ...
      c
        ? typeof c == "function"
          ? l.length
            ? (l = l.map(c))
            : ga(h, `Modifier ${h} used at start of tag`)
          : l.length
            ? ga(h, `Tag ${h} used as modifier`)
            : (l = Array.isArray(c) ? c : [c])
        : ga(h, `Unknown highlighting tag ${h}`);
    }
    for (let h of l) e.push(h);
  }
...
var st = class {
    ...
    replace(t, e, i) {
      ...
      return (
        ...
        i.length && i.decompose(0, i.length, n, 1 | 2),
        this.decompose(e, this.length, n, 1),
        ce.from(n, this.length - (e - t) + i.length)
      );
    }
    append(t) {
      return this.replace(this.length, this.length, t);
    ...
    slice(t, e = this.length) {
      [t, e] = tn(this, t, e);
      let i = [];
      return (this.decompose(t, e, i, 0), ce.from(i, e - t));
    }
    eq(t) {
      if (t == this) return !0;
      if (t.length != this.length || t.lines != this.lines) return !1;
  ...
  ot = class extends st {
    ...
    lineInner(t, e, i, n) {
      for (let r = 0; ; r++) {
        let o = this.text[r],
          a = n + o.length;
        if ((e ? i : a) >= t) return new Kf(n, a, i, o);
        ((n = a + 1), i++);
      }
    }
    decompose(t, e, i, n) {
      ...
      if (n & 1) {
        let o = i.pop(),
          a = ur(r.text, o.text.slice(), 0, r.length);
        if (a.length <= 32) i.push(new ot(a, o.length + r.length));
        else {
          let l = a.length >> 1;
          i.push(new ot(a.slice(0, l)), new ot(a.slice(l)));
        }
      } else i.push(r);
    }
    replace(t, e, i) {
      if (!(i instanceof ot)) return super.replace(t, e, i);
      [t, e] = tn(this, t, e);
      let n = ur(this.text, ur(i.text, Hf(this.text, 0, t)), e),
        r = this.length + i.length - (e - t);
      return n.length <= 32 ? new ot(n, r) : ce.from(ot.split(n, []), r);
    }
    sliceString(
      t,
      e = this.length,
...
`,
    ...
    static split(t, e) {
      ...
      for (let r of t)
        (i.push(r),
          (n += r.length + 1),
          i.length == 32 && (e.push(new ot(i, n)), (i = []), (n = -1)));
      return (n > -1 && e.push(new ot(i, n)), e);
    }
  },
  ce = class extends st {
    constructor(t, e) {
    ...
    replace(t, e, i) {
      if ((([t, e] = tn(this, t, e)), i.lines < this.lines))
        for (let n = 0, r = 0; n < this.children.length; n++) {
          let o = this.children[n],
            a = r + o.length;
          if (t >= r && e <= a) {
            ...
            if (l.lines < h >> (5 - 1) && l.lines > h >> (5 + 1)) {
              let c = this.children.slice();
              return ((c[n] = l), new ce(c, this.length - (e - t) + i.length));
            }
            return super.replace(r, a, l);
          }
          r = a + 1;
...
`,
    ...
    static from(t, e = t.reduce((i, n) => i + n.length + 1, -1)) {
      ...
      function f(d) {
        let p;
        if (d.lines > r && d instanceof ce) for (let O of d.children) f(O);
        else
          d.lines > o && (l > o || !l)
            ? (u(), a.push(d))
            : d instanceof ot &&
                l &&
                (p = c[c.length - 1]) instanceof ot &&
                d.lines + p.lines <= 32
              ? ((l += d.lines),
                (h += d.length + 1),
                (c[c.length - 1] = new ot(
      ...
      function u() {
        l != 0 &&
          (a.push(c.length == 1 ? c[0] : ce.from(c, h)),
          (h = -1),
          (l = c.length = 0));
      }
      for (let d of t) f(d);
      return (u(), a.length == 1 ? a[0] : new ce(a, e));
    }
  };
st.empty = new ot([""], 0);
function l0(s) {
    ...
    constructor(t, e = 1) {
      ((this.dir = e),
        ...
        (this.offsets = [
          e > 0
            ? 1
            : (t instanceof ot ? t.text.length : t.children.length) << 1,
        ]));
    }
    nextInner(t, e) {
      for (this.done = this.lineBreak = !1; ;) {
        let i = this.nodes.length - 1,
          ...
          r = this.offsets[i],
          o = r >> 1,
          a = n instanceof ot ? n.text.length : n.children.length;
        if (o == (e > 0 ? a : 0)) {
          if (i == 0) return ((this.done = !0), (this.value = ""), this);
          (e > 0 && this.offsets[i - 1]++,
            this.nodes.pop(),
          ...
          t > l.length
            ...
            : (e < 0 && this.offsets[i]--,
              ...
              this.offsets.push(
                e > 0
                  ? 1
                  : (l instanceof ot ? l.text.length : l.children.length) << 1,
              ));
        }
      }
    }
...
typeof Symbol != "undefined" &&
  ...
  (Ji.prototype[Symbol.iterator] =
    ba.prototype[Symbol.iterator] =
    Sa.prototype[Symbol.iterator] =
      function () {
        return this;
      }));
var Kf = class {
...
var ya = /\r\n?|\n/,
  ...
  Ft = class {
    ...
    composeDesc(t) {
      return this.empty ? t : t.empty ? this : Jf(this, t);
    }
    mapDesc(t, e = !1) {
      return t.empty ? this : va(this, t, e);
    }
    mapPos(t, e = -1, i = oi.Simple) {
      let n = 0,
        r = 0;
      for (let o = 0; o < this.sections.length;) {
        let a = this.sections[o++],
        ...
        if (l < 0) {
          ...
          if (
            i != oi.Simple &&
            h >= t &&
            ((i == oi.TrackDel && n < t && h > t) ||
              (i == oi.TrackBefore && n < t) ||
              (i == oi.TrackAfter && h > t))
          )
            return null;
          if (h > t || (h == t && e < 0 && !a))
  ...
  dt = class extends Ft {
    ...
    apply(t) {
      ...
      return (
        wa(this, (e, i, n, r, o) => (t = t.replace(n, n + (i - e), o)), !1),
        t
      );
    }
    mapDesc(t, e = !1) {
      return va(this, t, e, !0);
    }
    invert(t) {
      let e = this.sections.slice(),
        i = [];
      for (let n = 0, r = 0; n < e.length; n += 2) {
        ...
        if (a >= 0) {
          ((e[n] = a), (e[n + 1] = o));
          let l = n >> 1;
          for (; i.length < l;) i.push(st.empty);
          i.push(o ? t.slice(r, r + o) : st.empty);
        }
        r += o;
      }
      return new dt(e, i);
    ...
    compose(t) {
      return this.empty ? t : t.empty ? this : Jf(this, t, !0);
    }
    map(t, e = !1) {
      return t.empty ? this : va(this, t, e, !0);
    }
    iterChanges(t, e = !1) {
      wa(this, t, e);
    }
    ...
    filter(t) {
      ...
      t: for (let o = 0, a = 0; ;) {
        ...
        for (; a < l || (a == l && r.len == 0);) {
          ...
          kt(n, c, -1);
          let f = r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0;
          (kt(e, c, f), f > 0 && ai(i, e, r.text), r.forward(c), (a += c));
        }
        let h = t[o++];
        for (; a < h;) {
          if (r.done) break t;
          let c = Math.min(r.len, h - a);
          (kt(e, c, -1),
            kt(n, c, r.ins == -1 ? -1 : r.off == 0 ? r.ins : 0),
            r.forward(c),
            (a += c));
        }
      }
      return { changes: new dt(e, i), filtered: Ft.create(n) };
    }
    toJSON() {
      let t = [];
      for (let e = 0; e < this.sections.length; e += 2) {
      ...
      for (let n = 0; n < t.length; n++) {
        ...
        if (typeof r == "number") e.push(r, -1);
          ...
          if (r.length == 1) e.push(r[0], 0);
            ...
            for (; i.length < n;) i.push(st.empty);
            ((i[n] = st.of(r.slice(1))), e.push(r[0], i[n].length));
          }
        }
      }
      return new dt(e, i);
...
function ai(s, t, e) {
  ...
  if (i < s.length) s[s.length - 1] = s[s.length - 1].append(e);
    ...
    for (; s.length < i;) s.push(st.empty);
    s.push(e);
  }
}
function wa(s, t, e) {
...
function va(s, t, e, i = !1) {
  ...
  for (let l = -1; ;) {
    ...
    if (o.ins == -1 && a.ins == -1) {
      let h = Math.min(o.len, a.len);
      (kt(n, h, -1), o.forward(h), a.forward(h));
    } else if (
      a.ins >= 0 &&
      (o.ins < 0 ||
        l == o.i ||
      ...
      for (kt(n, a.ins, -1); h;) {
        ...
        (o.ins >= 0 &&
          l < o.i &&
          o.len <= c &&
          (kt(n, 0, o.ins), r && ai(r, n, o.text), (l = o.i)),
          o.forward(c),
          (h -= c));
      }
      a.next();
      ...
      (kt(n, h, l < o.i ? o.ins : 0),
        r && l < o.i && ai(r, n, o.text),
        (l = o.i),
        o.forward(o.len - c));
    } else {
      if (o.done && a.done) return r ? dt.createSet(n, r) : Ft.create(n);
      throw new Error("Mismatched change set lengths");
    }
  }
}
function Jf(s, t, e = !1) {
  let i = [],
    ...
    o = new en(t);
  for (let a = !1; ;) {
    if (r.done && o.done) return n ? dt.createSet(i, n) : Ft.create(i);
    if (r.ins == 0) (kt(i, r.len, 0, a), r.next());
    else if (o.len == 0 && !o.done)
      (kt(i, 0, o.ins, a), n && ai(n, i, o.text), o.next());
    else {
      if (r.done || o.done) throw new Error("Mismatched change set lengths");
      {
        let l = Math.min(r.len2, o.len),
        ...
        if (r.ins == -1) {
          let c = o.ins == -1 ? -1 : o.off ? 0 : o.ins;
          (kt(i, l, c, a), n && c && ai(n, i, o.text));
        } else
          o.ins == -1
            ? (kt(i, r.off ? 0 : r.len, l, a), n && ai(n, i, r.textBit(l)))
            : (kt(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, a),
              n && !o.off && ai(n, i, o.text));
        ((a = (r.ins > l || (o.ins >= 0 && o.len > l)) && (a || i.length > h)),
          r.forward2(l),
          o.forward(l));
      }
...
var en = class {
    ...
    get text() {
      let { inserted: t } = this.set,
        e = (this.i - 2) >> 1;
      return e >= t.length ? st.empty : t[e];
    }
    textBit(t) {
      let { inserted: e } = this.set,
        i = (this.i - 2) >> 1;
  ...
  qe = class {
    constructor(t, e, i, n) {
      ((this.from = t), (this.to = e), (this.flags = i), (this.goalColumn = n));
    }
    get anchor() {
      return this.flags & 32 ? this.to : this.from;
    }
    ...
    map(t, e = -1) {
      ...
      return (
        ...
        i == this.from && n == this.to
          ? this
          : new qe(i, n, this.flags, this.goalColumn)
      );
    }
    extend(t, e = t, i = 0) {
      if (t <= this.anchor && e >= this.anchor)
        return Z.range(t, e, void 0, void 0, i);
      let n = Math.abs(t - this.anchor) > Math.abs(e - this.anchor) ? t : e;
      return Z.range(this.anchor, n, void 0, void 0, i);
    }
    eq(t, e = !1) {
      return (
        this.anchor == t.anchor &&
  ...
  Z = class {
    ...
    static cursor(t, e = 0, i, n) {
      return qe.create(
        t,
        t,
        (e == 0 ? 0 : e < 0 ? 8 : 16) | (i == null ? 7 : Math.min(6, i)),
        n,
      );
    }
    static range(t, e, i, n, r) {
      ...
      return (
        !r && t != e && (r = e < t ? 1 : -1),
        r && (o |= r < 0 ? 8 : 16),
        e < t ? qe.create(e, t, o | 32, i) : qe.create(t, e, o, i)
      );
    }
    static undirectionalRange(t, e) {
      return qe.create(t, e, 64, void 0);
    }
    static normalized(t, e = 0) {
      let i = t[e];
      (t.sort((n, r) => n.from - r.from), (e = t.indexOf(i)));
        ...
        if (r.empty ? r.from <= o.to : r.from < o.to) {
          ...
          (n <= e && e--,
            t.splice(
              --n,
              2,
              r.anchor > r.head ? Z.range(l, a) : Z.range(a, l),
            ));
        }
      }
      return new Z(t, e);
  ...
  yt = class {
    ...
    static define(t = {}) {
      return new yt(
        t.combine || ((e) => e),
        t.compareInput || ((e, i) => e === i),
        t.compare || (t.combine ? (e, i) => e === i : ka),
        !!t.static,
        t.enables,
      );
    }
    of(t) {
      return new Nn([], this, 0, t);
    }
    compute(t, e) {
      if (this.isStatic) throw new Error("Can't compute a static facet");
      return new Nn(t, this, 1, e);
    }
    computeN(t, e) {
      if (this.isStatic) throw new Error("Can't compute a static facet");
      return new Nn(t, this, 2, e);
    }
    from(t, e) {
      return (e || (e = (i) => i), this.compute([t], (i) => e(i.field(t))));
    }
    ...
    return {
      ...
      update(f, u) {
        if (
          ...
          let d = i(f);
          if (a ? !eu(d, f.values[o], n) : !n(d, f.values[o]))
            return ((f.values[o] = d), 1);
        }
        return 0;
      },
  ...
  return {
    ...
    reconfigure(l, h) {
      let c = Qa(l, i),
        f = h.config.facets[t.id],
        u = h.facet(t);
      if (f && !c && ka(e, f)) return ((l.values[o] = u), 0);
      let d = a(l);
      return t.compare(d, u) ? ((l.values[o] = u), 0) : ((l.values[o] = d), 1);
    },
  };
}
var dr = yt.define({ static: !0 }),
  We = class {
    constructor(t, e, i, n, r) {
      ((this.id = t),
        (this.createF = e),
      ...
      return {
        ...
        reconfigure: (i, n) => {
          let r = i.facet(dr),
            o = n.facet(dr),
            a;
          return (a = r.find((l) => l.field == this)) &&
            a != o.find((l) => l.field == this)
            ? ((i.values[e] = a.create(i)), 1)
            : n.config.address[this.id] != null
              ? ((i.values[e] = n.field(this)), 0)
              : ((i.values[e] = this.create(i)), 1);
        },
  ...
  Pi = { lowest: 4, low: 3, default: 2, high: 1, highest: 0 };
function qn(s) {
  return (t) => new Pa(t, s);
}
var zw = {
    highest: qn(Pi.highest),
    high: qn(Pi.high),
    default: qn(Pi.default),
    low: qn(Pi.low),
    lowest: qn(Pi.lowest),
  },
  Pa = class {
  ...
  Wn = class {
    of(t) {
      return new pr(this, t);
    }
    reconfigure(t) {
      return Wn.reconfigure.of({ compartment: this, extension: t });
    }
    get(t) {
      return t.config.compartments.get(this);
    }
    ...
    static resolve(t, e, i) {
      ...
      for (let u in r) {
        let d = r[u],
          ...
          O = (c && c[u]) || [];
        if (d.every((g) => g.type == 0))
          if (((a[p.id] = (l.length << 1) | 1), ka(O, d))) l.push(i.facet(p));
          else {
            let g = p.combine(d.map((b) => b.value));
            l.push(i && p.compare(g, i.facet(p)) ? i.facet(p) : g);
          }
          ...
          for (let g of d)
            g.type == 0
              ? ((a[g.id] = (l.length << 1) | 1), l.push(g.value))
              : ((a[g.id] = h.length << 1), h.push((b) => g.dynamicSlot(b)));
          ((a[p.id] = h.length << 1), h.push((g) => h0(g, p, d)));
        }
      }
      let f = h.map((u) => u(a));
      return new _n(t, o, f, a, l, r);
    }
  };
function c0(s, t, e) {
  let i = [[], [], [], [], []],
  ...
  function r(o, a) {
    ...
    if (l != null) {
      if (l <= a) return;
      let h = i[l].indexOf(o);
      (h > -1 && i[l].splice(h, 1), o instanceof pr && e.delete(o.compartment));
    }
    if ((n.set(o, a), Array.isArray(o))) for (let h of o) r(h, a);
      ...
      let h = t.get(o.compartment) || o.inner;
      (e.set(o.compartment, h), r(h, a));
    } else if (o instanceof Pa) r(o.inner, o.prec);
    else if (o instanceof We) (i[a].push(o), o.provides && r(o.provides, a));
    else if (o instanceof Nn)
      (i[a].push(o), o.facet.extensions && r(o.facet.extensions, Pi.default));
    else {
      let h = o.extension;
      if (!h)
        throw new Error(
          `Unrecognized extension value in extension set (${o}).`,
        );
      if (h == o)
        throw new Error(
          `Unrecognized extension value in extension set (${o}). This sometimes happens because multiple instances of @codemirror/state are loaded, breaking instanceof checks.`,
  ...
  return (r(s, Pi.default), i.reduce((o, a) => o.concat(a)));
}
function Gn(s, t) {
  if (t & 1) return 2;
  let e = t >> 1,
...
var iu = yt.define(),
  $a = yt.define({ combine: (s) => s.some((t) => t), static: !0 }),
  nu = yt.define({ combine: (s) => (s.length ? s[0] : void 0), static: !0 }),
  su = yt.define(),
  ru = yt.define(),
  ou = yt.define(),
  au = yt.define({ combine: (s) => (s.length ? s[0] : !1) }),
  _e = class {
    constructor(t, e) {
      ((this.type = t), (this.value = e));
    }
...
pt.reconfigure = pt.define();
pt.appendConfig = pt.define();
var ut = class {
  constructor(t, e, i, n, r, o) {
    ((this.startState = t),
      (this.changes = e),
      ...
      (this._state = null),
      i && tu(i, e.newLength),
      r.some((a) => a.type == ut.time) ||
        (this.annotations = r.concat(ut.time.of(Date.now()))));
  }
  static create(t, e, i, n, r, o) {
    return new ut(t, e, i, n, r, o);
  }
  get newDoc() {
    return this._doc || (this._doc = this.changes.apply(this.startState.doc));
  }
  ...
  isUserEvent(t) {
    let e = this.annotation(ut.userEvent);
    return !!(
      e &&
      (e == t ||
        (e.length > t.length &&
...
ut.time = _e.define();
ut.userEvent = _e.define();
ut.addToHistory = _e.define();
ut.remote = _e.define();
function f0(s, t) {
  let e = [];
  for (let i = 0, n = 0; ;) {
        ...
        (o = s.changes.compose(n))),
    {
      ...
      selection: t.selection
        ...
        : (i = s.selection) === null || i === void 0
          ? void 0
          : i.map(n),
      effects: pt.mapEffects(s.effects, n).concat(pt.mapEffects(t.effects, r)),
      annotations: s.annotations.length
        ? s.annotations.concat(t.annotations)
        : t.annotations,
      scrollIntoView: s.scrollIntoView || t.scrollIntoView,
...
function Ta(s, t, e) {
  let i = t.selection,
    n = nn(t.annotations);
  return (
    t.userEvent && (n = n.concat(ut.userEvent.of(t.userEvent))),
    {
      changes:
        t.changes instanceof dt
          ? t.changes
          : dt.of(t.changes || [], e, s.facet(nu)),
      selection: i && (i instanceof Z ? i : Z.single(i.anchor, i.head)),
      effects: nn(t.effects),
      annotations: n,
      scrollIntoView: !!t.scrollIntoView,
    }
  );
...
function fu(s, t, e) {
  let i = Ta(s, t.length ? t[0] : {}, s.doc.length);
  t.length && t[0].filter === !1 && (e = !1);
  for (let r = 1; r < t.length; r++) {
    t[r].filter === !1 && (e = !1);
    let o = !!t[r].sequential;
    i = cu(i, Ta(s, t[r], o ? i.changes.newLength : s.doc.length), o);
  }
  let n = ut.create(
    s,
    i.changes,
...
function u0(s) {
  let t = s.startState,
    e = !0;
  for (let n of t.facet(su)) {
    let r = n(s);
    if (r === !1) {
      e = !1;
      break;
    }
    Array.isArray(r) && (e = e === !0 ? r : f0(e, r));
  }
  if (e !== !0) {
    let n, r;
    if (e === !1) ((r = s.changes.invertedDesc), (n = dt.empty(t.doc.length)));
    else {
      let o = s.changes.filter(e);
      ((n = o.changes), (r = o.filtered.mapDesc(o.changes).invertedDesc));
    }
  ...
  for (let n = i.length - 1; n >= 0; n--) {
    ...
    r instanceof ut
      ? (s = r)
      : Array.isArray(r) && r.length == 1 && r[0] instanceof ut
        ? (s = r[0])
        : (s = fu(t, nn(r), !1));
  }
  return s;
...
function d0(s) {
  ...
  for (let n = e.length - 1; n >= 0; n--) {
    ...
    r &&
      Object.keys(r).length &&
      (i = cu(i, Ta(t, r, s.changes.newLength), !0));
  }
  return i == s
    ? s
    : ut.create(
...
var p0 = [];
function nn(s) {
  return s == null ? p0 : Array.isArray(s) ? s : [s];
}
var Ge = (function (s) {
    return (
      (s[(s.Word = 0)] = "Word"),
  ...
  Ca;
try {
  Ca = new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch (s) {}
function m0(s) {
  if (Ca) return Ca.test(s);
  for (let t = 0; t < s.length; t++) {
    let e = s[t];
    if (
      /\w/.test(e) ||
      (e > "\x80" && (e.toUpperCase() != e.toLowerCase() || O0.test(e)))
    )
      return !0;
  }
  return !1;
...
function g0(s) {
  return (t) => {
    if (!/\S/.test(t)) return Ge.Space;
    if (m0(t)) return Ge.Word;
    for (let e = 0; e < s.length; e++) if (t.indexOf(s[e]) > -1) return Ge.Word;
    return Ge.Other;
  };
}
var lt = class {
  constructor(t, e, i, n, r, o) {
    ((this.config = t),
      ...
      (this.computeSlot = r),
      o && (o._state = this));
    for (let a = 0; a < this.config.dynamicSlots.length; a++) Gn(this, a << 1);
    this.computeSlot = null;
  }
  field(t, e = !0) {
    let i = this.config.address[t.id];
  ...
  applyTransaction(t) {
    ...
    for (let a of t.effects)
      a.is(Wn.reconfigure)
        ...
        : a.is(pt.reconfigure)
          ? ((e = null), (i = a.value))
          : a.is(pt.appendConfig) && ((e = null), (i = nn(i).concat(a.value)));
    let r;
    e
      ? (r = t.startState.values.slice())
      : ((e = _n.resolve(i, n, this)),
        (r = new lt(
          e,
          this.doc,
          this.selection,
    ...
    let o = t.startState.facet($a) ? t.newSelection : t.newSelection.asSingle();
    new lt(e, t.newDoc, o, r, (a, l) => l.update(a, t), t);
  }
  replaceSelection(t) {
    return (
      typeof t == "string" && (t = this.toText(t)),
  ...
  changeByRange(t) {
    ...
    for (let a = 1; a < e.ranges.length; a++) {
      ...
      (r.push(l.range.map(f)),
        (n = n.compose(c)),
        (o = pt.mapEffects(o, c).concat(pt.mapEffects(nn(l.effects), f))));
    }
    return { changes: n, selection: Z.create(r, e.mainIndex), effects: o };
  }
  changes(t = []) {
    return t instanceof dt
      ? t
      : dt.of(t, this.doc.length, this.facet(lt.lineSeparator));
  }
  toText(t) {
    return st.of(t.split(this.facet(lt.lineSeparator) || ya));
  }
  sliceDoc(t = 0, e = this.doc.length) {
    return this.doc.sliceString(t, e, this.lineBreak);
  }
  facet(t) {
    let e = this.config.address[t.id];
    return e == null ? t.default : (Gn(this, e), Or(this, e));
  }
  toJSON(t) {
    let e = { doc: this.sliceDoc(), selection: this.selection.toJSON() };
    if (t)
  ...
  static create(t = {}) {
    let e = _n.resolve(t.extensions || [], new Map()),
      i =
        t.doc instanceof st
          ? t.doc
          : st.of((t.doc || "").split(e.staticFacet(lt.lineSeparator) || ya)),
      n = t.selection
  ...
  get lineBreak() {
    return (
      this.facet(lt.lineSeparator) ||
      `
`
    );
  }
  get readOnly() {
    return this.facet(au);
  }
  phrase(t, ...e) {
  ...
  wordAt(t) {
    ...
    for (; o > 0;) {
      let l = Ne(e, o, !1);
      if (r(e.slice(l, o)) != Ge.Word) break;
      o = l;
    }
    for (; a < n;) {
      let l = Ne(e, a);
      if (r(e.slice(a, l)) != Ge.Word) break;
      a = l;
    }
    return o == a ? null : Z.range(o + i, a + i);
  }
};
lt.allowMultipleSelections = $a;
lt.tabSize = yt.define({ combine: (s) => (s.length ? s[0] : 4) });
lt.lineSeparator = nu;
lt.readOnly = au;
lt.phrases = yt.define({
  compare(s, t) {
    let e = Object.keys(s),
      i = Object.keys(t);
    return e.length == i.length && e.every((n) => s[n] == t[n]);
...
lt.languageData = iu;
lt.changeFilter = su;
lt.transactionFilter = ru;
lt.transactionExtender = ou;
Wn.reconfigure = pt.define();
function uu(s, t, e = {}) {
  let i = {};
  for (let n of s)
    for (let r of Object.keys(n)) {
...
var Un = class {
  ...
  range(t, e = t) {
    return sn.create(t, e, this);
  }
};
Un.prototype.startSide = Un.prototype.endSide = 0;
Un.prototype.point = !1;
Un.prototype.mapMode = oi.TrackDel;
function Aa(s, t) {
...
var mr = class {
    ...
    map(t, e) {
      ...
      return { mapped: i.length ? new mr(n, r, i, a) : null, pos: o };
    }
  },
  Qt = class {
    constructor(t, e, i, n) {
    ...
    update(t) {
      let {
        ...
        o = t.filter;
      if (e.length == 0 && !o) return this;
      if ((i && (e = e.slice().sort(Ea)), this.isEmpty))
        return e.length ? Qt.of(e) : this;
      let a = new Za(this, null, -1).goto(0),
        l = 0,
        h = [],
        c = new Fn();
      for (; a.value || l < e.length;)
        if (
          ...
          c.addChunk(this.chunkPos[a.chunkIndex], this.chunk[a.chunkIndex])
            ...
            : ((!o || n > a.to || r < a.from || o(a.from, a.to, a.value)) &&
                (c.addInner(a.from, a.to, a.value) ||
                  h.push(sn.create(a.from, a.to, a.value))),
              a.next());
      return c.finishInner(
        this.nextLayer.isEmpty && !h.length
          ? Qt.empty
    ...
    map(t) {
      ...
      let r = this.nextLayer.map(t);
      return e.length == 0 ? r : new Qt(i, e, r || Qt.empty, n);
    }
    between(t, e, i) {
      if (!this.isEmpty) {
        for (let n = 0; n < this.chunk.length; n++) {
    ...
    iter(t = 0) {
      return rn.from([this]).goto(t);
    }
    get isEmpty() {
      return this.nextLayer == this;
    }
    static iter(t, e = 0) {
      return rn.from(t).goto(e);
    }
    static compare(t, e, i, n, r = -1) {
      let o = t.filter(
          (f) => f.maxPoint > 0 || (!f.isEmpty && f.maxPoint >= r),
        ...
        h = new on(o, l, r),
        c = new on(a, l, r);
      (i.iterGaps((f, u, d) => pu(h, f, c, u, d, n)),
        i.empty && i.length == 0 && pu(h, 0, c, 0, 0, n));
    }
    static eq(t, e, i = 0, n) {
      n == null && (n = 1e9 - 1);
      let r = t.filter((c) => !c.isEmpty && e.indexOf(c) < 0),
      ...
      if (!r.length) return !0;
      let a = du(r, o),
        l = new on(r, a, 0).goto(i),
        h = new on(o, a, 0).goto(i);
      for (;;) {
        if (
          l.to != h.to ||
          !Xa(l.active, h.active) ||
          (l.point && (!h.point || !Aa(l.point, h.point)))
        )
          return !1;
        if (l.to > n) return !0;
        (l.next(), h.next());
    ...
    static of(t, e = !1) {
      let i = new Fn();
      for (let n of t instanceof sn ? [t] : e ? b0(t) : t)
        i.add(n.from, n.to, n.value);
      return i.finish();
    }
    static join(t) {
      if (!t.length) return Qt.empty;
      let e = t[t.length - 1];
      for (let i = t.length - 2; i >= 0; i--)
        for (let n = t[i]; n != Qt.empty; n = n.nextLayer)
          e = new Qt(n.chunkPos, n.chunk, e, Math.max(n.maxPoint, e.maxPoint));
      return e;
    }
  };
Qt.empty = new Qt([], [], null, -1);
function b0(s) {
  if (s.length > 1)
    for (let t = s[0], e = 1; e < s.length; e++) {
      let i = s[e];
      if (Ea(t, i) > 0) return s.slice().sort(Ea);
      t = i;
    }
  return s;
}
...
var Fn = class {
  ...
  add(t, e, i) {
    this.addInner(t, e, i) ||
      (this.nextLayer || (this.nextLayer = new Fn())).add(t, e, i);
  }
  addInner(t, e, i) {
    let n = t - this.lastTo || i.startSide - this.last.endSide;
    if (n <= 0 && (t - this.lastFrom || i.startSide - this.last.startSide) < 0)
...
var Za = class {
  ...
  rn = class {
    ...
    static from(t, e = null, i = -1) {
      ...
      for (let r = 0; r < t.length; r++)
        for (let o = t[r]; !o.isEmpty; o = o.nextLayer)
          o.maxPoint >= i && n.push(new Za(o, e, i, r));
      return n.length == 1 ? n[0] : new rn(n);
    }
    get startSide() {
      return this.value ? this.value.startSide : 0;
    }
    goto(t, e = -1e9) {
      for (let i of this.heap) i.goto(t, e);
      for (let i = this.heap.length >> 1; i >= 0; i--) Ma(this.heap, i);
      return (this.next(), this);
    }
    forward(t, e) {
      for (let i of this.heap) i.forward(t, e);
...
var on = class {
  ...
  removeActive(t) {
    (gr(this.active, t),
      gr(this.activeTo, t),
      gr(this.activeRank, t),
      (this.minActive = Ou(this.active, this.activeTo)));
  }
  addActive(t) {
    let e = 0,
      { value: i, to: n, rank: r } = this.cursor;
    for (
      ...
      e++;
    (br(this.active, e, i),
      br(this.activeTo, e, n),
      br(this.activeRank, e, r),
      t && br(t, e, this.cursor.from),
      (this.minActive = Ou(this.active, this.activeTo)));
  }
  next() {
    let t = this.to,
    ...
    if (
      (s.point || e.point
        ? ((s.point &&
            e.point &&
            Aa(s.point, e.point) &&
            Xa(s.activeForPoint(s.to), e.activeForPoint(e.to))) ||
            r.comparePoint(a, p, s.point, e.point),
          (c = !1))
        : (c && r.boundChange(a),
          p > a &&
            !Xa(s.active, e.active) &&
            r.compareRange(a, p, s.active, e.active),
          h && p < o && (f || s.openEnd(d) != e.openEnd(d)) && (c = !0)),
      d > o)
    )
      break;
    ((a = d), u <= 0 && s.next(), u >= 0 && e.next());
  }
}
function Xa(s, t) {
  if (s.length != t.length) return !1;
  for (let e = 0; e < s.length; e++)
    if (s[e] != t[e] && !Aa(s[e], t[e])) return !1;
  return !0;
}
function gr(s, t) {
  for (let e = t, i = s.length - 1; e < i; e++) s[e] = s[e + 1];
...
function Sr(s, t, e = s.length) {
  let i = 0;
  for (let n = 0; n < e && n < s.length;)
    s.charCodeAt(n) == 9 ? ((i += t - (i % t)), n++) : (i++, (n = Ne(s, n)));
  return i;
}
var S0 = (s) => {
  let { state: t } = s,
    e = t.doc.lineAt(t.selection.main.from),
    i = La(s.state, e.from);
  return i.line ? y0(s) : i.block ? v0(s) : !1;
};
function Ra(s, t) {
...
var y0 = Ra(Q0, 0);
var w0 = Ra(mu, 0);
var v0 = Ra((s, t) => mu(s, t, k0(t)), 0);
function La(s, t) {
  let e = s.languageDataAt("commentTokens", t, 1);
  return e.length ? e[0] : {};
}
var Hn = 50;
function x0(s, { open: t, close: e }, i, n) {
  let r = s.sliceDoc(i - Hn, i),
    o = s.sliceDoc(n, n + Hn),
    a = /\s*$/.exec(r)[0].length,
    l = /^\s*/.exec(o)[0].length,
    h = r.length - a;
  if (r.slice(h - t.length, h) == t && o.slice(l, l + e.length) == e)
    return {
  ...
  n - i <= 2 * Hn
    ? (c = f = s.sliceDoc(i, n))
    : ((c = s.sliceDoc(i, i + Hn)), (f = s.sliceDoc(n - Hn, n)));
  let u = /^\s*/.exec(c)[0].length,
    d = /\s*$/.exec(f)[0].length,
    p = f.length - d - e.length;
...
function k0(s) {
  ...
  for (let e of s.selection.ranges) {
    let i = s.doc.lineAt(e.from),
      n = e.to <= i.to ? i : s.doc.lineAt(e.to);
    n.from > i.from &&
      n.from == e.to &&
      (n = e.to == i.to + 1 ? i : s.doc.lineAt(e.to - 1));
    let r = t.length - 1;
    r >= 0 && t[r].to > i.from
      ? (t[r].to = n.to)
      : t.push({ from: i.from + /^\s*/.exec(i.text)[0].length, to: n.to });
  }
  return t;
}
function mu(s, t, e = t.selection.ranges) {
  let i = e.map((r) => La(t, r.from).block);
  if (!i.every((r) => r)) return null;
  let n = e.map((r, o) => x0(t, i[o], r.from, r.to));
  if (s != 2 && !n.every((r) => r))
    return {
      changes: t.changes(
        e.map((r, o) =>
    ...
    for (let o = 0, a; o < n.length; o++)
      if ((a = n[o])) {
        let l = i[o],
          { open: h, close: c } = a;
        r.push(
          { from: h.pos - l.open.length, to: h.pos + h.margin },
...
function Q0(s, t, e = t.selection.ranges) {
  let i = [],
    n = -1;
  ...
  if (s != 2 && i.some((r) => r.comment < 0 && (!r.empty || r.single))) {
    let r = [];
    for (let { line: a, token: l, indent: h, empty: c, single: f } of i)
...
var Ia = _e.define(),
  ...
  bu = We.define({
    ...
    update(s, t) {
      let e = t.state.facet(gu),
        i = t.annotation(Ia);
      if (i) {
        let l = At.fromTransaction(t, i.selection),
          h = i.side,
          c = h == 0 ? s.undone : s.done;
        return (
          l
            ? (c = vr(c, c.length, e.minDepth, l))
            : (c = wu(c, t.startState.selection)),
          new fe(h == 0 ? i.rest : c, h == 0 ? c : i.rest)
        );
      }
      let n = t.annotation(P0);
      if (
        ((n == "full" || n == "before") && (s = s.isolate()),
        t.annotation(ut.addToHistory) === !1)
      )
        return t.changes.empty ? s : s.addMapping(t.changes.desc);
      let r = At.fromTransaction(t),
        o = t.annotation(ut.time),
        a = t.annotation(ut.userEvent);
      return (
        r
          ? (s = s.addChanges(r, o, a, e, t))
          : t.selection &&
            (s = s.addSelection(t.startState.selection, o, a, e.newGroupDelay)),
        (n == "full" || n == "after") && (s = s.isolate()),
        s
      );
    },
    toJSON(s) {
      return {
        done: s.done.map((t) => t.toJSON()),
        undone: s.undone.map((t) => t.toJSON()),
      };
    },
    fromJSON(s) {
      return new fe(s.done.map(At.fromJSON), s.undone.map(At.fromJSON));
    },
  });
function Su(s = {}) {
  return [
    ...
    A.domEventHandlers({
      beforeinput(t, e) {
        let i =
          t.inputType == "historyUndo"
            ? wr
            : t.inputType == "historyRedo"
              ? Kn
              : null;
...
var At = class {
  ...
  toJSON() {
    ...
    return {
      changes:
        (t = this.changes) === null || t === void 0 ? void 0 : t.toJSON(),
  ...
  static fromJSON(t) {
    return new At(
      t.changes && dt.fromJSON(t.changes),
      [],
      t.mapped && Ft.fromJSON(t.mapped),
  ...
  static fromTransaction(t, e) {
    let i = Ht;
    for (let n of t.startState.facet($0)) {
      let r = n(t);
  ...
  static selection(t) {
    return new At(void 0, Ht, void 0, void 0, t);
  }
};
function vr(s, t, e, i) {
  let n = t + 1 > e + 20 ? t - e - 1 : 0,
    r = s.slice(n, t);
  return (r.push(i), r);
}
function A0(s, t) {
  let e = [],
    i = !1;
  return (
    s.iterChangedRanges((n, r) => e.push(n, r)),
    t.iterChangedRanges((n, r, o, a) => {
...
function E0(s, t) {
  return (
    s.ranges.length == t.ranges.length &&
    s.ranges.filter((e, i) => e.empty != t.ranges[i].empty).length === 0
  );
}
function yu(s, t) {
...
function wu(s, t) {
  if (s.length) {
    let e = s[s.length - 1],
      i = e.selectionsAfter.slice(Math.max(0, e.selectionsAfter.length - Z0));
    return i.length && i[i.length - 1].eq(t)
      ? s
      : (i.push(t), vr(s, s.length - 1, 1e9, e.setSelAfter(i)));
  } else return [At.selection([t])];
}
function M0(s) {
  let t = s[s.length - 1],
    e = s.slice();
  return (
    (e[s.length - 1] = t.setSelAfter(
...
function Da(s, t) {
  ...
  for (; e;) {
    ...
    if ((n.changes && !n.changes.empty) || n.effects.length) {
      let r = s.slice(0, e);
      return ((r[e - 1] = n), r);
    } else ((t = n.mapped), e--, (i = n.selectionsAfter));
  }
  return i.length ? [At.selection(i)] : Ht;
}
function X0(s, t, e) {
  let i = yu(
    s.selectionsAfter.length ? s.selectionsAfter.map((a) => a.map(t)) : Ht,
    e,
  );
  if (!s.changes) return At.selection(i);
  let n = s.changes.map(t),
    r = t.mapDesc(s.changes, !0),
    o = s.mapped ? s.mapped.composeDesc(r) : r;
  return new At(n, pt.mapEffects(s.effects, t), o, s.startSelection.map(r), i);
}
var R0 = /^(input\.type|delete)($|\.)/,
  fe = class {
    ...
    addChanges(t, e, i, n, r) {
      ...
      return (
        ...
        ((!a.selectionsAfter.length &&
          ...
          n.joinToEvent(r, A0(a.changes, t.changes))) ||
          ...
          ? (o = vr(
              ...
              new At(
                ...
                yu(pt.mapEffects(t.effects, a.changes), a.effects),
                a.mapped,
                a.startSelection,
                Ht,
              ),
            ))
          : (o = vr(o, o.length, n.minDepth, t)),
        new fe(o, Ht, e, i)
      );
    }
    addSelection(t, e, i, n) {
      ...
      return r.length > 0 &&
        ...
        E0(r[r.length - 1], t)
        ? this
        : new fe(wu(this.done, t), this.undone, e, i);
    }
    addMapping(t) {
      return new fe(
        Da(this.done, t),
    ...
    pop(t, e, i) {
      ...
      if (i && r.selectionsAfter.length)
        return e.update({
          ...
          annotations: Ia.of({ side: t, rest: M0(n), selection: o }),
          userEvent: t == 0 ? "select.undo" : "select.redo",
          scrollIntoView: !0,
        });
      if (r.changes) {
        let a = n.length == 1 ? Ht : n.slice(0, n.length - 1);
        return (
          r.mapped && (a = Da(a, r.mapped)),
          e.update({
            changes: r.changes,
            selection: r.startSelection,
            effects: r.effects,
            annotations: Ia.of({ side: t, rest: a, selection: o }),
            filter: !1,
...
fe.empty = new fe(Ht, Ht);
var vu = [
  { key: "Mod-z", run: wr, preventDefault: !0 },
  { key: "Mod-y", mac: "Mod-Shift-z", run: Kn, preventDefault: !0 },
  { linux: "Ctrl-Shift-z", run: Kn, preventDefault: !0 },
  { key: "Mod-u", run: T0, preventDefault: !0 },
  { key: "Alt-u", mac: "Mod-Shift-u", run: C0, preventDefault: !0 },
];
function an(s, t) {
  return Z.create(s.ranges.map(t), s.mainIndex);
}
function ue(s, t) {
  return s.update({ selection: t, scrollIntoView: !0, userEvent: "select" });
}
function de({ state: s, dispatch: t }, e) {
  let i = an(s.selection, e);
  return i.eq(s.selection, !0) ? !1 : (t(ue(s, i)), !0);
}
function xr(s, t) {
  return Z.cursor(t ? s.to : s.from);
}
function xu(s, t) {
  return de(s, (e) => (e.empty ? s.moveByChar(e, t) : xr(e, t)));
}
function Pt(s) {
  return s.textDirectionAt(s.state.selection.main.head) == it.LTR;
}
var ku = (s) => xu(s, !Pt(s)),
  Qu = (s) => xu(s, Pt(s));
function Pu(s, t) {
  return de(s, (e) => (e.empty ? s.moveByGroup(e, t) : xr(e, t)));
}
var L0 = (s) => Pu(s, !Pt(s)),
  I0 = (s) => Pu(s, Pt(s));
var Ww =
  typeof Intl != "undefined" && Intl.Segmenter
    ...
    : null;
function D0(s, t, e) {
  if (t.type.prop(e)) return !0;
  let i = t.to - t.from;
  return (
    (i && (i > 2 || /[^\s,.;:]/.test(s.sliceDoc(t.from, t.to)))) || t.firstChild
  );
}
function kr(s, t, e) {
  let i = F(s).resolveInner(t.head),
    n = e ? X.closedBy : X.openedBy;
  for (let l = t.head; ;) {
    let h = e ? i.childAfter(l) : i.childBefore(l);
    if (!h) break;
    D0(s, h, n) ? (i = h) : (l = e ? h.to : h.from);
  }
  let r = i.type.prop(n),
    o,
    a;
  return (
    r && (o = e ? Qi(s, i.from, 1) : Qi(s, i.to, -1)) && o.matched
      ? (a = e ? o.end.to : o.end.from)
      : (a = e ? i.to : i.from),
    Z.cursor(a, e ? -1 : 1)
  );
}
var B0 = (s) => de(s, (t) => kr(s.state, t, !Pt(s))),
  z0 = (s) => de(s, (t) => kr(s.state, t, Pt(s)));
function $u(s, t) {
  return de(s, (e) => {
    if (!e.empty) return xr(e, t);
...
var Tu = (s) => $u(s, !1),
  Cu = (s) => $u(s, !0);
function Au(s) {
  let t = s.scrollDOM.clientHeight < s.scrollDOM.scrollHeight - 2,
    e = 0,
    i = 0,
    n;
  if (t) {
    for (let r of s.state.facet(A.scrollMargins)) {
      let o = r(s);
      ((o == null ? void 0 : o.top) &&
        (e = Math.max(o == null ? void 0 : o.top, e)),
        (o == null ? void 0 : o.bottom) &&
          (i = Math.max(o == null ? void 0 : o.bottom, i)));
    }
    n = s.scrollDOM.clientHeight - e - i;
  } else n = (s.dom.ownerDocument.defaultView || window).innerHeight;
  return {
    marginTop: e,
    marginBottom: i,
    selfScroll: t,
...
function Eu(s, t) {
  let e = Au(s),
    { state: i } = s,
    n = an(i.selection, (o) =>
      o.empty ? s.moveVertically(o, t, e.height) : xr(o, t),
    );
  if (n.eq(i.selection)) return !1;
  let r;
  if (e.selfScroll) {
    let o = s.coordsAtPos(i.selection.main.head),
      a = s.scrollDOM.getBoundingClientRect(),
      l = a.top + e.marginTop,
      h = a.bottom - e.marginBottom;
    o &&
      o.top > l &&
      o.bottom < h &&
      (r = A.scrollIntoView(n.main.head, { y: "start", yMargin: o.top - l }));
  }
...
var Zu = (s) => Eu(s, !1),
  Ba = (s) => Eu(s, !0);
function li(s, t, e) {
  let i = s.lineBlockAt(t.head),
    n = s.moveToLineBoundary(t, e);
  if (
    (n.head == t.head &&
      n.head != (e ? i.to : i.from) &&
      (n = s.moveToLineBoundary(t, e, !1)),
    !e && n.head == i.from && i.length)
  ) {
    let r = /^\s*/.exec(
      s.state.sliceDoc(i.from, Math.min(i.from + 100, i.to)),
    )[0].length;
    r && t.head != i.from + r && (n = Z.cursor(i.from + r));
  }
  return n;
}
var V0 = (s) => de(s, (t) => li(s, t, !0)),
  j0 = (s) => de(s, (t) => li(s, t, !1)),
  Y0 = (s) => de(s, (t) => li(s, t, !Pt(s))),
  N0 = (s) => de(s, (t) => li(s, t, Pt(s))),
  q0 = (s) => de(s, (t) => Z.cursor(s.lineBlockAt(t.head).from, 1)),
  W0 = (s) => de(s, (t) => Z.cursor(s.lineBlockAt(t.head).to, -1));
function _0(s, t, e) {
  let i = !1,
    n = an(s.selection, (r) => {
      let o =
        Qi(s, r.head, -1) ||
        Qi(s, r.head, 1) ||
        (r.head > 0 && Qi(s, r.head - 1, 1)) ||
        (r.head < s.doc.length && Qi(s, r.head + 1, -1));
      if (!o || !o.end) return r;
      i = !0;
      let a = o.start.from == r.head ? o.end.to : o.end.from;
      return e ? Z.range(r.anchor, a) : Z.cursor(a);
    });
  return i ? (t(ue(s, n)), !0) : !1;
}
var G0 = ({ state: s, dispatch: t }) => _0(s, t, !1);
function Kt(s, t, e) {
  let i = an(s.state.selection, (n) => {
    n.undirectional &&
      n.head >= n.anchor != t &&
      (n = Z.range(n.head, n.anchor));
    let r = e(n);
    return Z.range(
      n.anchor,
      r.head,
  ...
  return i.eq(s.state.selection) ? !1 : (s.dispatch(ue(s.state, i)), !0);
}
function Mu(s, t) {
  return Kt(s, t, (e) => s.moveByChar(e, t));
}
var Xu = (s) => Mu(s, !Pt(s)),
  Ru = (s) => Mu(s, Pt(s));
function Lu(s, t) {
  return Kt(s, t, (e) => s.moveByGroup(e, t));
}
var U0 = (s) => Lu(s, !Pt(s)),
  F0 = (s) => Lu(s, Pt(s));
var H0 = (s) => {
    let t = !Pt(s);
    return Kt(s, t, (e) => kr(s.state, e, t));
  },
  K0 = (s) => {
    let t = Pt(s);
    return Kt(s, t, (e) => kr(s.state, e, t));
...
function Iu(s, t) {
  return Kt(s, t, (e) => s.moveVertically(e, t));
}
var Du = (s) => Iu(s, !1),
  Bu = (s) => Iu(s, !0);
function zu(s, t) {
  return Kt(s, t, (e) => s.moveVertically(e, t, Au(s).height));
}
var Vu = (s) => zu(s, !1),
  ju = (s) => zu(s, !0),
  J0 = (s) => Kt(s, !0, (t) => li(s, t, !0)),
  tb = (s) => Kt(s, !1, (t) => li(s, t, !1)),
  eb = (s) => {
    let t = !Pt(s);
    return Kt(s, t, (e) => li(s, e, t));
  },
  ib = (s) => {
    let t = Pt(s);
    return Kt(s, t, (e) => li(s, e, t));
  },
  nb = (s) => Kt(s, !1, (t) => Z.cursor(s.lineBlockAt(t.head).from)),
  sb = (s) => Kt(s, !0, (t) => Z.cursor(s.lineBlockAt(t.head).to)),
  Yu = ({ state: s, dispatch: t }) => (t(ue(s, { anchor: 0 })), !0),
  Nu = ({ state: s, dispatch: t }) => (t(ue(s, { anchor: s.doc.length })), !0),
  qu = ({ state: s, dispatch: t }) => (
    t(ue(s, { anchor: s.selection.main.anchor, head: 0 })),
    !0
  ),
  Wu = ({ state: s, dispatch: t }) => (
    t(ue(s, { anchor: s.selection.main.anchor, head: s.doc.length })),
    !0
  ),
  rb = ({ state: s, dispatch: t }) => (
    t(
      s.update({
        selection: { anchor: 0, head: s.doc.length },
        userEvent: "select",
      }),
    ),
    !0
  ),
  ob = ({ state: s, dispatch: t }) => {
    let e = Pr(s).map(({ from: i, to: n }) =>
      Z.range(i, Math.min(n + 1, s.doc.length)),
    );
    return (t(s.update({ selection: Z.create(e), userEvent: "select" })), !0);
  },
  ab = ({ state: s, dispatch: t }) => {
    let e = an(s.selection, (i) => {
      let n = F(s),
        r = n.resolveStack(i.from, 1);
      if (i.empty) {
    ...
    return e.eq(s.selection) ? !1 : (t(ue(s, e)), !0);
  };
function _u(s, t) {
  let { state: e } = s,
    i = e.selection,
    n = e.selection.ranges.slice();
  for (let r of e.selection.ranges) {
    let o = e.doc.lineAt(r.head);
    if (t ? o.to < s.state.doc.length : o.from > 0)
      for (let a = r; ;) {
        let l = s.moveVertically(a, t);
        if (l.head < o.from || l.head > o.to) {
          n.some((h) => h.head == l.head) || n.push(l);
          break;
        } else {
  ...
  return n.length == i.ranges.length
    ? !1
    : (s.dispatch(ue(e, Z.create(n, n.length - 1))), !0);
}
var lb = (s) => _u(s, !1),
  hb = (s) => _u(s, !0),
  cb = ({ state: s, dispatch: t }) => {
    let e = s.selection,
      i = null;
    return (
      e.ranges.length > 1
        ? (i = Z.create([e.main]))
        : e.main.empty || (i = Z.create([Z.cursor(e.main.head)])),
      i ? (t(ue(s, i)), !0) : !1
    );
  };
function Jn(s, t) {
  if (s.state.readOnly) return !1;
  let e = "delete.selection",
    { state: i } = s,
    n = i.changeByRange((r) => {
      let { from: o, to: a } = r;
      if (o == a) {
        let l = t(r);
        (l < o
          ? ((e = "delete.backward"), (l = Qr(s, l, !1)))
          : l > o && ((e = "delete.forward"), (l = Qr(s, l, !0))),
          (o = Math.min(o, l)),
          (a = Math.max(a, l)));
      } else ((o = Qr(s, o, !1)), (a = Qr(s, a, !0)));
      return o == a
        ? { range: r }
        : {
            changes: { from: o, to: a },
            range: Z.cursor(o, o < r.head ? -1 : 1),
          };
    });
...
var Gu = (s, t, e) =>
    Jn(s, (i) => {
      ...
      if (
        ...
        n > o.from &&
        n < o.from + 200 &&
        !/[^ \t]/.test((a = o.text.slice(0, n - o.from)))
      ) {
        if (a[a.length - 1] == "	") return n - 1;
        let h = Sr(a, r.tabSize),
          c = h % jn(r) || jn(r);
        for (let f = 0; f < c && a[a.length - 1 - f] == " "; f++) n--;
        l = n;
      } else
        ((l = Ne(o.text, n - o.from, t, t) + o.from),
          l == n && o.number != (t ? r.doc.lines : 1)
            ? (l += t ? 1 : -1)
            : !t &&
              /[\ufe00-\ufe0f]/.test(o.text.slice(l - o.from, n - o.from)) &&
              (l = Ne(o.text, l - o.from, !1, !1) + o.from));
      return l;
    }),
  za = (s) => Gu(s, !1, !0);
var Uu = (s) => Gu(s, !0, !1),
  Fu = (s, t) =>
    Jn(s, (e) => {
      let i = e.head,
        { state: n } = s,
        r = n.doc.lineAt(i),
        o = n.charCategorizer(i);
      for (let a = null; ;) {
        if (i == (t ? r.to : r.from)) {
          i == e.head && r.number != (t ? n.doc.lines : 1) && (i += t ? 1 : -1);
          break;
        }
        let l = Ne(r.text, i - r.from, t) + r.from,
          h = r.text.slice(Math.min(i, l) - r.from, Math.max(i, l) - r.from),
          c = o(h);
        if (a != null && c != a) break;
        ((h != " " || i != e.head) && (a = c), (i = l));
      }
...
var Ob = ({ state: s, dispatch: t }) => {
  ...
  mb = ({ state: s, dispatch: t }) => {
    ...
    let e = s.changeByRange((i) => {
      ...
      let n = i.from,
        r = s.doc.lineAt(n),
        o = n == r.from ? n - 1 : Ne(r.text, n - r.from, !1) + r.from,
        a = n == r.to ? n + 1 : Ne(r.text, n - r.from, !0) + r.from;
      return {
        changes: {
          from: o,
          to: a,
          insert: s.doc.slice(n, a).append(s.doc.slice(o, n)),
        },
        range: Z.cursor(a),
      };
    });
    return e.changes.empty
      ? !1
      : (t(s.update(e, { scrollIntoView: !0, userEvent: "move.character" })),
        !0);
  };
function Pr(s) {
  let t = [],
  ...
  for (let i of s.selection.ranges) {
    let n = s.doc.lineAt(i.from),
      r = s.doc.lineAt(i.to);
    if (
      (!i.empty && i.to == r.from && (r = s.doc.lineAt(i.to - 1)),
      e >= n.number)
    ) {
      let o = t[t.length - 1];
      ((o.to = r.to), o.ranges.push(i));
    } else t.push({ from: n.from, to: r.to, ranges: [i] });
    e = r.number + 1;
  }
  return t;
}
function Ku(s, t, e) {
  ...
  let i = [],
    n = [];
  for (let r of Pr(s)) {
    if (e ? r.to == s.doc.length : r.from == 0) continue;
    let o = s.doc.lineAt(e ? r.to + 1 : r.from - 1),
      a = o.length + 1;
    if (e) {
      i.push(
        { from: r.to, to: o.to },
        { from: r.from, insert: o.text + s.lineBreak },
      );
      for (let l of r.ranges)
        n.push(
          Z.range(
            Math.min(s.doc.length, l.anchor + a),
            Math.min(s.doc.length, l.head + a),
          ),
        );
    } else {
      i.push(
        { from: o.from, to: r.from },
        { from: r.to, insert: s.lineBreak + o.text },
      );
      for (let l of r.ranges) n.push(Z.range(l.anchor - a, l.head - a));
    }
  }
  return i.length
    ? (t(
        s.update({
          changes: i,
          scrollIntoView: !0,
          selection: Z.create(n, s.selection.mainIndex),
          userEvent: "move.line",
        }),
      ),
      !0)
...
var gb = ({ state: s, dispatch: t }) => Ku(s, t, !1),
  bb = ({ state: s, dispatch: t }) => Ku(s, t, !0);
function Ju(s, t, e) {
  if (s.readOnly) return !1;
  let i = [];
  for (let r of Pr(s))
    e
      ? i.push({
          from: r.from,
          insert: s.doc.slice(r.from, r.to) + s.lineBreak,
        })
      : i.push({ from: r.to, insert: s.lineBreak + s.doc.slice(r.from, r.to) });
  let n = s.changes(i);
  return (
    t(
      s.update({
...
var Sb = ({ state: s, dispatch: t }) => Ju(s, t, !1),
  yb = ({ state: s, dispatch: t }) => Ju(s, t, !0),
  wb = (s) => {
    if (s.state.readOnly) return !1;
    let { state: t } = s,
      e = t.changes(
      ...
      i = an(t.selection, (n) => {
        let r;
        if (s.lineWrapping) {
          let o = s.lineBlockAt(n.head),
            a = s.coordsAtPos(n.head, n.assoc || 1);
          a &&
            (r = o.bottom + s.documentTop - a.bottom + s.defaultLineHeight / 2);
        }
...
function vb(s, t) {
  ...
  return i &&
    ...
    i.to <= t &&
    n.from >= t &&
    (r = i.type.prop(X.closedBy)) &&
    r.indexOf(n.name) > -1 &&
    s.doc.lineAt(i.to).from == s.doc.lineAt(n.from).from &&
    !/\S/.test(s.sliceDoc(i.to, n.from))
    ? { from: i.to, to: n.from }
    : null;
}
var td = ed(!1),
  ...
  return ({ state: t, dispatch: e }) => {
    ...
    let i = t.changeByRange((n) => {
      let { from: r, to: o } = n,
        a = t.doc.lineAt(r),
        l = !s && r == o && vb(t, r);
      s && (r = o = (o <= a.to ? a : t.doc.lineAt(o)).to);
      let h = new Hi(t, { simulateBreak: r, simulateDoubleBreak: !!l }),
        c = fa(h, r);
      for (
        c == null && (c = Sr(/^\s*/.exec(t.doc.lineAt(r).text)[0], t.tabSize));
      ...
      l
        ...
        : r > a.from &&
          r < a.from + 100 &&
          !/\S/.test(a.text.slice(0, r)) &&
          (r = a.from);
      let f = ["", Yn(t, c)];
      return (
        l && f.push(Yn(t, h.lineIndent(a.from, -1))),
        {
          changes: { from: r, to: o, insert: st.of(f) },
          range: Z.cursor(r + 1 + f[1].length),
        }
      );
    });
...
function Va(s, t) {
  ...
  return s.changeByRange((i) => {
    ...
    return {
      changes: n,
      range: Z.range(r.mapPos(i.anchor, 1), r.mapPos(i.head, 1)),
    };
  });
}
var kb = ({ state: s, dispatch: t }) => {
    if (s.readOnly) return !1;
    let e = Object.create(null),
      i = new Hi(s, {
      ...
      n = Va(s, (r, o, a) => {
        ...
        let h = /^\s*/.exec(r.text)[0],
          c = Yn(s, l);
        (h != c || a.from < r.from + h.length) &&
          ((e[r.from] = l),
          o.push({ from: r.from, to: r.from + h.length, insert: c }));
      });
    return (n.changes.empty || t(s.update(n, { userEvent: "indent" })), !0);
  },
  Qb = ({ state: s, dispatch: t }) =>
    s.readOnly
      ? !1
      : (t(
          s.update(
            Va(s, (e, i) => {
              i.push({ from: e.from, insert: s.facet(ri) });
            }),
            { userEvent: "input.indent" },
          ),
        ),
        !0),
  Pb = ({ state: s, dispatch: t }) =>
    s.readOnly
      ? !1
      : (t(
          s.update(
            Va(s, (e, i) => {
              ...
              if (!n) return;
              let r = Sr(n, s.tabSize),
                o = 0,
                a = Yn(s, Math.max(0, r - jn(s)));
              for (
                ;
                o < n.length &&
                o < a.length &&
                n.charCodeAt(o) == a.charCodeAt(o);
              )
                o++;
              i.push({
                from: e.from + o,
        ...
        !0),
  $b = (s) => (s.setTabFocusMode(), !0);
var Tb = [
    { key: "Ctrl-b", run: ku, shift: Xu, preventDefault: !0 },
    { key: "Ctrl-f", run: Qu, shift: Ru },
    { key: "Ctrl-p", run: Tu, shift: Du },
    { key: "Ctrl-n", run: Cu, shift: Bu },
    { key: "Ctrl-a", run: q0, shift: nb },
    { key: "Ctrl-e", run: W0, shift: sb },
    { key: "Ctrl-d", run: Uu },
    { key: "Ctrl-h", run: za },
    { key: "Ctrl-k", run: ub },
  ...
  Cb = [
    { key: "ArrowLeft", run: ku, shift: Xu, preventDefault: !0 },
    {
      key: "Mod-ArrowLeft",
      mac: "Alt-ArrowLeft",
      run: L0,
    ...
    { mac: "Cmd-ArrowLeft", run: Y0, shift: eb, preventDefault: !0 },
    { key: "ArrowRight", run: Qu, shift: Ru, preventDefault: !0 },
    {
      key: "Mod-ArrowRight",
      mac: "Alt-ArrowRight",
      run: I0,
    ...
    { mac: "Cmd-ArrowRight", run: N0, shift: ib, preventDefault: !0 },
    { key: "ArrowUp", run: Tu, shift: Du, preventDefault: !0 },
    { mac: "Cmd-ArrowUp", run: Yu, shift: qu },
    { mac: "Ctrl-ArrowUp", run: Zu, shift: Vu },
    { key: "ArrowDown", run: Cu, shift: Bu, preventDefault: !0 },
    { mac: "Cmd-ArrowDown", run: Nu, shift: Wu },
    { mac: "Ctrl-ArrowDown", run: Ba, shift: ju },
    { key: "PageUp", run: Zu, shift: Vu },
    { key: "PageDown", run: Ba, shift: ju },
    { key: "Home", run: j0, shift: tb, preventDefault: !0 },
    { key: "Mod-Home", run: Yu, shift: qu },
    { key: "End", run: V0, shift: J0, preventDefault: !0 },
    { key: "Mod-End", run: Nu, shift: Wu },
    { key: "Enter", run: td, shift: td },
    { key: "Mod-a", run: rb },
    { key: "Backspace", run: za, shift: za, preventDefault: !0 },
    { key: "Delete", run: Uu, preventDefault: !0 },
    { key: "Mod-Backspace", mac: "Alt-Backspace", run: Hu, preventDefault: !0 },
    { key: "Mod-Delete", mac: "Alt-Delete", run: fb, preventDefault: !0 },
    { mac: "Mod-Backspace", run: db, preventDefault: !0 },
    { mac: "Mod-Delete", run: pb, preventDefault: !0 },
  ].concat(Tb.map((s) => ({ mac: s.key, run: s.run, shift: s.shift }))),
  id = [
    { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: B0, shift: H0 },
    { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: z0, shift: K0 },
    { key: "Alt-ArrowUp", run: gb },
    { key: "Shift-Alt-ArrowUp", run: Sb },
    { key: "Alt-ArrowDown", run: bb },
    { key: "Shift-Alt-ArrowDown", run: yb },
    { key: "Mod-Alt-ArrowUp", run: lb },
    { key: "Mod-Alt-ArrowDown", run: hb },
    { key: "Escape", run: cb },
    { key: "Mod-Enter", run: xb },
    { key: "Alt-l", mac: "Ctrl-l", run: ob },
    { key: "Mod-i", run: ab, preventDefault: !0 },
    { key: "Mod-[", run: Pb },
    { key: "Mod-]", run: Qb },
    { key: "Mod-Alt-\\", run: kb },
    { key: "Shift-Mod-k", run: wb },
    { key: "Shift-Mod-\\", run: G0 },
    { key: "Mod-/", run: S0 },
    { key: "Alt-A", run: w0 },
    { key: "Ctrl-m", mac: "Shift-Alt-m", run: $b },
  ].concat(Cb);
var ja = class {
  constructor(t, e, i, n) {
    ((this.state = t),
  ...
  tokenBefore(t) {
    let e = F(this.state).resolveInner(this.pos, -1);
...
function Ab(s) {
  ...
  for (let { label: n } of s) {
    t[n[0]] = !0;
    for (let r = 1; r < n.length; r++) e[n[r]] = !0;
  }
  let i = nd(t) + nd(e) + "*$";
  return [new RegExp("^" + i), new RegExp(i)];
}
function sd(s) {
  let t = s.map((n) => (typeof n == "string" ? { label: n } : n)),
    [e, i] = t.every((n) => /^\w+$/.test(n.label)) ? [/\w*$/, /\w+$/] : Ab(t);
  return (n) => {
    let r = n.matchBefore(i);
    return r || n.explicit
      ? { from: r ? r.from : n.pos, options: t, validFor: e }
      : null;
  };
}
function rd(s, t) {
  return (e) => {
    for (let i = F(e.state).resolveInner(e.pos, -1); i; i = i.parent) {
      if (s.indexOf(i.name) > -1) return null;
...
function Eb(s, t) {
  ...
  return !n && !r
    ...
    : new RegExp(
        `${n ? "^" : ""}(?:${i})${r ? "$" : ""}`,
        (e = s.flags) !== null && e !== void 0 ? e : s.ignoreCase ? "i" : "",
      );
}
var Zb = Se.define();
var tv = typeof navigator == "object" && /Win/.test(navigator.platform);
var Mb = A.baseTheme({
  ...
  $r = class {
    ...
    map(t) {
      let e = t.mapPos(this.from, -1, gt.TrackDel),
        i = t.mapPos(this.to, 1, gt.TrackDel);
      return e == null || i == null ? null : new $r(this.field, e, i);
    }
  },
  Tr = class {
    constructor(t, e) {
    ...
    instantiate(t, e) {
      ...
      for (let l of this.lines) {
        if (i.length) {
          let h = o,
            c = /^\t*/.exec(l)[0].length;
          for (let f = 0; f < c; f++) h += t.facet(ri);
          (n.push(e + h.length - c), (l = h + l.slice(c)));
        }
        (i.push(l), (e += l.length + 1));
      }
      let a = this.fieldPositions.map(
        (l) => new $r(l.field, n[l.line] + l.from, n[l.line] + l.to),
      );
      ...
      for (let o of t.split(/\r\n?|\n/)) {
        for (
          ...
          for (let f = 0; f < e.length; f++)
            (a != null ? e[f].seq == a : c ? e[f].name == c : !1) && (h = f);
          if (h < 0) {
            let f = 0;
            for (
              ;
              f < e.length && (a == null || (e[f].seq != null && e[f].seq < a));
            )
              f++;
            (e.splice(f, 0, { seq: a, name: c }), (h = f));
            for (let u of n) u.field >= h && u.field++;
          }
          for (let f of n)
          ...
          (n.push(new od(h, i.length, r.index, r.index + c.length)),
            (o = o.slice(0, r.index) + l + o.slice(r.index + r[0].length)));
        }
        ((o = o.replace(/\\([{}])/g, (a, l, h) => {
          for (let c of n)
  ...
  Rb = q.mark({ class: "cm-snippetField" }),
  $i = class {
    constructor(t, e) {
      ((this.ranges = t),
        (this.active = e),
        (this.deco = q.set(
          t.map((i) => (i.from == i.to ? Xb : Rb).range(i.from, i.to)),
          !0,
        )));
    }
    map(t) {
      ...
      return new $i(e, this.active);
    }
    selectionInsideField(t) {
      return t.ranges.every((e) =>
        this.ranges.some(
          (i) => i.field == this.active && i.from <= e.from && i.to >= e.to,
        ),
      );
    }
  },
  ...
  es = Wt.define({
    ...
    update(s, t) {
      for (let e of t.effects) {
        if (e.is(ts)) return e.value;
        if (e.is(Lb) && s) return new $i(s.ranges, e.value);
      }
      return (
        s && t.docChanged && (s = s.map(t.changes)),
        s && t.selection && !s.selectionInsideField(t.selection) && (s = null),
        s
      );
    },
    provide: (s) => A.decorations.from(s, (t) => (t ? t.deco : q.none)),
  });
function Ya(s, t) {
  return k.create(
    s.filter((e) => e.field == t).map((e) => k.range(e.from, e.to)),
  );
}
function Ib(s) {
  let t = Tr.parse(s);
  return (e, i, n, r) => {
    let { text: o, ranges: a } = t.instantiate(e.state, n),
      { main: l } = e.state.selection,
      h = {
        changes: { from: n, to: r == l.from ? l.to : r, insert: B.of(o) },
        scrollIntoView: !0,
        annotations: i ? [Zb.of(i), ct.userEvent.of("input.complete")] : void 0,
      };
    if ((a.length && (h.selection = Ya(a, 0)), a.some((c) => c.field > 0))) {
      let c = new $i(a, 0),
        f = (h.effects = [ts.of(c)]);
      e.state.field(es, !1) === void 0 &&
        f.push(tt.appendConfig.of([es, jb, Yb, Mb]));
    }
...
function ad(s) {
  return ({ state: t, dispatch: e }) => {
    let i = t.field(es, !1);
    if (!i || (s < 0 && i.active == 0)) return !1;
    let n = i.active + s,
      r = s > 0 && !i.ranges.some((o) => o.field == n + s);
    return (
      e(
        t.update({
          selection: Ya(i.ranges, n),
          effects: ts.of(r ? null : new $i(i.ranges, n)),
          scrollIntoView: !0,
        }),
      ),
      !0
...
var Db = ({ state: s, dispatch: t }) =>
    s.field(es, !1) ? (t(s.update({ effects: ts.of(null) })), !0) : !1,
  Bb = ad(1),
  zb = ad(-1);
var Vb = [
    { key: "Tab", run: Bb, shift: zb },
    { key: "Escape", run: Db },
  ],
  ld = M.define({
    combine(s) {
      return s.length ? s[0] : Vb;
    },
  }),
  jb = be.highest(Be.compute([ld], (s) => s.facet(ld)));
function Et(s, t) {
  return { ...t, apply: Ib(s) };
}
var Yb = A.domEventHandlers({
  mousedown(s, t) {
    ...
    return !n || n.field == e.active
      ? !1
      : (t.dispatch({
          selection: Ya(e.ranges, n.field),
          effects: ts.of(
            e.ranges.some((r) => r.field > n.field)
              ? new $i(e.ranges, n.field)
              : null,
          ),
          scrollIntoView: !0,
        }),
...
var hd = new (class extends ye {})();
hd.startSide = 1;
hd.endSide = -1;
var ev = typeof navigator == "object" && /Android\b/.test(navigator.userAgent);
var cd = (() => [
  uf(),
  Su(),
  af(),
...
var fd = A.baseTheme({
    ...
    ".cm-strong": { "font-weight": "bold", color: "var(--bold-color)" },
    ".cm-strikethrough": {
  ...
  Nb = ki.define([
    { tag: m.heading1, class: "cm-header cm-header-1" },
    { tag: m.heading2, class: "cm-header cm-header-2" },
    { tag: m.heading3, class: "cm-header cm-header-3" },
    { tag: m.heading4, class: "cm-header cm-header-4" },
    { tag: m.heading5, class: "cm-header cm-header-5" },
    { tag: m.heading6, class: "cm-header cm-header-6" },
    { tag: m.angleBracket, class: "cm-html-embed cm-embed-block" },
    { tag: m.squareBracket, class: "cm-hmd-barelink cm-link" },
    { tag: m.paren, class: "cm-inline-code" },
    { tag: m.emphasis, class: "cm-em" },
    { tag: m.strong, class: "cm-strong" },
    { tag: m.quote, class: "cm-formatting cm-formatting-quote cm-quote" },
  ]),
  ud = fr(Nb);
function dd(s, t = "") {
  let e = 3;
...
function Rt(s, t, e) {
  return (
    (e = e || t),
    s.length <= t.length + e.length
      ? t + s + e
      : s.substring(0, t.length) == t && s.substring(s.length - e.length) == e
        ? s.substring(t.length, s.length - e.length)
        : t + s + e
  );
}
...
var pd = te(require("obsidian")),
  Na = class extends pd.Menu {
    ...
    onload() {
      super.onload();
      let t = this.dom,
        e = activeDocument.createDocumentFragment(),
        i = e.createDiv({ cls: "table-generator-container" }),
        n = e.createDiv({ cls: ["table-generator-counter", "menu-item"] });
      for (let r = 0; r < 7; r++)
        for (let o = 0; o < 7; o++) {
          let a = createDiv({ cls: "table-generator-grid" });
          (a.setAttr("i", r),
            a.setAttr("j", o),
            a.addEventListener("click", () => {
              this.editor.createEmptyTable(r + 1, o + 1);
            }),
            this.editor.plugin.registerDomEvent(a, "mouseenter", () => {
              (i.querySelectorAll(".table-generator-grid").forEach((l) => {
                let h = l.getAttr("i"),
                  c = l.getAttr("j");
                if (!h || !c) return;
                let f = parseInt(h),
                  u = parseInt(c);
                f > r || u > o ? l.removeClass("select") : l.addClass("select");
              }),
                (n.innerText = `${r + 1} rows ${o + 1} columns`));
            }),
            i.append(a));
        }
      t.append(e);
...
var is = class {
    constructor(t, e, i, n, r, o, a, l, h, c = 0, f) {
      ((this.p = t),
        (this.stack = e),
        (this.state = i),
        (this.reducePos = n),
    ...
    reduce(t) {
      ...
      if ((a && (this.score += a), i == 0)) {
        (n < r.minRepeatTerm &&
          ...
          n < r.minRepeatTerm &&
            this.storeNode(n, this.reducePos, this.reducePos, o ? 8 : 4, !0),
          this.reduceContext(n, this.reducePos));
        return;
      }
      let l = this.stack.length - (i - 1) * 3 - (t & 262144 ? 6 : 0),
      ...
      c >= 2e3 &&
        !((e = this.p.parser.nodeSet.types[n]) === null || e === void 0
          ? void 0
          : e.isAnonymous) &&
      ...
      if (t & 262144) this.state = this.stack[l];
      else {
    ...
    storeNode(t, e, i, n = 4, r = !1) {
      ...
      if (!r || this.pos == i) this.buffer.push(t, e, i, n);
      else {
        let o = this.buffer.length;
    ...
    shift(t, e, i, n) {
      if (t & 131072) this.pushState(t & 65535, this.pos);
        ...
        let r = t,
          { parser: o } = this.p;
        this.pos = n;
        let a = o.stateFlag(r, 1);
        (!a && (n > i || e <= o.maxNode) && (this.reducePos = n),
          this.pushState(r, a ? i : Math.min(i, this.reducePos)),
          this.shiftContext(e, i),
          e <= o.maxNode && this.buffer.push(e, i, n, 4));
      } else
        ((this.pos = n),
          this.shiftContext(e, i),
    ...
    split() {
      let t = this,
        e = t.buffer.length;
      for (
        e && t.buffer[e - 4] == 0 && (e -= 4);
        e > 0 && t.buffer[e - 2] > t.reducePos;
      )
        e -= 4;
    ...
    recoverByInsert(t) {
      ...
      if (e.length > 4 << 1 || this.stack.length >= 120) {
        ...
        for (let r = 0, o; r < e.length; r += 2)
          (o = e[r + 1]) != this.state &&
            this.p.parser.hasAction(o, t) &&
            n.push(e[r], o);
        if (this.stack.length < 120)
          for (let r = 0; n.length < 4 << 1 && r < e.length; r += 2) {
            let o = e[r + 1];
            n.some((a, l) => l & 1 && a == o) || n.push(e[r], o);
          }
        e = n;
      }
      let i = [];
    ...
    get deadEnd() {
      ...
      let { parser: t } = this.p;
      return (
        t.data[t.stateSlot(this.state, 1)] == 65535 &&
    ...
    updateContext(t) {
      if (t != this.curContext.context) {
        let e = new qa(this.curContext.tracker, t);
        (e.hash != this.curContext.hash && this.emitContext(),
          (this.curContext = e));
      }
    }
    setLookAhead(t) {
      return t <= this.lookAhead
        ? !1
        : (this.emitLookAhead(), (this.lookAhead = t), !0);
    }
    close() {
  ...
  ns = class {
    ...
    static create(t, e = t.bufferBase + t.buffer.length) {
      return new ns(t, e, e - t.bufferBase);
    }
    maybeNext() {
...
var rs = class {
  ...
  Ti = class {
    ...
    token(t, e) {
      let { parser: i } = e.p;
      bd(this.data, t, e, this.id, i.data, i.tokenPrecTable);
    }
  };
...
var Ci = class {
  constructor(t, e, i) {
    ((this.precTable = e),
      (this.elseToken = i),
      (this.data = typeof t == "string" ? ss(t) : t));
  }
  token(t, e) {
    let i = t.pos,
      n = 0;
    for (;;) {
      let r = t.next < 0,
        o = t.resolveOffset(1, 1);
      if (
        (bd(this.data, t, e, 0, this.data, this.precTable), t.token.value > -1)
      )
        break;
...
Ci.prototype.contextual = Ti.prototype.fallback = Ti.prototype.extend = !1;
var wt = class {
  constructor(t, e = {}) {
    ((this.token = t),
...
function Sd(s, t, e) {
  for (let i = t, n; (n = s[i]) != 65535; i++) if (n == e) return i - t;
  return -1;
}
function qb(s, t, e, i) {
  let n = Sd(e, i, t);
  return n < 0 || Sd(e, i, s) < n;
}
var jt =
  ...
  Wa = null;
function yd(s, t, e) {
  let i = s.cursor(V.IncludeAnonymous);
  for (i.moveTo(t); ;)
      ...
      for (;;) {
        if ((e < 0 ? i.to < t : i.from > t) && !i.type.isError)
          return e < 0
            ...
            : Math.min(s.length, Math.max(i.from + 1, t + 25));
        if (e < 0 ? i.prevSibling() : i.nextSibling()) break;
        if (!i.parent()) return e < 0 ? 0 : s.length;
      }
}
var wd = class {
    constructor(t, e) {
      ...
      if (t) {
        for (
          this.safeFrom = t.openStart
            ? yd(t.tree, t.from + t.offset, 1) - t.offset
            : t.from,
            this.safeTo = t.openEnd
              ? yd(t.tree, t.to + t.offset, -1) - t.offset
              : t.to;
          this.trees.length;
        )
      ...
      for (;;) {
        ...
        if (r instanceof z) {
          if (o == t) {
            ...
            let a = o + r.length;
            if (a <= this.safeTo) {
              let l = r.prop(X.lookAhead);
              if (!l || a + l < this.fragment.to) return r;
            }
          }
          (this.index[e]++,
            o + r.length >= Math.max(this.safeFrom, t) &&
  ...
  vd = class {
    constructor(t, e) {
      ((this.stream = e),
        ...
        (this.mainToken = null),
        (this.actions = []),
        (this.tokens = t.tokenizers.map((i) => new rs())));
    }
    getActions(t) {
      let e = 0,
        i = null,
      ...
      for (let h = 0; h < r.length; h++) {
        ...
        if (
          ...
          ((c.contextual ||
            ...
            f.mask != o ||
            f.context != a) &&
            (this.updateCachedToken(f, c, t), (f.mask = o), (f.context = a)),
      ...
      if ((e.token(this.stream.reset(n, t), i), t.value > -1)) {
        ...
        for (let o = 0; o < r.specialized.length; o++)
          if (r.specialized[o] == t.value) {
            let a = r.specializers[o](this.stream.read(t.start, t.end), i);
    ...
    putAction(t, e, i, n) {
      for (let r = 0; r < n; r += 3) if (this.actions[r] == t) return n;
      return (
        (this.actions[n++] = t),
        (this.actions[n++] = e),
        (this.actions[n++] = i),
    ...
    addActions(t, e, i, n) {
      let { state: r } = t,
        ...
        { data: a } = o;
      for (let l = 0; l < 2; l++)
        for (let h = o.stateSlot(r, l ? 2 : 1); ; h += 3) {
          if (a[h] == 65535)
            if (a[h + 1] == 1) h = Ue(a, h + 2);
            else {
              n == 0 &&
                a[h + 1] == 2 &&
                (n = this.putAction(Ue(a, h + 2), e, i, n));
              break;
            }
          a[h] == e && (n = this.putAction(Ue(a, h + 1), e, i, n));
        }
      return n;
    }
  },
  xd = class {
    constructor(t, e, i, n) {
      ((this.parser = t),
        ...
        (this.stream = new gd(e, n)),
        (this.tokens = new vd(t, this.stream)),
        (this.topTerm = t.top[1]));
      let { from: r } = n[0];
      ((this.stacks = [is.start(this, t.top[0], r)]),
        (this.fragments =
          i.length && this.stream.end - r > t.bufferLength * 4
            ? new wd(i, t.nodeSet)
            : null));
    }
    get parsedPos() {
    ...
    advance() {
      ...
      for (let o = 0; o < t.length; o++) {
        let a = t[o];
        for (;;) {
          if (((this.tokens.mainToken = null), a.pos > e)) i.push(a);
          else {
            if (this.advanceStack(a, i, t)) continue;
            {
              (n || ((n = []), (r = [])), n.push(a));
      ...
      if (!i.length) {
        ...
        if (o)
          return (
            jt && console.log("Finish with " + this.stackID(o)),
            this.stackToTree(o)
          );
      ...
      if (this.recovering && n) {
        let o =
          this.stoppedAt != null && n[0].pos > this.stoppedAt
            ? n[0]
            : this.runRecovery(n, r, i);
        if (o)
          return (
            jt && console.log("Force-finish " + this.stackID(o)),
      ...
      if (this.recovering) {
        ...
        i.length > 12 &&
          (i.sort((o, a) => a.score - o.score), i.splice(12, i.length - 12));
      }
    ...
    advanceStack(t, e, i) {
      ...
      if (this.fragments) {
        let h = t.curContext && t.curContext.tracker.strict,
          c = h ? t.curContext.hash : 0;
        for (let f = this.fragments.nodeAt(n); f;) {
          let u =
            this.parser.nodeSet.types[f.type.id] == f.type
              ? r.getGoto(t.state, f.type.id)
              : -1;
          if (u > -1 && f.length && (!h || (f.prop(X.contextHash) || 0) == c))
            return (
              t.useNode(f, u),
              jt &&
                console.log(
          ...
          if (!(f instanceof z) || f.children.length == 0 || f.positions[0] > 0)
            break;
          let d = f.children[0];
        ...
        return (
          ...
          jt &&
            console.log(
              o +
                this.stackID(t) +
                ` (via always-reduce ${r.getName(a & 65535)})`,
            ),
          !0
        );
        ...
        if (
          ...
          jt &&
            console.log(
              o +
                this.stackID(p) +
                ` (via ${(c & 65536) == 0 ? "shift" : `reduce of ${r.getName(c & 65535)}`} for ${r.getName(f)} @ ${n}${p == t ? "" : ", split"})`,
            ),
          d)
        )
          return !0;
      ...
      for (let o = 0; o < t.length; o++) {
        ...
        if (
          ...
          (r ||
            ((r = !0),
            a.restart(),
            jt && console.log(c + this.stackID(a) + " (restarted)"),
        ...
        for (
          ...
          d < 10 &&
          f.forceReduce() &&
          (jt && console.log(u + this.stackID(f) + " (via force-reduce)"),
          !this.advanceFully(f, i));
          d++
        )
          jt && (u = this.stackID(f) + " -> ");
        for (let d of a.recoverByInsert(l))
          (jt && console.log(c + this.stackID(d) + " (via recover-insert)"),
            this.advanceFully(d, i));
        this.stream.end > a.pos
          ? (h == a.pos && (h++, (l = 0)),
            a.recoverByDelete(l, h),
            jt &&
              console.log(
                c +
                  this.stackID(a) +
    ...
    stackID(t) {
      let e = (Wa || (Wa = new WeakMap())).get(t);
      return (
        e || Wa.set(t, (e = String.fromCodePoint(this.nextStackID++))),
        e + t
      );
    }
  };
...
var Qd = class {
  ...
  os = class {
    constructor(t) {
      ((this.start = t.start),
        (this.shift = t.shift || _a),
        (this.reduce = t.reduce || _a),
        (this.reuse = t.reuse || _a),
        (this.hash = t.hash || (() => 0)),
  ...
  Ee = class extends yi {
    constructor(t) {
      ...
      let i = Object.keys(t.topRules).map((a) => t.topRules[a][1]),
        n = [];
      for (let a = 0; a < e.length; a++) n.push([]);
      function r(a, l, h) {
        n[a].push([l, l.deserialize(String(h))]);
      }
      if (t.nodeProps)
        for (let a of t.nodeProps) {
          let l = a[0];
          typeof l == "string" && (l = X[l]);
          for (let h = 1; h < a.length;) {
            let c = a[h++];
            if (c >= 0) r(c, l, a[h++]);
            else {
              let f = a[h + -c];
              for (let u = -c; u > 0; u--) r(a[h++], l, f);
              h++;
            }
          }
        }
      ((this.nodeSet = new ze(
        ...
        (this.strict = !1),
        (this.bufferLength = Ko));
      let o = ss(t.tokenData);
      ...
      ((this.specializers = this.specializerSpecs.map(Pd)),
        (this.states = ss(t.states, Uint32Array)),
        (this.data = ss(t.stateData)),
        (this.goto = ss(t.goto)),
        (this.maxTerm = t.maxTerm),
        (this.tokenizers = t.tokenizers.map((a) =>
          typeof a == "number" ? new Ti(o, a) : a,
        )),
    ...
    getGoto(t, e, i = !1) {
      ...
      for (let r = n[e + 1]; ;) {
        let o = n[r++],
          ...
          l = n[r++];
        if (a && i) return l;
        for (let h = r + (o >> 1); r < h; r++) if (n[r] == t) return l;
        if (a) return -1;
      }
    }
    hasAction(t, e) {
      ...
      for (let n = 0; n < 2; n++)
        for (let r = this.stateSlot(t, n ? 2 : 1), o; ; r += 3) {
          if ((o = i[r]) == 65535)
            if (i[r + 1] == 1) o = i[(r = Ue(i, r + 2))];
            else {
              if (i[r + 1] == 2) return Ue(i, r + 2);
              break;
            }
          if (o == e || o == 0) return Ue(i, r + 1);
        }
      return 0;
    }
    stateSlot(t, e) {
    ...
    allActions(t, e) {
      ...
      for (let r = this.stateSlot(t, 1); n == null; r += 3) {
        if (this.data[r] == 65535)
          if (this.data[r + 1] == 1) r = Ue(this.data, r + 2);
          else break;
        n = e(Ue(this.data, r + 1));
      }
      return n;
    }
    nextStates(t) {
      ...
      for (let i = this.stateSlot(t, 1); ; i += 3) {
        if (this.data[i] == 65535)
          if (this.data[i + 1] == 1) i = Ue(this.data, i + 2);
          else break;
    ...
    configure(t) {
      let e = Object.assign(Object.create(Ee.prototype), this);
      ...
      return (
        t.tokenizers &&
          (e.tokenizers = this.tokenizers.map((i) => {
        ...
        t.specializers &&
          ...
          (e.specializerSpecs = this.specializerSpecs.map((i, n) => {
            let r = t.specializers.find((a) => a.from == i.external);
            if (!r) return i;
            let o = Object.assign(Object.assign({}, i), { external: r.to });
            return ((e.specializers[n] = Pd(o)), o);
          }))),
    ...
    parseDialect(t) {
      ...
      for (let r = 0; r < e.length; r++)
        if (!i[r])
          for (let o = this.dialects[e[r]], a; (a = this.data[o++]) != 65535;)
...
function Wb(s) {
  ...
  for (let e of s) {
    let i = e.p.stoppedAt;
    (e.pos == e.p.stream.end || (i != null && e.pos > i)) &&
...
function Ha(s, t) {
  let e = s.pos + t;
  if (Bd == e && Dd == s) return Id;
  let i = s.peek(t),
    n = "";
  for (; m1(i);) ((n += String.fromCharCode(i)), (i = s.peek(++t)));
  return (
    (Dd = s),
    (Bd = e),
    (Id = n ? n.toLowerCase() : i == g1 || i == b1 ? void 0 : null)
  );
}
var zd = 60,
  Cr = 62,
...
var y1 = [Ga, Ed, Td, Cd, Ad],
  w1 = new os({
    start: null,
    shift(s, t, e, i) {
      return y1.indexOf(t) > -1 ? new Vd(Ha(i, 1) || "", s) : s;
    },
    reduce(s, t) {
      return t == Md && s ? s.parent : s;
    },
    reuse(s, t, e, i) {
      let n = t.type.id;
      return n == Ga || n == c1 ? new Vd(Ha(i, 1) || "", s) : s;
    },
    strict: !1,
  }),
  v1 = new wt(
    (s, t) => {
      if (s.next != zd) {
        s.next < 0 && t.context && s.acceptToken(Ua);
        return;
      }
      s.advance();
      let e = s.next == Ka;
      ...
      let i = Ha(s, 0);
      if (i === void 0) return;
      if (!i) return s.acceptToken(e ? s1 : n1);
      let n = t.context ? t.context.name : null;
      if (e) {
        if (i == n) return s.acceptToken(t1);
        if (n && O1[n]) return s.acceptToken(Ua, -2);
        if (t.dialectEnabled(u1)) return s.acceptToken(e1);
        for (let r = t.context; r; r = r.parent) if (r.name == i) return;
        s.acceptToken(i1);
      } else {
        if (i == "script") return s.acceptToken(Td);
        if (i == "style") return s.acceptToken(Cd);
        if (i == "textarea") return s.acceptToken(Ad);
        if (p1.hasOwnProperty(i)) return s.acceptToken(Ed);
        n && Ld[n] && Ld[n][i] ? s.acceptToken(Ua, -1) : s.acceptToken(Ga);
      }
    },
    { contextual: !0 },
  ),
  x1 = new wt((s) => {
    for (let t = 0, e = 0; ; e++) {
      ...
      if (s.next == S1) t++;
      else if (s.next == Cr && t >= 2) {
        e >= 3 && s.acceptToken(Zd, -2);
        break;
      } else t = 0;
      s.advance();
    }
...
function k1(s) {
  for (; s; s = s.parent) if (s.name == "svg" || s.name == "math") return !0;
  return !1;
}
var Q1 = new wt((s, t) => {
  if (s.next == Ka && s.peek(1) == Cr) {
    let e = t.dialectEnabled(d1) || k1(t.context);
    s.acceptToken(e ? Jb : $d, 2);
  } else s.next == Cr && s.acceptToken($d, 1);
});
function Ja(s, t, e) {
  let i = 2 + s.length;
  return new wt((n) => {
    for (let r = 0, o = 0, a = 0; ; a++) {
      ...
      if (
        (r == 0 && n.next == zd) ||
        (r == 1 && n.next == Ka) ||
        (r >= 2 && r < i && n.next == s.charCodeAt(r - 2))
      )
        (r++, o++);
      else if (r == i && n.next == Cr) {
...
var P1 = Ja("script", _b, Gb),
  $1 = Ja("style", Ub, Fb),
  T1 = Ja("textarea", Hb, Kb),
  C1 = he({
  ...
  jd = Ee.deserialize({
    ...
    tokenizers: [P1, $1, T1, Q1, v1, x1, 0, 1, 2, 3, 4, 5],
...
function Yd(s, t) {
  let e = Object.create(null);
  for (let i of s.getChildren(Xd)) {
    let n = i.getChild(o1),
      r = i.getChild(Fa) || i.getChild(Rd);
    n &&
      (e[t.read(n.from, n.to)] = r
        ? r.type.id == Fa
...
function tl(s, t, e) {
  let i;
  for (let n of e)
    if (!n.attrs || n.attrs(i || (i = Yd(s.node.parent.firstChild, t))))
...
function el(s = [], t = []) {
  ...
  for (let a of t) (o[a.name] || (o[a.name] = [])).push(a);
  return sr((a, l) => {
    let h = a.type.id;
    if (h == a1) return tl(a, l, e);
    if (h == l1) return tl(a, l, i);
    if (h == h1) return tl(a, l, n);
    if (h == Md && r.length) {
      let c = a.node,
        f = c.firstChild,
        u = f && Nd(f, l),
      ...
      if (u) {
        for (let p of r)
          if (p.tag == u && (!p.attrs || p.attrs(d || (d = Yd(f, l))))) {
            let O = c.lastChild,
              g = O.type.id == f1 ? O.from : c.to;
            if (g > f.to)
    ...
    if (o && h == Xd) {
      ...
      if ((f = c.firstChild)) {
        ...
        if (u)
          for (let d of u) {
            if (d.tagName && d.tagName != Nd(c.parent, l)) continue;
            let p = c.lastChild;
            if (p.type.id == Fa) {
              let O = p.from + 1,
                g = p.lastChild,
                b = p.to - (g && g.isError ? 0 : 1);
              if (b > O)
                return {
                  parser: d.parser,
                  overlay: [{ from: O, to: b }],
            ...
            } else if (p.type.id == Rd)
              return {
                parser: d.parser,
                overlay: [{ from: p.from, to: p.to }],
              };
          }
      }
    }
...
function Ud(s) {
  return il(s) || (s >= 97 && s <= 102) || (s >= 65 && s <= 70);
}
var Fd = (s, t, e) => (i, n) => {
    for (let r = !1, o = 0, a = 0; ; a++) {
      let { next: l } = i;
      if (as(l) || l == Ar || l == Gd || (r && il(l)))
        (!r && (l != Ar || a > 0) && (r = !0),
          o === a && l == Ar && o++,
          i.advance());
      else if (l == Y1 && i.peek(1) != N1) {
        if ((i.advance(), Ud(i.next))) {
          do i.advance();
          while (Ud(i.next));
          i.next == 32 && i.advance();
        ...
        r && i.acceptToken(o == 2 && n.canShift(Wd) ? t : l == I1 ? e : s);
        break;
      }
    }
  },
  W1 = new wt(Fd(E1, Wd, Z1), { contextual: !0 }),
  _1 = new wt(Fd(M1, X1, R1), { contextual: !0 }),
  G1 = new wt((s) => {
    if (_d.includes(s.peek(-1))) {
      let { next: t } = s;
      (as(t) ||
        t == Gd ||
        t == z1 ||
  ...
  U1 = new wt((s) => {
    if (!_d.includes(s.peek(-1))) {
      let { next: t } = s;
      if ((t == V1 && (s.advance(), s.acceptToken(qd)), as(t))) {
        do s.advance();
        while (as(s.next) || il(s.next));
        s.acceptToken(qd);
      }
    }
  }),
  ...
  K1 = { __proto__: null, or: 104, and: 104, not: 112, only: 112, layer: 206 },
  J1 = { __proto__: null, selector: 118, style: 124, layer: 202 },
  tS = {
    __proto__: null,
    "@import": 198,
    "@media": 210,
  ...
  Hd = Ee.deserialize({
    ...
    tokenizers: [
      ...
      3,
      4,
      new Ci("m~RRYZ[z{a~~g~aO$_~~dP!P!Qg~lO$`~~", 28, 152),
    ],
    topRules: { StyleSheet: [0, 6], Styles: [1, 126] },
    dynamicPrecedences: { 94: 1 },
    specialized: [
      { term: 147, get: (s) => H1[s] || -1 },
      { term: 148, get: (s) => K1[s] || -1 },
      { term: 4, get: (s) => J1[s] || -1 },
      { term: 28, get: (s) => tS[s] || -1 },
      { term: 146, get: (s) => eS[s] || -1 },
    ],
    tokenPrec: 2405,
  });
var nl = null;
function sl() {
  if (!nl && typeof document == "object" && document.body) {
    let { style: s } = document.body,
      t = [],
      e = new Set();
    for (let i in s)
      i != "cssText" &&
        ...
        typeof s[i] == "string" &&
        (/[A-Z]/.test(i) &&
          (i = i.replace(/[A-Z]/g, (n) => "-" + n.toLowerCase())),
        e.has(i) || (t.push(i), e.add(i)));
    nl = t.sort().map((i) => ({ type: "property", label: i, apply: i + ": " }));
  }
  return nl || [];
}
var Kd = [
...
function rS(s, t) {
  var e;
  if (
    ((s.name == "(" || s.type.isError) && (s = s.parent || s),
    s.name != "ArgList")
  )
    return !1;
...
function ep(s, t, e) {
  if (t.to - t.from > 4096) {
    ...
    let n = [],
      r = new Set(),
      o = t.cursor(V.IncludeAnonymous);
    if (o.firstChild())
      do
        for (let a of ep(s, o.node, e))
          r.has(a.label) || (r.add(a.label), n.push(a));
      while (o.nextSibling());
    return (tp.set(t, n), n);
  } else {
    let i = [],
    ...
    return (
      t.cursor().iterate((r) => {
        ...
        if (
          e(r) &&
          r.matchContext(oS) &&
          ((o = r.node.nextSibling) === null || o === void 0
            ? void 0
            : o.name) == ":"
        ) {
          let a = s.sliceString(r.from, r.to);
          n.has(a) || (n.add(a), i.push({ label: a, type: "variable" }));
        }
      }),
      i
    );
...
var lS = (s) => (t) => {
    let { state: e, pos: i } = t,
      n = F(e).resolveInner(i, -1),
      r =
        n.type.isError &&
        n.from == n.to - 1 &&
        e.doc.sliceString(n.from, n.to) == "-";
    if (
      n.name == "PropertyName" ||
      ((r || n.name == "TagName") &&
        /^(Block|Styles)$/.test(n.resolve(n.to).name))
    )
      return { from: n.from, options: sl(), validFor: Fe };
    if (n.name == "ValueName")
      return { from: n.from, options: Jd, validFor: Fe };
    if (n.name == "PseudoClassName")
      return { from: n.from, options: Kd, validFor: Fe };
    if (s(n) || ((t.explicit || r) && rS(n, e.doc)))
      return {
        from: s(n) || r ? n.from : i,
        options: ep(e.doc, aS(n), s),
        validFor: sS,
      };
    if (n.name == "TagName") {
      for (let { parent: l } = n; l; l = l.parent)
        if (l.name == "Block")
          return { from: n.from, options: sl(), validFor: Fe };
      return { from: n.from, options: iS, validFor: Fe };
    }
    if (n.name == "AtKeyword")
      return { from: n.from, options: nS, validFor: Fe };
    if (!t.explicit) return null;
    let o = n.resolve(i),
      a = o.childBefore(i);
    return a && a.name == ":" && o.name == "PseudoClassSelector"
      ? { from: i, options: Kd, validFor: Fe }
      : (a && a.name == ":" && o.name == "Declaration") || o.name == "ArgList"
        ? { from: i, options: Jd, validFor: Fe }
        : o.name == "Block" || o.name == "Styles"
          ? { from: i, options: sl(), validFor: Fe }
          : null;
  },
  hS = lS((s) => s.name == "VariableName"),
  ls = Ce.define({
    name: "css",
    parser: Hd.configure({
      props: [
        je.add({ Declaration: Ki() }),
        Ye.add({ "Block KeyframeList": cr }),
      ],
    }),
    languageData: {
...
function ip() {
  return new Ae(ls, ls.data.of({ autocomplete: hS }));
}
var cS = 316,
  fS = 317,
  np = 1,
  ...
  ES = new wt(
    (s, t) => {
      let { next: e } = s;
      (e == sp || e == -1 || t.context) && s.acceptToken(OS);
    },
  ...
  ZS = new wt(
    (s, t) => {
      let { next: e } = s,
        i;
      rl.indexOf(e) > -1 ||
        (e == ol && ((i = s.peek(1)) == ol || i == vS)) ||
        (e != sp && e != wS && e != -1 && !t.context && s.acceptToken(cS));
    },
    { contextual: !0 },
  ),
  MS = new wt(
    (s, t) => {
      s.next == CS && !t.context && s.acceptToken(fS);
    },
    { contextual: !0 },
  ),
  XS = new wt(
    (s, t) => {
      ...
      if (e == xS || e == kS) {
        if ((s.advance(), e == s.next)) {
          s.advance();
          let i = !t.context && t.canShift(np);
          s.acceptToken(i ? np : uS);
        }
      } else
        e == $S &&
          s.peek(1) == TS &&
          (s.advance(),
          s.advance(),
          (s.next < 48 || s.next > 57) && s.acceptToken(dS));
    },
    { contextual: !0 },
  );
function al(s, t) {
...
var RS = new wt((s, t) => {
    if (s.next != QS || !t.dialectEnabled(yS) || (s.advance(), s.next == ol))
      return;
    let e = 0;
    for (; rl.indexOf(s.next) > -1;) (s.advance(), e++);
    if (al(s.next, !0)) {
      for (s.advance(), e++; al(s.next, !1);) (s.advance(), e++);
      for (; rl.indexOf(s.next) > -1;) (s.advance(), e++);
      if (s.next == PS) return;
      for (let i = 0; ; i++) {
        if (i == 7) {
          if (!al(s.next, !0)) return;
          break;
        }
  ...
  rp = Ee.deserialize({
    ...
    tokenizers: [
      ...
      new Ci("j~RQYZXz{^~^O(Q~~aP!P!Qd~iO(R~~", 25, 323),
    ],
    topRules: {
      Script: [0, 7],
    ...
    specialized: [
      { term: 327, get: (s) => IS[s] || -1 },
      { term: 343, get: (s) => DS[s] || -1 },
      { term: 95, get: (s) => BS[s] || -1 },
    ],
    tokenPrec: 15201,
  });
var op = [
    Et("function ${name}(${params}) {\n	${}\n}", {
      label: "function",
      detail: "definition",
      type: "keyword",
    }),
    Et("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n	${}\n}", {
      label: "for",
      detail: "loop",
      type: "keyword",
    }),
    Et("for (let ${name} of ${collection}) {\n	${}\n}", {
      label: "for",
      detail: "of loop",
      type: "keyword",
    }),
    ...
    Et('import {${names}} from "${module}"\n${}', {
      label: "import",
      detail: "named",
      type: "keyword",
    }),
    Et('import ${name} from "${module}"\n${}', {
      label: "import",
      detail: "default",
      type: "keyword",
    }),
...
var VS = ["FunctionDeclaration"],
  jS = {
    FunctionDeclaration: hs("function"),
    ClassDeclaration: hs("class"),
    ClassExpression: () => !0,
    EnumDeclaration: hs("constant"),
    TypeAliasDeclaration: hs("type"),
    NamespaceDeclaration: hs("namespace"),
    VariableDefinition(s, t) {
      s.matchContext(VS) || t(s, "variable");
    },
    TypeDefinition(s, t) {
      t(s, "type");
    },
...
function hp(s, t) {
  ...
  let i = [],
    n = !0;
  function r(o, a) {
    let l = s.sliceString(o.from, o.to);
    i.push({ label: l, type: a });
  }
  return (
    t.cursor(V.IncludeAnonymous).iterate((o) => {
      if (n) n = !1;
      else if (o.name) {
        let a = jS[o.name];
        if ((a && a(o, r)) || lp.has(o.name)) return !1;
      } else if (o.to - o.from > 8192) {
        for (let a of hp(s, o.node)) i.push(a);
        return !1;
      }
    }),
    ap.set(t, i),
...
function YS(s) {
  let t = F(s.state).resolveInner(s.pos, -1);
  if (fp.indexOf(t.name) > -1) return null;
  let e =
    t.name == "VariableName" ||
    (t.to - t.from < 20 && cp.test(s.state.sliceDoc(t.from, t.to)));
  if (!e && !s.explicit) return null;
  let i = [];
  for (let n = t; n; n = n.parent)
    lp.has(n.name) && (i = i.concat(hp(s.state.doc, n)));
  return { options: i, from: e ? t.from : s.pos, validFor: cp };
}
var pe = Ce.define({
    name: "javascript",
    parser: rp.configure({
      props: [
        je.add({
          IfStatement: Ki({ except: /^\s*({|else\b)/ }),
          TryStatement: Ki({ except: /^\s*({|catch\b|finally\b)/ }),
          LabeledStatement: Yf,
          SwitchBody: (s) => {
            let t = s.textAfter,
              e = /^\s*\}/.test(t),
          ...
          "Statement Property": Ki({ except: /^\s*{/ }),
          JSXElement(s) {
        ...
        Ye.add({
          ...
          JSXElement(s) {
            ...
            let e = s.lastChild;
            return { from: t.to, to: e.type.isError ? s.to : e.from };
          },
          "JSXSelfClosingTag JSXOpenTag"(s) {
            var t;
            let e =
                (t = s.firstChild) === null || t === void 0
                  ? void 0
                  : t.nextSibling,
              i = s.lastChild;
            return !e || e.type.isError
              ? null
              : { from: e.to, to: i.type.isError ? s.to : i.from };
          },
        }),
      ],
    }),
  ...
  up = {
    ...
    facet: zn({ commentTokens: { block: { open: "{/*", close: "*/}" } } }),
  },
  ll = pe.configure({ dialect: "ts" }, "typescript"),
  hl = pe.configure({
    dialect: "jsx",
    props: [lr.add((s) => (s.isTop ? [up] : void 0))],
  }),
  cl = pe.configure(
    { dialect: "jsx ts", props: [lr.add((s) => (s.isTop ? [up] : void 0))] },
    "typescript",
  ),
  dp = (s) => ({ label: s, type: "keyword" }),
  pp =
    "break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield"
      ...
      .map(dp),
  NS = pp.concat(
    ["declare", "implements", "private", "protected", "public"].map(dp),
  );
function Op(s = {}) {
  let t = s.jsx ? (s.typescript ? cl : hl) : s.typescript ? ll : pe,
    e = s.typescript ? zS.concat(NS) : op.concat(pp);
  return new Ae(t, [
    pe.data.of({ autocomplete: rd(fp, sd(e)) }),
    pe.data.of({ autocomplete: YS }),
    s.jsx ? _S : [],
  ]);
}
function qS(s) {
  for (;;) {
    if (
      s.name == "JSXOpenTag" ||
      s.name == "JSXSelfClosingTag" ||
      s.name == "JSXFragmentTag"
    )
      return s;
    if (s.name == "JSXEscape" || !s.parent) return null;
    s = s.parent;
  }
}
function mp(s, t, e = s.length) {
...
var WS = typeof navigator == "object" && /Android\b/.test(navigator.userAgent),
  _S = A.inputHandler.of((s, t, e, i, n) => {
    if (
      (WS ? s.composing : s.compositionStarted) ||
      s.state.readOnly ||
      t != e ||
      (i != ">" && i != "/") ||
      !pe.isActiveAt(s.state, t, -1)
    )
      return !1;
    let r = n(),
      { state: o } = r,
        ...
        if (
          ...
          if (i == "/" && f.name == "JSXStartCloseTag") {
            ...
            if (
              ...
              return { range: l, changes: { from: c, insert: `</${u}>` } };
          }
        }
        return { range: l };
      });
...
var cs = ["_blank", "_self", "_top", "_parent"],
  fl = ["ascii", "utf-8", "utf-16", "latin1", "latin1"],
  ul = ["get", "post", "put", "delete"],
  dl = [
  ...
  bp =
    "beforeunload copy cut dragstart dragover dragleave dragenter dragend drag paste focus blur change click load mousedown mouseenter mouseleave mouseup keydown keyup resize scroll unload"
      .split(" ")
      .map((s) => "on" + s);
for (let s of bp) gp[s] = null;
var ln = class {
  constructor(t, e) {
    ((this.tags = { ...GS, ...t }),
      (this.globalAttrs = { ...gp, ...e }),
      (this.allTags = Object.keys(this.tags)),
      (this.globalAttrNames = Object.keys(this.globalAttrs)));
  }
};
ln.default = new ln();
function hn(s, t, e = s.length) {
  if (!t) return "";
  let i = t.firstChild,
    n = i && i.getChild("TagName");
  return n ? s.sliceString(n.from, Math.min(n.to, e)) : "";
}
function cn(s, t = !1) {
  for (; s; s = s.parent)
    if (s.name == "Element")
...
function Sp(s, t, e) {
  let i = e.tags[hn(s, cn(t))];
  return (i == null ? void 0 : i.children) || e.allTags;
}
function pl(s, t) {
  let e = [];
  for (let i = cn(t); i && !i.type.isTop; i = cn(i.parent)) {
    let n = hn(s, i);
    if (n && i.lastChild.name == "CloseTag") break;
    n &&
      e.indexOf(n) < 0 &&
      (t.name == "EndTag" || t.from >= i.firstChild.to) &&
      e.push(n);
  }
  return e;
}
var yp = /^[:\-\.\w\u00b7-\uffff]*$/;
function wp(s, t, e, i, n) {
  let r = /\s*>/.test(s.sliceDoc(n, n + 5)) ? "" : ">",
    o = cn(e, e.name == "StartTag" || e.name == "TagName");
  return {
    from: i,
    to: n,
    options: Sp(s.doc, o, t)
...
function US(s, t, e, i) {
  let n = [],
    r = 0;
  for (let o of Sp(s.doc, e, t)) n.push({ label: "<" + o, type: "type" });
  for (let o of pl(s.doc, e))
    n.push({ label: "</" + o + ">", type: "type", boost: 99 - r++ });
  return {
    from: i,
    to: i,
    options: n,
...
function HS(s, t, e, i, n) {
  var r;
  let o =
      (r = e.parent) === null || r === void 0
        ? void 0
        : r.getChild("AttributeName"),
    a = [],
    l;
  if (o) {
    let h = s.sliceDoc(o.from, o.to),
      c = t.globalAttrs[h];
    if (!c) {
      let f = cn(e),
        u = f ? t.tags[hn(s.doc, f)] : null;
      c = (u == null ? void 0 : u.attrs) && u.attrs[h];
    }
    if (c) {
      let f = s.sliceDoc(i, n).toLowerCase(),
        u = '"',
        d = '"';
      /^['"]/.test(f)
        ? ((l = f[0] == '"' ? /^[^"]*$/ : /^[^']*$/),
          (u = ""),
          (d = s.sliceDoc(n, n + 1) == f[0] ? "" : f[0]),
          (f = f.slice(1)),
          i++)
        : (l = /^[^\s<>='"]*$/);
      for (let p of c) a.push({ label: p, apply: u + p + d, type: "constant" });
    }
  }
...
function xp(s, t) {
  let { state: e, pos: i } = t,
    n = F(e).resolveInner(i, -1),
    r = n.resolve(i);
  for (let o = i, a; r == n && (a = n.childBefore(o));) {
    let l = a.lastChild;
  ...
  return n.name == "TagName"
    ? n.parent && /CloseTag$/.test(n.parent.name)
      ? vp(e, n, n.from, i)
      : wp(e, s, n, n.from, i)
    : n.name == "StartTag" || n.name == "IncompleteTag"
      ? wp(e, s, n, i, i)
      : n.name == "StartCloseTag" || n.name == "IncompleteCloseTag"
        ? vp(e, n, i, i)
        : n.name == "OpenTag" ||
            n.name == "SelfClosingTag" ||
            n.name == "AttributeName"
          ? FS(e, s, n, n.name == "AttributeName" ? n.from : i, i)
          : n.name == "Is" ||
              n.name == "AttributeValue" ||
              n.name == "UnquotedAttributeValue"
            ? HS(e, s, n, n.name == "Is" ? i : n.from, i)
            : t.explicit &&
                (r.name == "Element" ||
                  r.name == "Text" ||
                  r.name == "Document")
...
function kp(s) {
  return xp(ln.default, s);
}
function KS(s) {
  let { extraTags: t, extraGlobalAttributes: e } = s,
    i = e || t ? new ln(t, e) : ln.default;
  return (n) => xp(i, n);
}
var JS = pe.parser.configure({ top: "SingleExpression" }),
  Qp = [
    {
      tag: "script",
    ...
    },
    {
      ...
      attrs(s) {
        return (
          (!s.lang || s.lang == "css") &&
          (!s.type || /^(text\/)?(x-)?(stylesheet|css)$/i.test(s.type))
        );
      },
      parser: ls.parser,
    },
  ...
  Pp = [
    { name: "style", parser: ls.parser.configure({ top: "Styles" }) },
  ].concat(bp.map((s) => ({ name: s, parser: pe.parser }))),
  $p = Ce.define({
    name: "html",
    parser: jd.configure({
      props: [
        je.add({
          Element(s) {
            ...
            return s.node.to <= s.pos + t[0].length
              ? s.continue()
              : s.lineIndent(s.node.from) + (t[2] ? 0 : s.unit);
          },
          ...
          Document(s) {
            ...
            for (let i = s.node; ;) {
              let n = i.lastChild;
              if (!n || n.name != "Element" || n.to != i.to) break;
              t = i = n;
            }
            return t &&
              !(
                (e = t.lastChild) &&
                (e.name == "CloseTag" || e.name == "SelfClosingTag")
              )
              ? s.lineIndent(t.from) + s.unit
              : null;
          },
        }),
        Ye.add({
          Element(s) {
            ...
            return !t || t.name != "OpenTag"
              ? null
              : { from: t.to, to: e.name == "CloseTag" ? e.from : s.to };
          },
        }),
        pa.add({ "OpenTag CloseTag": (s) => s.getChild("TagName") }),
      ],
    }),
    languageData: {
      commentTokens: { block: { open: "<!--", close: "-->" } },
  ...
  Er = $p.configure({ wrap: el(Qp, Pp) });
function Zr(s = {}) {
  let t = "",
    e;
  (s.matchClosingTags === !1 && (t = "noMatch"),
    s.selfClosingTags === !0 && (t = (t ? t + " " : "") + "selfClosing"),
    ((s.nestedLanguages && s.nestedLanguages.length) ||
      (s.nestedAttributes && s.nestedAttributes.length)) &&
      (e = el(
        (s.nestedLanguages || []).concat(Qp),
        (s.nestedAttributes || []).concat(Pp),
      )));
  let i = e
    ? $p.configure({ wrap: e, dialect: t })
    : t
      ? Er.configure({ dialect: t })
      : Er;
  return new Ae(i, [
    Er.data.of({ autocomplete: KS(s) }),
    s.autoCloseTags !== !1 ? ty : [],
    Op().support,
    ip().support,
  ]);
}
var Tp = new Set(
  ...
  ty = A.inputHandler.of((s, t, e, i, n) => {
    if (
      s.composing ||
      s.state.readOnly ||
      t != e ||
      (i != ">" && i != "/") ||
      !Er.isActiveAt(s.state, t, -1)
    )
      return !1;
    let r = n(),
      { state: o } = r,
      a = o.changeByRange((l) => {
        var h, c, f;
        let u = o.doc.sliceString(l.from - 1, l.to) == i,
          { head: d } = l,
          p = F(o).resolveInner(d, -1),
          O;
        if (u && i == ">" && p.name == "EndTag") {
          let g = p.parent;
          if (
            ((c =
              ...
              ? void 0
              : c.name) != "CloseTag" &&
            (O = hn(o.doc, g.parent, d)) &&
            !Tp.has(O)
          ) {
            let b = d + (o.doc.sliceString(d, d + 1) === ">" ? 1 : 0),
              S = `</${O}>`;
            return { range: l, changes: { from: d, to: b, insert: S } };
          }
        } else if (u && i == "/" && p.name == "IncompleteCloseTag") {
          let g = p.parent;
          if (
            p.from == d - 2 &&
            ((f = g.lastChild) === null || f === void 0 ? void 0 : f.name) !=
              "CloseTag" &&
            (O = hn(o.doc, g, d)) &&
            !Tp.has(O)
          ) {
            let b = d + (o.doc.sliceString(d, d + 1) === ">" ? 1 : 0),
              S = `${O}>`;
            return {
              range: k.cursor(d + S.length, -1),
              changes: { from: d, to: b, insert: S },
            };
          }
        }
        return { range: l };
...
var fs = class {
    ...
    constructor(t, e, i, n, r, o, a) {
      ((this.type = t),
        ...
        (this.children = o),
        (this.positions = a),
        (this.hashProp = [[X.contextHash, n]]));
    }
    addChild(t, e) {
      (t.prop(X.contextHash) != this.hash &&
        (t = new z(t.type, t.children, t.positions, t.length, this.hashProp)),
    ...
    toTree(t, e = this.end) {
      ...
      return (
        ...
        new z(
          ...
          makeTree: (n, r, o) => new z(nt.none, n, r, o, this.hashProp),
        })
      );
    }
  },
...
(function (s) {
  ((s[(s.Document = 1)] = "Document"),
    (s[(s.CodeBlock = 2)] = "CodeBlock"),
    (s[(s.FencedCode = 3)] = "FencedCode"),
    (s[(s.Blockquote = 4)] = "Blockquote"),
    (s[(s.HorizontalRule = 5)] = "HorizontalRule"),
    (s[(s.BulletList = 6)] = "BulletList"),
    (s[(s.OrderedList = 7)] = "OrderedList"),
    (s[(s.ListItem = 8)] = "ListItem"),
    (s[(s.ATXHeading1 = 9)] = "ATXHeading1"),
    (s[(s.ATXHeading2 = 10)] = "ATXHeading2"),
    (s[(s.ATXHeading3 = 11)] = "ATXHeading3"),
    (s[(s.ATXHeading4 = 12)] = "ATXHeading4"),
    (s[(s.ATXHeading5 = 13)] = "ATXHeading5"),
    (s[(s.ATXHeading6 = 14)] = "ATXHeading6"),
    (s[(s.SetextHeading1 = 15)] = "SetextHeading1"),
    (s[(s.SetextHeading2 = 16)] = "SetextHeading2"),
    (s[(s.HTMLBlock = 17)] = "HTMLBlock"),
    (s[(s.LinkReference = 18)] = "LinkReference"),
    (s[(s.Paragraph = 19)] = "Paragraph"),
    (s[(s.CommentBlock = 20)] = "CommentBlock"),
    (s[(s.ProcessingInstructionBlock = 21)] = "ProcessingInstructionBlock"),
    (s[(s.Escape = 22)] = "Escape"),
    (s[(s.Entity = 23)] = "Entity"),
    (s[(s.HardBreak = 24)] = "HardBreak"),
    (s[(s.Emphasis = 25)] = "Emphasis"),
    (s[(s.StrongEmphasis = 26)] = "StrongEmphasis"),
    (s[(s.Link = 27)] = "Link"),
    (s[(s.Image = 28)] = "Image"),
    (s[(s.InlineCode = 29)] = "InlineCode"),
    (s[(s.HTMLTag = 30)] = "HTMLTag"),
    (s[(s.Comment = 31)] = "Comment"),
    (s[(s.ProcessingInstruction = 32)] = "ProcessingInstruction"),
    (s[(s.Autolink = 33)] = "Autolink"),
    (s[(s.HeaderMark = 34)] = "HeaderMark"),
    (s[(s.QuoteMark = 35)] = "QuoteMark"),
    (s[(s.ListMark = 36)] = "ListMark"),
    (s[(s.LinkMark = 37)] = "LinkMark"),
    (s[(s.EmphasisMark = 38)] = "EmphasisMark"),
    (s[(s.CodeMark = 39)] = "CodeMark"),
    (s[(s.CodeText = 40)] = "CodeText"),
    (s[(s.CodeInfo = 41)] = "CodeInfo"),
    (s[(s.LinkTitle = 42)] = "LinkTitle"),
    (s[(s.LinkLabel = 43)] = "LinkLabel"),
    (s[(s.URL = 44)] = "URL"));
})(v || (v = {}));
var Cp = class {
    constructor(t, e) {
...
function Ep(s, t, e) {
  if (
    e.pos == e.text.length ||
    (s != t.block && e.indent >= t.stack[e.depth + 1].value + e.baseIndent)
  )
    return !0;
  if (e.indent >= e.baseIndent + 4) return !1;
  let i = (s.type == v.OrderedList ? gl : ml)(e, t, !1);
  return (
    i > 0 &&
    (s.type != v.BulletList || Ol(e, t, !1) < 0) &&
    e.text.charCodeAt(e.pos + i - 1) == s.value
  );
}
var Zp = {
  [v.Blockquote](s, t, e) {
    return e.next != 62
      ? !1
      : (e.markers.push(
          j(v.QuoteMark, t.lineStart + e.pos, t.lineStart + e.pos + 1),
        ),
        e.moveBase(e.pos + (Jt(e.text.charCodeAt(e.pos + 1)) ? 2 : 1)),
        (s.end = t.lineStart + e.text.length),
        !0);
  },
  [v.ListItem](s, t, e) {
    return e.indent < e.baseIndent + s.value && e.next > -1
      ? !1
      : (e.moveBaseColumn(e.baseIndent + s.value), !0);
  },
  [v.OrderedList]: Ep,
  [v.BulletList]: Ep,
  [v.Document]() {
...
function us(s, t = 0) {
  for (; t < s.length && Jt(s.charCodeAt(t));) t++;
  return t;
}
function Mp(s, t, e) {
  for (; t > e && Jt(s.charCodeAt(t - 1));) t--;
  return t;
}
function Xp(s) {
  if (s.next != 96 && s.next != 126) return -1;
  let t = s.pos + 1;
  for (; t < s.text.length && s.text.charCodeAt(t) == s.next;) t++;
  if (t < s.pos + 3) return -1;
  if (s.next == 96) {
    for (let e = t; e < s.text.length; e++)
      if (s.text.charCodeAt(e) == 96) return -1;
  }
  return t;
}
function Rp(s) {
...
function Ol(s, t, e) {
  if (s.next != 42 && s.next != 45 && s.next != 95) return -1;
  let i = 1;
  for (let n = s.pos + 1; n < s.text.length; n++) {
    let r = s.text.charCodeAt(n);
    if (r == s.next) i++;
    else if (!Jt(r)) return -1;
  }
  return (e &&
    s.next == 45 &&
    Dp(s) > -1 &&
    s.depth == t.stack.length &&
    t.parser.leafBlockParsers.indexOf(qp.SetextHeading) > -1) ||
    i < 3
    ? -1
    : 1;
}
function Lp(s, t) {
  for (let e = s.stack.length - 1; e >= 0; e--)
    if (s.stack[e].type == t) return !0;
  return !1;
}
function ml(s, t, e) {
  return (s.next == 45 || s.next == 43 || s.next == 42) &&
    (s.pos == s.text.length - 1 || Jt(s.text.charCodeAt(s.pos + 1))) &&
    (!e || Lp(t, v.BulletList) || s.skipSpace(s.pos + 2) < s.text.length)
    ? 1
    : -1;
}
function gl(s, t, e) {
  ...
  for (; n >= 48 && n <= 57;) {
    i++;
    if (i == s.text.length) return -1;
    n = s.text.charCodeAt(i);
  }
  return i == s.pos ||
    i > s.pos + 9 ||
    (n != 46 && n != 41) ||
    (i < s.text.length - 1 && !Jt(s.text.charCodeAt(i + 1))) ||
    (e &&
      !Lp(t, v.OrderedList) &&
      (s.skipSpace(i + 1) == s.text.length || i > s.pos + 1 || s.next != 49))
    ? -1
    : i + 1 - s.pos;
}
function Ip(s) {
  if (s.next != 35) return -1;
  let t = s.pos + 1;
  for (; t < s.text.length && s.text.charCodeAt(t) == 35;) t++;
  if (t < s.text.length && s.text.charCodeAt(t) != 32) return -1;
  let e = t - s.pos;
  return e > 6 ? -1 : e;
}
function Dp(s) {
  if ((s.next != 45 && s.next != 61) || s.indent >= s.baseIndent + 4) return -1;
  let t = s.pos + 1;
  for (; t < s.text.length && s.text.charCodeAt(t) == s.next;) t++;
  let e = t;
  for (; t < s.text.length && Jt(s.text.charCodeAt(t));) t++;
...
function Vp(s, t, e) {
  if (s.next != 60) return -1;
  let i = s.text.slice(s.pos);
  for (let n = 0, r = Sl.length - (e ? 1 : 0); n < r; n++)
    if (Sl[n][0].test(i)) return n;
  return -1;
}
function jp(s, t) {
  let e = s.countIndent(t, s.pos, s.indent),
    i = s.countIndent(s.skipSpace(t), t, e);
  return i >= e + 5 ? e + 1 : i;
}
function hi(s, t, e) {
  let i = s.length - 1;
  i >= 0 && s[i].to == t && s[i].type == v.CodeText
    ? (s[i].to = e)
    : s.push(j(v.CodeText, t, e));
}
var Mr = {
    ...
    IndentedCode(s, t) {
      ...
      let i = t.findColumn(e),
        n = s.lineStart + i,
        r = s.lineStart + t.text.length,
        o = [],
        a = [];
      for (hi(o, n, r); s.nextLine() && t.depth >= s.stack.length;)
        if (t.pos == t.text.length) {
          hi(a, s.lineStart - 1, s.lineStart);
          for (let l of t.markers) a.push(l);
        } else {
          if (t.indent < e) break;
          {
            if (a.length) {
              for (let h of a)
                h.type == v.CodeText ? hi(o, h.from, h.to) : o.push(h);
              a = [];
            }
            hi(o, s.lineStart - 1, s.lineStart);
            for (let h of t.markers) o.push(h);
            r = s.lineStart + t.text.length;
      ...
      return (
        a.length &&
          ((a = a.filter((l) => l.type != v.CodeText)),
          a.length && (t.markers = a.concat(t.markers))),
        s.addNode(s.buffer.writeElements(o, -n).finish(v.CodeBlock, r - n), n),
        !0
      );
    },
    FencedCode(s, t) {
      let e = Xp(t);
      if (e < 0) return !1;
      let i = s.lineStart + t.pos,
        n = t.next,
        r = e - t.pos,
        o = t.skipSpace(e),
        a = Mp(t.text, t.text.length, o),
        l = [j(v.CodeMark, i, i + r)];
      o < a && l.push(j(v.CodeInfo, s.lineStart + o, s.lineStart + a));
      for (
        let h = !0, c = !0, f = !1;
        s.nextLine() && t.depth >= s.stack.length;
        h = !1
      ) {
        let u = t.pos;
        if (t.indent - t.baseIndent < 4)
          for (; u < t.text.length && t.text.charCodeAt(u) == n;) u++;
        if (u - t.pos >= r && t.skipSpace(u) == t.text.length) {
          for (let d of t.markers) l.push(d);
          (c && f && hi(l, s.lineStart - 1, s.lineStart),
            l.push(j(v.CodeMark, s.lineStart + t.pos, s.lineStart + u)),
            s.nextLine());
          break;
        } else {
          ((f = !0), h || (hi(l, s.lineStart - 1, s.lineStart), (c = !1)));
          for (let O of t.markers) l.push(O);
          let d = s.lineStart + t.basePos,
            p = s.lineStart + t.text.length;
          d < p && (hi(l, d, p), (c = !1));
        }
      }
      return (
        s.addNode(
          s.buffer
            .writeElements(l, -i)
            .finish(v.FencedCode, s.prevLineEnd() - i),
          i,
        ),
        !0
      );
    ...
    Blockquote(s, t) {
      ...
      return e < 0
        ? !1
        : (s.startContext(v.Blockquote, t.pos),
          s.addNode(v.QuoteMark, s.lineStart + t.pos, s.lineStart + t.pos + 1),
          t.moveBase(t.pos + e),
          null);
    },
    HorizontalRule(s, t) {
      if (Ol(t, s, !1) < 0) return !1;
      let e = s.lineStart + t.pos;
      return (s.nextLine(), s.addNode(v.HorizontalRule, e), !0);
    },
    BulletList(s, t) {
      let e = ml(t, s, !1);
      if (e < 0) return !1;
      s.block.type != v.BulletList &&
        s.startContext(v.BulletList, t.basePos, t.next);
      let i = jp(t, t.pos + 1);
      return (
        s.startContext(v.ListItem, t.basePos, i - t.baseIndent),
        s.addNode(v.ListMark, s.lineStart + t.pos, s.lineStart + t.pos + e),
        t.moveBaseColumn(i),
        null
      );
    },
    OrderedList(s, t) {
      let e = gl(t, s, !1);
      if (e < 0) return !1;
      s.block.type != v.OrderedList &&
        s.startContext(
          v.OrderedList,
          t.basePos,
          t.text.charCodeAt(t.pos + e - 1),
        );
      let i = jp(t, t.pos + e);
      return (
        s.startContext(v.ListItem, t.basePos, i - t.baseIndent),
    ...
    ATXHeading(s, t) {
      ...
      let i = t.pos,
        n = s.lineStart + i,
        r = Mp(t.text, t.text.length, i),
        o = r;
      for (; o > i && t.text.charCodeAt(o - 1) == t.next;) o--;
      (o == r || o == i || !Jt(t.text.charCodeAt(o - 1))) &&
        (o = t.text.length);
      let a = s.buffer
        .write(v.HeaderMark, 0, e)
        .writeElements(
          s.parser.parseInline(t.text.slice(i + e + 1, o), n + e + 1),
          -n,
        );
      o < t.text.length && a.write(v.HeaderMark, o - i, r - i);
      let l = a.finish(v.ATXHeading1 - 1 + e, t.text.length - i);
    ...
    HTMLBlock(s, t) {
      ...
      let i = s.lineStart + t.pos,
        ...
        r = [],
        o = n != bl;
      for (; !n.test(t.text) && s.nextLine();) {
        if (t.depth < s.stack.length) {
          o = !1;
          break;
        }
        for (let h of t.markers) r.push(h);
      }
      o && s.nextLine();
      let a =
          n == Bp
            ? v.CommentBlock
            : n == zp
              ? v.ProcessingInstructionBlock
              : v.HTMLBlock,
        l = s.prevLineEnd();
      return (s.addNode(s.buffer.writeElements(r, -i).finish(a, l - i), i), !0);
    },
...
` +
          e.scrub(),
        r = this.advance(n);
      return r > -1 && r < n.length ? this.complete(t, i, r) : !1;
    }
    finish(t, e) {
      return (this.stage == 2 || this.stage == 3) &&
        us(e.content, this.pos) == e.content.length
    ...
    complete(t, e, i) {
      return (
        t.addLeafElement(
          e,
          j(v.LinkReference, this.start, this.start + i, this.elts),
        ),
        !0
      );
    }
    ...
    advance(t) {
      for (;;) {
        if (this.stage == -1) return -1;
        if (this.stage == 0) {
          if (!this.nextStage(tO(t, this.pos, this.start, !0))) return -1;
          if (t.charCodeAt(this.pos) != 58) return (this.stage = -1);
          (this.elts.push(
            j(v.LinkMark, this.pos + this.start, this.pos + this.start + 1),
          ),
            this.pos++);
        } else if (this.stage == 1) {
          if (!this.nextStage(Kp(t, us(t, this.pos), this.start))) return -1;
        } else if (this.stage == 2) {
          let e = us(t, this.pos),
            i = 0;
          if (e > this.pos) {
            let n = Jp(t, e, this.start);
            if (n) {
              let r = yl(t, n.to - this.start);
              r > 0 && (this.nextStage(n), (i = r));
            }
          }
          return (i || (i = yl(t, this.pos)), i > 0 && i < t.length ? i : -1);
        } else return yl(t, this.pos);
      }
    }
  };
function yl(s, t) {
...
var Np = class {
    nextLine(t, e, i) {
      let n = e.depth < t.stack.length ? -1 : Dp(e),
        r = e.next;
      if (n < 0) return !1;
      let o = j(v.HeaderMark, t.lineStart + e.pos, t.lineStart + n);
      return (
        t.nextLine(),
        t.addLeafElement(
          i,
          j(
            r == 61 ? v.SetextHeading1 : v.SetextHeading2,
            i.start,
            t.prevLineEnd(),
            [...t.parser.parseInline(i.content, i.start), o],
          ),
        ),
        !0
      );
  ...
  qp = {
    LinkReference(s, t) {
      return t.content.charCodeAt(0) == 91 ? new Yp(t) : null;
    },
    SetextHeading() {
      return new Np();
    },
  ...
  Wp = class {
      ...
      ((this.parser = t),
        ...
        (this.lineStart =
          ...
          this.absoluteLineEnd =
            n[0].from),
        (this.block = fs.create(v.Document, 0, this.lineStart, 0, 0)),
        (this.stack = [this.block]),
        (this.fragments = i.length ? new eO(i, e) : null),
        this.readLine());
    }
    get parsedPos() {
    ...
    advance() {
      ...
      for (;;) {
        for (let i = 0; ;) {
          let n =
            t.depth < this.stack.length
              ? this.stack[this.stack.length - 1]
              : null;
          for (; i < t.markers.length && (!n || t.markers[i].from < n.end);) {
            let r = t.markers[i++];
      ...
      let e = new Cp(this.lineStart + t.pos, t.text.slice(t.pos));
      ...
      t: for (; this.nextLine() && t.pos != t.text.length;) {
        if (t.indent < t.baseIndent + 4) {
          for (let i of this.parser.endLeafBlock) if (i(this, t, e)) break t;
        }
        for (let i of e.parsers) if (i.nextLine(this, t, e)) return null;
        e.content +=
          `
` + t.scrub();
        for (let i of t.markers) e.marks.push(i);
      }
    ...
    reuseFragment(t) {
      ...
      return e
        ? ((this.absoluteLineStart += e),
          (this.lineStart = iO(this.absoluteLineStart, this.ranges)),
          this.moveRangeI(),
    ...
    scanLine(t) {
      ...
      if (((e.end = t), t >= this.to)) e.text = "";
        ...
        ((e.text = this.lineChunkAt(t)),
        (e.end += e.text.length),
        this.ranges.length > 1)
      ) {
        let i = this.absoluteLineStart,
          n = this.rangeI;
        for (; this.ranges[n].to < e.end;) {
          n++;
          let r = this.ranges[n].from,
            o = this.lineChunkAt(r);
          ((e.end = r + o.length),
            (e.text = e.text.slice(0, this.ranges[n - 1].to - i) + o),
            (i = e.end - e.text.length));
        }
      }
      return e;
    }
    readLine() {
      let { line: t } = this,
        { text: e, end: i } = this.scanLine(this.absoluteLineStart);
      for (
        this.absoluteLineEnd = i, t.reset(e);
        t.depth < this.stack.length;
        t.depth++
      ) {
        let n = this.stack[t.depth],
          r = this.parser.skipContextMarkup[n.type];
        if (!r) throw new Error("Unhandled block context " + v[n.type]);
        let o = this.line.markers.length;
        if (!r(n, this, t)) {
          (this.line.markers.length > o &&
            (n.end = this.line.markers[this.line.markers.length - 1].to),
            t.forward());
          break;
        }
        t.forward();
...
`);
    ...
    addNode(t, e, i) {
      (typeof t == "number" &&
        (t = new z(
          ...
          un,
          un,
          (i ?? this.prevLineEnd()) - e,
        )),
        this.block.addChild(t, e - this.block.from));
    }
    addElement(t) {
      this.block.addChild(
        t.toTree(this.parser.nodeSet),
        t.from - this.block.from,
      );
    }
    addLeafElement(t, e) {
      this.addNode(
        this.buffer
          .writeElements(Ql(e.children, t.marks), -e.from)
    ...
    finishContext() {
      ...
      (e.addChild(t.toTree(this.parser.nodeSet), t.from - e.from),
        (this.block = e));
    }
    finish() {
    ...
    finishLeaf(t) {
      for (let i of t.parsers) if (i.finish(this, t)) return;
      let e = Ql(this.parser.parseInline(t.content, t.start), t.marks);
      this.addNode(
        this.buffer
          .writeElements(e, -t.start)
          .finish(v.Paragraph, t.content.length),
        t.start,
      );
    }
    elt(t, e, i, n) {
      return typeof t == "string"
        ? j(this.parser.getNodeType(t), e, i, n)
        : new xl(t, e);
    }
    get buffer() {
      return new vl(this.parser.nodeSet);
    }
  };
function _p(s, t, e, i, n) {
  let r = s[t].to,
    o = [],
    a = [],
    l = e.from + i;
  ...
  return (
    h(e.to + i, !1),
    new z(e.type, o, a, e.to + i - l, e.tree ? e.tree.propValues : void 0)
  );
}
var fn = class extends yi {
  constructor(t, e, i, n, r, o, a, l, h) {
    super();
    ((this.nodeSet = t),
      (this.blockParsers = e),
  ...
  configure(t) {
    ...
    if (ds(e.defineNodes)) {
      ...
      for (let p of e.defineNodes) {
        ...
        if (u.some((w) => w.name == O)) continue;
        b && (n[u.length] = (w, Q, P) => b(Q, P, w.value));
        let y = u.length,
          C = b
            ? ["Block", "BlockContext"]
            : g
              ? y >= v.ATXHeading1 && y <= v.SetextHeading2
                ? ["Block", "LeafBlock", "Heading"]
                : ["Block", "LeafBlock"]
              : void 0;
        (u.push(nt.define({ id: y, name: O, props: C && [[X.group, C]] })),
          S &&
            (d || (d = {}),
            Array.isArray(S) || S instanceof Ct
              ? (d[O] = S)
              : Object.assign(d, S)));
      }
      ((i = new ze(u)), d && (i = i.extend(he(d))));
    }
    if ((ds(e.props) && (i = i.extend(...e.props)), ds(e.remove)))
      for (let u of e.remove) {
        let d = this.blockNames.indexOf(u),
          p = this.inlineNames.indexOf(u);
        (d > -1 && (r[d] = o[d] = void 0), p > -1 && (l[p] = void 0));
      }
    if (ds(e.parseBlock))
      for (let u of e.parseBlock) {
        let d = a.indexOf(u.name);
        if (d > -1) ((r[d] = u.parse), (o[d] = u.leaf));
        else {
          let p = u.before
            ? Xr(a, u.before)
            : u.after
        ...
        if (d > -1) l[d] = u.parse;
          ...
          let p = u.before
            ...
            : u.after
              ? Xr(h, u.after) + 1
              : h.length - 1;
          (l.splice(p, 0, u.parse), h.splice(p, 0, u.name));
        }
      }
    return (
      e.wrap && (f = f.concat(e.wrap)),
      new fn(i, r, o, a, c, n, l, h, f)
    );
  }
  getNodeType(t) {
  ...
  parseInline(t, e) {
    let i = new Lr(this, t, e);
    t: for (let n = e; n < i.end;) {
      let r = i.char(n);
...
function wl(s) {
  ...
  return {
    ...
    wrap: n ? (r ? (o, a, l, h) => n(r(o, a, l, h), a, l, h) : n) : r,
  };
}
function Xr(s, t) {
  let e = s.indexOf(t);
    ...
    props:
      s >= v.Escape
        ...
        : [
            [
              X.group,
              s in Zp ? ["Block", "BlockContext"] : ["Block", "LeafBlock"],
            ],
          ],
    top: t == "Document",
  });
var un = [],
  vl = class {
    ...
    write(t, e, i, n = 0) {
      return (this.content.push(t, e, i, 4 + n * 4), this);
    }
    writeElements(t, e = 0) {
      for (let i of t) i.writeTo(this, e);
      return this;
    }
    finish(t, e) {
      return z.build({
  ...
  dn = class {
    constructor(t, e, i, n = un) {
      ((this.type = t), (this.from = e), (this.to = i), (this.children = n));
    }
    writeTo(t, e) {
...
function j(s, t, e, i) {
  return new dn(s, t, e, i);
}
var Up = { resolve: "Emphasis", mark: "EmphasisMark" },
  Fp = { resolve: "Emphasis", mark: "EmphasisMark" },
  Ai = {},
  Rr = {},
  Lt = class {
    constructor(t, e, i, n) {
      ((this.type = t), (this.from = e), (this.to = i), (this.side = n));
    }
  },
  Hp = "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~",
  ps = /[!"#$%&'()*+,\-.\/:;<=>?@\[\\\]^_`{|}~\xA1\u2010-\u2027]/;
try {
  ps = new RegExp("[\\p{S}|\\p{P}]", "u");
} catch (s) {}
var kl = {
  Escape(s, t, e) {
    if (t != 92 || e == s.end - 1) return -1;
    let i = s.char(e + 1);
    for (let n = 0; n < Hp.length; n++)
      if (Hp.charCodeAt(n) == i) return s.append(j(v.Escape, e, e + 2));
    return -1;
  },
  Entity(s, t, e) {
    if (t != 38) return -1;
    let i = /^(?:#\d+|#x[a-f\d]+|\w+);/i.exec(s.slice(e + 1, e + 31));
    return i ? s.append(j(v.Entity, e, e + 1 + i[0].length)) : -1;
  },
  InlineCode(s, t, e) {
    if (t != 96 || (e && s.char(e - 1) == 96)) return -1;
    let i = e + 1;
    for (; i < s.end && s.char(i) == 96;) i++;
    let n = i - e,
      r = 0;
    for (; i < s.end; i++)
      if (s.char(i) == 96) {
        if ((r++, r == n && s.char(i + 1) != 96))
          return s.append(
            j(v.InlineCode, e, i + 1, [
              j(v.CodeMark, e, e + n),
              j(v.CodeMark, i + 1 - n, i + 1),
            ]),
          );
      } else r = 0;
    return -1;
  ...
  HTMLTag(s, t, e) {
    if (t != 60 || e == s.end - 1) return -1;
    let i = s.slice(e + 1, s.end),
      n =
    ...
    if (n)
      return s.append(
        j(v.Autolink, e, e + 1 + n[0].length, [
          j(v.LinkMark, e, e + 1),
          j(v.URL, e + 1, e + n[0].length),
          j(v.LinkMark, e + n[0].length, e + 1 + n[0].length),
        ]),
      );
    let r = /^!--[^>](?:-[^-]|[^-])*?-->/i.exec(i);
    if (r) return s.append(j(v.Comment, e, e + 1 + r[0].length));
    let o = /^\?[^]*?\?>/.exec(i);
    if (o) return s.append(j(v.ProcessingInstruction, e, e + 1 + o[0].length));
    let a =
      /^(?:![A-Z][^]*?>|!\[CDATA\[[^]*?\]\]>|\/\s*[a-zA-Z][\w-]*\s*>|\s*[a-zA-Z][\w-]*(\s+[a-zA-Z:_][\w-.:]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*(\/\s*)?>)/.exec(
        i,
      );
    return a ? s.append(j(v.HTMLTag, e, e + 1 + a[0].length)) : -1;
  },
  Emphasis(s, t, e) {
    ...
    let n = s.slice(e - 1, e),
      ...
      u = c && (t == 42 || !f || o),
      d = f && (t == 42 || !c || a);
    return s.append(new Lt(t == 95 ? Up : Fp, e, i, (u ? 1 : 0) | (d ? 2 : 0)));
  },
  HardBreak(s, t, e) {
    if (t == 92 && s.char(e + 1) == 10)
      return s.append(j(v.HardBreak, e, e + 2));
    if (t == 32) {
      let i = e + 1;
      for (; s.char(i) == 32;) i++;
      if (s.char(i) == 10 && i >= e + 2)
        return s.append(j(v.HardBreak, e, i + 1));
    }
    return -1;
  },
  Link(s, t, e) {
    return t == 91 ? s.append(new Lt(Ai, e, e + 1, 1)) : -1;
  },
  Image(s, t, e) {
    return t == 33 && s.char(e + 1) == 91
      ? s.append(new Lt(Rr, e, e + 2, 1))
      : -1;
  },
  LinkEnd(s, t, e) {
    if (t != 93) return -1;
    for (let i = s.parts.length - 1; i >= 0; i--) {
      let n = s.parts[i];
      if (n instanceof Lt && (n.type == Ai || n.type == Rr)) {
        if (
          !n.side ||
          (s.skipSpace(n.to) == e && !/[(\[]/.test(s.slice(e + 1, e + 2)))
        )
          return ((s.parts[i] = null), -1);
        let r = s.takeContent(i),
          o = (s.parts[i] = ny(
            s,
            r,
            n.type == Ai ? v.Link : v.Image,
            n.from,
            e + 1,
          ));
        if (n.type == Ai)
          for (let a = 0; a < i; a++) {
            let l = s.parts[a];
            l instanceof Lt && l.type == Ai && (l.side = 0);
          }
        return o.to;
      }
    }
...
function ny(s, t, e, i, n) {
  let { text: r } = s,
    ...
    a = n;
  if (
    (t.unshift(j(v.LinkMark, i, i + (e == v.Image ? 2 : 1))),
    t.push(j(v.LinkMark, n - 1, n)),
    o == 40)
  ) {
    let l = s.skipSpace(n + 1),
      h = Kp(r, l - s.offset, s.offset),
      c;
    (h &&
      ((l = s.skipSpace(h.to)),
      l != h.to &&
        ((c = Jp(r, l - s.offset, s.offset)), c && (l = s.skipSpace(c.to)))),
      s.char(l) == 41 &&
        (t.push(j(v.LinkMark, n, n + 1)),
        (a = l + 1),
        h && t.push(h),
        c && t.push(c),
        t.push(j(v.LinkMark, l, a))));
  } else if (o == 91) {
    let l = tO(r, n - s.offset, s.offset, !1);
    l && (t.push(l), (a = l.to));
  }
  return j(e, i, a, t);
}
function Kp(s, t, e) {
  if (s.charCodeAt(t) == 60) {
    for (let n = t + 1; n < s.length; n++) {
      let r = s.charCodeAt(n);
      if (r == 62) return j(v.URL, t + e, n + 1 + e);
      if (r == 60 || r == 10) return !1;
    }
    return null;
  } else {
    let n = 0,
      r = t;
    for (let o = !1; r < s.length; r++) {
    ...
    return r > t ? j(v.URL, t + e, r + e) : r == s.length ? null : !1;
  }
}
function Jp(s, t, e) {
  let i = s.charCodeAt(t);
  if (i != 39 && i != 34 && i != 40) return !1;
  let n = i == 40 ? 41 : i;
  for (let r = t + 1, o = !1; r < s.length; r++) {
    let a = s.charCodeAt(r);
    if (o) o = !1;
    else {
      if (a == n) return j(v.LinkTitle, t + e, r + 1 + e);
      a == 92 && (o = !0);
    }
  }
  return null;
...
function tO(s, t, e, i) {
  for (let n = !1, r = t + 1, o = Math.min(s.length, r + 999); r < o; r++) {
    let a = s.charCodeAt(r);
    if (n) n = !1;
    else {
      if (a == 93) return i ? !1 : j(v.LinkLabel, t + e, r + 1 + e);
      if ((i && !Jt(a) && (i = !1), a == 91)) return !1;
      a == 92 && (n = !0);
    }
  }
  return null;
...
var Lr = class {
  ...
  addDelimiter(t, e, i, n, r) {
    return this.append(new Lt(t, e, i, (n ? 1 : 0) | (r ? 2 : 0)));
  }
  get hasOpenLink() {
    for (let t = this.parts.length - 1; t >= 0; t--) {
      let e = this.parts[t];
      if (e instanceof Lt && (e.type == Ai || e.type == Rr)) return !0;
    }
    return !1;
  }
  addElement(t) {
  ...
  resolveMarkers(t) {
    for (let i = t; i < this.parts.length; i++) {
      let n = this.parts[i];
      if (!(n instanceof Lt && n.type.resolve && n.side & 2)) continue;
      let r = n.type == Up || n.type == Fp,
        o = n.to - n.from,
        a,
        l = i - 1;
      for (; l >= t; l--) {
      ...
      if (!a) continue;
      let h = n.type.resolve,
        c = [],
        f = a.from,
        u = n.to;
      if (r) {
        let O = Math.min(2, a.to - a.from, o);
        ((f = a.to - O),
          (u = n.from + O),
          (h = O == 1 ? "Emphasis" : "StrongEmphasis"));
      }
      a.type.mark && c.push(this.elt(a.type.mark, f, a.to));
      for (let O = l + 1; O < i; O++)
        (this.parts[O] instanceof dn && c.push(this.parts[O]),
          (this.parts[O] = null));
      n.type.mark && c.push(this.elt(n.type.mark, n.from, u));
      let d = this.elt(h, f, u, c);
      ((this.parts[l] =
        r && a.from != f ? new Lt(a.type, a.from, f, a.side) : null),
        (this.parts[i] =
          r && n.to != u ? new Lt(n.type, u, n.to, n.side) : null)
          ? this.parts.splice(i, 0, d)
          : (this.parts[i] = d));
    }
    let e = [];
    for (let i = t; i < this.parts.length; i++) {
      let n = this.parts[i];
      n instanceof dn && e.push(n);
    }
    return e;
  }
  findOpeningDelimiter(t) {
    for (let e = this.parts.length - 1; e >= 0; e--) {
      let i = this.parts[e];
      if (i instanceof Lt && i.type == t && i.side & 1) return e;
    }
    return null;
  }
  takeContent(t) {
  ...
  skipSpace(t) {
    return us(this.text, t - this.offset) + this.offset;
  }
  elt(t, e, i, n) {
    return typeof t == "string"
      ? j(this.parser.getNodeType(t), e, i, n)
...
function Ql(s, t) {
  ...
  let e = s.slice(),
    i = 0;
  for (let n of t) {
    for (; i < e.length && e[i].to < n.to;) i++;
    if (i < e.length && e[i].from < n.from) {
      let r = e[i];
      r instanceof dn &&
        (e[i] = new dn(r.type, r.from, r.to, Ql(r.children, [n])));
    } else e.splice(i++, 0, n);
  }
  return e;
}
var sy = [v.CodeBlock, v.ListItem, v.OrderedList, v.BulletList],
  eO = class {
    constructor(t, e) {
      ((this.fragments = t),
        (this.input = e),
...
`;
    ...
    takeNodes(t) {
      ...
      for (;;) {
        ...
        let c = iO(e.from - i, t.ranges);
        if (e.to - i <= t.ranges[t.rangeI].to) t.addNode(e.tree, c);
        else {
          let f = new z(
            t.parser.nodeSet.types[v.Paragraph],
            [],
            [],
            0,
            t.block.hashProp,
          );
          (t.reusePlaceholders.set(f, e.tree), t.addNode(f, c));
        }
        if (
          (e.type.is("Block") &&
            (sy.indexOf(e.type.id) < 0
              ? ((o = e.to - i), (a = t.block.children.length))
              : ((o = l), (a = h)),
            (l = e.to - i),
            (h = t.block.children.length)),
          !e.nextSibling())
        )
          break;
      }
...
var ry = he({
  ...
  nO = new fn(
    new ze(Gp).extend(ry),
    Object.keys(Mr).map((s) => Mr[s]),
    Object.keys(Mr).map((s) => qp[s]),
    Object.keys(Mr),
    ey,
    Zp,
    Object.keys(kl).map((s) => kl[s]),
    Object.keys(kl),
    [],
  );
function oy(s, t, e) {
  let i = [];
  for (let n = s.firstChild, r = t; ; n = n.nextSibling) {
    let o = n ? n.from : e;
    if ((o > r && i.push({ from: r, to: o }), !n)) break;
    r = n.to;
  }
  return i;
}
function sO(s) {
  ...
  return {
    wrap: sr((n, r) => {
      let o = n.type.id;
      if (t && (o == v.CodeBlock || o == v.FencedCode)) {
        let a = "";
        if (o == v.FencedCode) {
          let h = n.node.getChild(v.CodeInfo);
          h && (a = r.read(h.from, h.to));
        }
        let l = t(a);
        if (l)
          return {
            parser: l,
            overlay: (h) => h.type.id == v.CodeText,
            bracketed: o == v.FencedCode,
          };
      } else if (
        e &&
        (o == v.HTMLBlock || o == v.HTMLTag || o == v.CommentBlock)
      )
        return { parser: e, overlay: oy(n.node, n.from, n.to) };
      return null;
    }),
  };
}
var ay = { resolve: "Strikethrough", mark: "StrikethroughMark" },
  ly = {
    defineNodes: [
      {
        name: "Strikethrough",
...
function Os(s, t, e = 0, i, n = 0) {
    ...
    c = () => {
      i.push(
        s.elt(
          ...
          n + a,
          n + l,
          s.parser.parseInline(t.slice(a, l), n + a),
        ),
      );
    };
  for (let f = e; f < t.length; f++) {
    ...
    (u == 124 && !h
      ? ((!o || a > -1) && r++,
        (o = !1),
        i && (a > -1 && c(), i.push(s.elt("TableDelimiter", f + n, f + n + 1))),
        (a = l = -1))
      : (h || (u != 32 && u != 9)) && (a < 0 && (a = f), (l = f + 1)),
      (h = !h && u == 92));
  }
  return (a > -1 && (r++, i && c()), r);
}
...
var oO = /^[>\s]*\|?(\s*:?-+:?\s*\|)+(\s*:?-+:?\s*)?$/,
  Pl = class {
    ...
    nextLine(t, e, i) {
      if (this.rows == null) {
        ...
        let n;
        if (
          (e.next == 45 || e.next == 58 || e.next == 124) &&
          oO.test((n = e.text.slice(e.pos)))
        ) {
          let r = [];
          Os(t, i.content, 0, r, i.start) == Os(t, n, 0) &&
            (this.rows = [
        ...
        let n = [];
        (Os(t, e.text, e.pos, n, t.lineStart),
          this.rows.push(
            t.elt(
              "TableRow",
              t.lineStart + e.pos,
    ...
    parseBlock: [
      {
        name: "Table",
        leaf(s, t) {
          return rO(t.content, 0) ? new Pl() : null;
        },
        endLeaf(s, t, e) {
          if (e.parsers.some((n) => n instanceof Pl) || !rO(t.text, t.basePos))
            return !1;
          let i = s.peekLine();
          return oO.test(i) && Os(s, t.text, t.basePos) == Os(s, i, t.basePos);
        },
    ...
    parseBlock: [
      {
        name: "TaskList",
        leaf(s, t) {
          return /^\[[ xX]\][ \t]/.test(t.content) &&
            s.parentType().name == "ListItem"
            ? new aO()
            : null;
        },
        after: "SetextHeading",
  ...
  lO = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy,
  hO = /[\w-]+(\.[\w-]+)+(:\d+)?(\/[^\s<]*)?/gy,
  fy = /[\w-]+\.[\w-]+($|[/:])/,
  cO = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy,
  fO = /\/[a-zA-Z\d@.]+/gy;
function uO(s, t, e, i) {
  let n = 0;
  for (let r = t; r < e; r++) s[r] == i && n++;
  return n;
}
function uy(s, t) {
  hO.lastIndex = t;
  let e = hO.exec(s);
  if (!e || fy.exec(e[0])[0].indexOf("_") > -1) return -1;
  let i = t + e[0].length;
  for (;;) {
    let n = s[i - 1],
      r;
    if (
      ...
      i--;
    else if (n == ";" && (r = /&(?:#\d+|#x[a-f\d]+|\w+);$/.exec(s.slice(t, i))))
      i = t + r.index;
    else break;
  }
  return i;
    ...
    parseInline: [
      {
        ...
        parse(s, t, e) {
          let i = e - s.offset;
          if (i && /\w/.test(s.text[i - 1])) return -1;
          lO.lastIndex = i;
          let n = lO.exec(s.text),
            r = -1;
          if (!n) return -1;
          if (n[1] || n[2]) {
            if (((r = uy(s.text, i + n[0].length)), r > -1 && s.hasOpenLink)) {
              let o = /([^\[\]]|\[[^\]]*\])*/.exec(s.text.slice(i, r));
              r = i + o[0].length;
            }
          } else
            n[3]
              ? (r = dO(s.text, i))
              : ((r = dO(s.text, i + n[0].length)),
                r > -1 &&
                  n[0] == "xmpp:" &&
                  ((fO.lastIndex = r),
                  (n = fO.exec(s.text)),
          ...
          return r < 0
            ? -1
            : (s.addElement(s.elt("URL", e, r + s.offset)), r + s.offset);
        },
      },
    ],
  },
...
function OO(s, t, e) {
  return (i, n, r) => {
    if (n != s || i.char(r + 1) == s) return -1;
    let o = [i.elt(e, r, r + 1)];
    for (let a = r + 1; a < i.end; a++) {
      let l = i.char(a);
      if (l == s)
        return i.addElement(i.elt(t, r, a + 1, o.concat(i.elt(e, a, a + 1))));
      if ((l == 92 && o.push(i.elt("Escape", a, a++ + 2)), Jt(l))) break;
    }
    return -1;
  };
}
var mO = {
    ...
    parseInline: [
      { name: "Superscript", parse: OO(94, "Superscript", "SuperscriptMark") },
    ],
  },
  gO = {
    defineNodes: [
    ...
    parseInline: [
      { name: "Subscript", parse: OO(126, "Subscript", "SubscriptMark") },
    ],
  },
  bO = {
    ...
    parseInline: [
      {
        ...
        parse(s, t, e) {
          let i;
          return t != 58 || !(i = /^[a-zA-Z_0-9]+:/.exec(s.slice(e + 1, s.end)))
            ? -1
            : s.addElement(s.elt("Emoji", e, e + 1 + i[0].length));
        },
      },
    ],
  };
var SO = zn({ commentTokens: { block: { open: "<!--", close: "-->" } } }),
  yO = new X(),
  wO = nO.configure({
    props: [
      Ye.add((s) =>
        !s.is("Block") || s.is("Document") || $l(s) != null || py(s)
          ? void 0
          : (t, e) => ({ from: e.doc.lineAt(t.from).to, to: t.to }),
      ),
      yO.add($l),
      je.add({ Document: () => null }),
      si.add({ Document: SO }),
    ],
  });
function $l(s) {
...
function Oy(s, t) {
  ...
  for (;;) {
    let i = e.nextSibling,
      n;
    if (!i || ((n = $l(i.type)) != null && n <= t)) break;
    e = i;
  }
  return e.to;
}
var my = Nf.of((s, t, e) => {
  for (let i = F(s).resolveInner(e, -1); i && !(i.from < t); i = i.parent) {
    let n = i.type.prop(yO);
    if (n == null) continue;
    let r = Oy(i, n);
    if (r > e) return { from: e, to: r };
  }
  return null;
});
function Tl(s) {
  return new Xt(SO, s, [], "markdown");
}
var gy = Tl(wO),
  by = wO.configure([
    pO,
    ...
    bO,
    {
      props: [
        Ye.add({
          Table: (s, t) => ({ from: t.doc.lineAt(s.from).to, to: s.to }),
        }),
      ],
    },
  ]),
  ...
  return (e) => {
    if (e && s) {
      ...
      if (
        ...
        typeof s == "function"
          ? (i = s(e))
          : (i = Fi.matchLanguageName(s, e, !0)),
        i instanceof Fi)
      )
        return i.support
          ? i.support.language.parser
          : vi.getSkippingParser(i.load());
...
var Dr = class {
  ...
  blank(t, e = !0) {
    ...
    if (t != null) {
      ...
      for (
        let n = this.to - this.from - i.length - this.spaceAfter.length;
        n > 0;
        n--
      )
        i += " ";
  ...
  marker(t, e) {
    let i =
      this.node.name == "OrderedList" ? String(+xO(this.item, t)[2] + e) : "";
...
function vO(s, t) {
  ...
  for (let n = s; n; n = n.parent) {
    if (n.name == "FencedCode") return i;
    (n.name == "ListItem" || n.name == "Blockquote") && e.push(n);
  }
  for (let n = e.length - 1; n >= 0; n--) {
    let r = e[n],
      o,
      a = t.lineAt(r.from),
      l = r.from - a.from;
    if (r.name == "Blockquote" && (o = /^ *>( ?)/.exec(a.text.slice(l))))
      i.push(new Dr(r, l, l + o[0].length, "", o[1], ">", null));
    else if (
      r.name == "ListItem" &&
      r.parent.name == "OrderedList" &&
      (o = /^( *)\d+([.)])( *)/.exec(a.text.slice(l)))
    ) {
      let h = o[3],
        c = o[0].length;
      (h.length >= 4 && ((h = h.slice(0, h.length - 4)), (c -= 4)),
        i.push(new Dr(r.parent, l, l + c, o[1], h, o[2], r)));
    } else if (
      r.name == "ListItem" &&
      r.parent.name == "BulletList" &&
      ...
      h.length > 4 && ((h = h.slice(0, h.length - 4)), (c -= 4));
      let f = o[2];
      (o[3] && (f += o[3].replace(/[xX]/, " ")),
        i.push(new Dr(r.parent, l, l + c, o[1], h, f, r)));
    }
  }
  return i;
}
  ...
  for (let n = -1, r = s; ;) {
    if (r.name == "ListItem") {
      ...
      if (n >= 0) {
        if (l != n + 1) return;
        e.push({
          from: r.from + a[1].length,
          to: r.from + a[0].length,
          insert: String(n + 2 + i),
        });
      }
      n = l;
...
function Al(s, t) {
  ...
  if (!e || t.facet(ri) != "	") return s;
  let i = we(s, 4, e),
    n = "";
  for (let r = i; r > 0;) r >= 4 ? ((n += "	"), (r -= 4)) : ((n += " "), r--);
  return n + s.slice(e);
}
var yy =
    (s = {}) =>
    ({ state: t, dispatch: e }) => {
      let i = F(t),
        ...
        o = t.changeByRange((a) => {
          if (
            !a.empty ||
            (!Ir.isActiveAt(t, a.from, -1) && !Ir.isActiveAt(t, a.from, 1))
          )
            return (r = { range: a });
          let l = a.from,
            h = n.lineAt(l),
            c = vO(i.resolveInner(l, -1), n);
          for (; c.length && c[c.length - 1].from > l - h.from;) c.pop();
          if (!c.length) return (r = { range: a });
          let f = c[c.length - 1];
          if (f.to - f.spaceAfter.length > l - h.from)
            return (r = { range: a });
          let u =
            l >= f.to - f.spaceAfter.length && !/\S/.test(h.text.slice(f.to));
          if (f.item && u) {
            let b = f.node.firstChild,
              S = f.node.getChild("ListItem", "ListItem");
            if (
              b.to >= l ||
              (S && S.to < l) ||
              (h.from > 0 && !/[^\s>]/.test(n.lineAt(h.from - 1).text)) ||
              s.nonTightLists === !1
            ) {
              let y = c.length > 1 ? c[c.length - 2] : null,
                C,
                w = "";
              y && y.item
                ? ((C = h.from + y.from), (w = y.marker(n, 1)))
                : (C = h.from + (y ? y.to : 0));
              let Q = [{ from: C, to: l, insert: w }];
              return (
                f.node.name == "OrderedList" && Cl(f.item, n, Q, -2),
                y && y.node.name == "OrderedList" && Cl(y.item, n, Q),
                { range: k.cursor(C + w.length), changes: Q }
              );
            } else {
              let y = QO(c, t, h);
              return {
                range: k.cursor(l + y.length + 1),
                changes: { from: h.from, insert: y + t.lineBreak },
              };
            }
          }
          if (f.node.name == "Blockquote" && u && h.from) {
            let b = n.lineAt(h.from - 1),
              S = />\s*$/.exec(b.text);
            if (S && S.index == f.from) {
              let y = t.changes([
                { from: b.from + S.index, to: b.to },
                { from: h.from + f.from, to: h.to },
              ]);
              return { range: a.map(y), changes: y };
            }
          }
          let d = [];
          f.node.name == "OrderedList" && Cl(f.item, n, d);
          let p = f.item && f.item.from < h.from,
            O = "";
          if (!p || /^[\s\d.)\-+*>]*/.exec(h.text)[0].length >= f.to)
            for (let b = 0, S = c.length - 1; b <= S; b++)
              O +=
                b == S && !p
                  ? c[b].marker(n, 1)
                  : c[b].blank(
                      b < S ? we(h.text, 4, c[b + 1].from) - O.length : null,
                    );
          let g = l;
          for (; g > h.from && /\s/.test(h.text.charAt(g - h.from - 1));) g--;
          return (
            (O = Al(O, t)),
            vy(f.node, t.doc) && (O = QO(c, t, h) + t.lineBreak + O),
            d.push({ from: g, to: l, insert: t.lineBreak + O }),
            { range: k.cursor(g + O.length + 1), changes: d }
          );
        });
      return r
        ? !1
        : (e(t.update(o, { scrollIntoView: !0, userEvent: "input" })), !0);
    },
  wy = yy();
function kO(s) {
...
function vy(s, t) {
  if (s.name != "OrderedList" && s.name != "BulletList") return !1;
  let e = s.firstChild,
    i = s.getChild("ListItem", "ListItem");
  if (!i) return !1;
  let n = t.lineAt(e.to),
    r = t.lineAt(i.from),
    o = /^[\s>]*$/.test(n.text);
  return n.number + (o ? 0 : 1) < r.number;
}
function QO(s, t, e) {
  let i = "";
  for (let n = 0, r = s.length - 2; n <= r; n++)
    i += s[n].blank(
      n < r ? we(e.text, 4, s[n + 1].from) - i.length : null,
      n < r,
    );
  return Al(i, t);
}
function xy(s, t) {
  let e = s.resolveInner(t, -1),
    i = t;
  kO(e) && ((i = e.from), (e = e.parent));
  for (let n; (n = e.childBefore(i));)
    if (kO(n)) i = n.from;
    else if (n.name == "OrderedList" || n.name == "BulletList")
      ((e = n.lastChild), (i = e.to));
    else break;
  return e;
}
var ky = ({ state: s, dispatch: t }) => {
    let e = F(s),
      i = null,
      n = s.changeByRange((r) => {
        let o = r.from,
          { doc: a } = s;
        if (r.empty && Ir.isActiveAt(s, r.from)) {
          let l = a.lineAt(o),
            h = vO(xy(e, o), a);
          if (h.length) {
            let c = h[h.length - 1],
              f = c.to - c.spaceAfter.length + (c.spaceAfter ? 1 : 0);
            if (o - l.from > f && !/\S/.test(l.text.slice(f, o - l.from)))
              return {
                range: k.cursor(l.from + f),
            ...
            if (
              ...
              (!c.item ||
                l.from <= c.item.from ||
                !/\S/.test(l.text.slice(0, c.to)))
            ) {
              let u = l.from + c.from;
              if (
                c.item &&
                c.node.from < c.item.from &&
                /\S/.test(l.text.slice(c.from, c.to))
              ) {
                let d = c.blank(we(l.text, 4, c.to) - we(l.text, 4, c.from));
                return (
                  u == l.from && (d = Al(d, s)),
                  {
                    range: k.cursor(u + d.length),
                    changes: { from: u, to: l.from + c.to, insert: d },
                  }
                );
              }
              if (u < o)
                return { range: k.cursor(u), changes: { from: u, to: o } };
            }
          }
        }
        return (i = { range: r });
    ...
    return i
      ? !1
      : (t(s.update(n, { scrollIntoView: !0, userEvent: "delete" })), !0);
  },
  Qy = [
    { key: "Enter", run: wy },
    { key: "Backspace", run: ky },
  ],
  PO = Zr({ matchClosingTags: !1 });
function $O(s = {}) {
  let {
    codeLanguages: t,
    defaultCodeLanguage: e,
    addKeymap: i = !0,
    base: { parser: n } = gy,
    completeHTMLTags: r = !0,
    pasteURLAsLink: o = !0,
    htmlTagLanguage: a = PO,
  } = s;
  if (!(n instanceof fn))
    throw new RangeError(
      "Base parser provided to `markdown` should be a Markdown parser",
    );
  let l = s.extensions ? [s.extensions] : [],
    h = [a.support, my],
    c;
  (o && h.push(Cy),
    e instanceof Ae ? (h.push(e.support), (c = e.language)) : e && (c = e));
  let f = t || c ? Sy(t, c) : void 0;
  (l.push(sO({ codeParser: f, htmlParser: a.language.parser })),
    i && h.push(be.high(Be.of(Qy))));
  let u = Tl(n.configure(l));
  return (r && h.push(u.data.of({ autocomplete: Py })), new Ae(u, h));
}
function Py(s) {
  let { state: t, pos: e } = s,
    i = /<[:\-\.\w\u00b7-\uffff]*$/.exec(t.sliceDoc(e - 25, e));
  if (!i) return null;
  let n = F(t).resolveInner(e, -1);
  for (; n && !n.type.isTop;) {
    if (
      n.name == "CodeBlock" ||
      n.name == "FencedCode" ||
      n.name == "ProcessingInstructionBlock" ||
      n.name == "CommentBlock" ||
      n.name == "Link" ||
      n.name == "Image"
    )
...
function $y() {
  if (El) return El;
  let s = kp(new ja(I.create({ extensions: PO }), 0, !0));
  return (El = s ? s.options : []);
}
var Ty =
    /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i,
  Cy = A.domEventHandlers({
    paste: (s, t) => {
      var e;
      let { main: i } = t.state.selection;
      if (i.empty) return !1;
      let n =
        (e = s.clipboardData) === null || e === void 0
          ? void 0
          : e.getData("text/plain");
      if (
        !n ||
        !/^(https?:\/\/|mailto:|xmpp:|www\.)/.test(n) ||
        (/^www\./.test(n) && (n = "https://" + n),
        !Ir.isActiveAt(t.state, i.from, 1))
      )
        return !1;
      let r = F(t.state),
        o = !1;
      return (
        r.iterate({
          ...
          to: i.to,
          enter: (a) => {
            (a.from > i.from || Ty.test(a.name)) && (o = !0);
          },
          leave: (a) => {
            a.to < i.to && (o = !0);
          },
...
/* END BUNDLED CODEMIRROR/LEZER RUNTIME — plugin modal-editor logic resumes. */
